...
for alias, main, want in [
    ...
    # ⚠️ 영구 등재 — 2026-09-05 세션 A 가 잡은 사각. 「접두+대표명으로 «끝난다»」로 보면
    #    파생형을 통째로 놓친다. 키워드는 대표명 뒤에 접미어가 붙는 것이 «정상» 이라
    #    계정 안에서 어간 10건 옆에 파생 20건이 숨어 있었다(합 30). 접두는 «머리에서» 찾는다.
    ('동래구동래사적공원오네뜨분양권', '동래사적공원 오네뜨',  True),
    ('수영구수영2재개발조합',        '수영2 재개발',        True),
    ('함안군함안가야휴니온아르떼입주', '함안가야 휴니온아르떼', True),
    ('창원창원한신더휴메가센텀입주',   '창원 한신더휴 메가센텀', True),
    ...
    ('부산동래반도유보라',          '동래 반도 유보라',    False),   # 상위 지역 추가는 중복이 아니다
    ('동래반도유보라분양권',        '동래 반도 유보라',    False),   # 그냥 접미어
    ('창원자이 더 스카이 분양가',   '창원자이 더 스카이',  False),
]:
