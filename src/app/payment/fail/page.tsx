...
export default function PaymentFail() {
  return (
    <div style={{ display:'flex', flexDirection:'column', alignItems:'center', justifyContent:'center', minHeight:'60vh', gap:16, padding:24, textAlign:'center' }}>
      ...
      <Link href="/shop" style={{ backgroundColor:'var(--brand)', color:'var(--text-inverse)', borderRadius:9999, padding:'12px 32px', fontWeight:700, textDecoration:'none', display:'inline-block' }}>다시 시도</Link>
    </div>
  );
}
