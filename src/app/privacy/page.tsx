...
export default function PrivacyPage() {
  return (
    ...
    >
      <h1 style={{ fontSize: 'var(--fs-2xl)', fontWeight: 800, marginBottom: 8, color: 'var(--text-primary)' }}>개인정보처리방침</h1>
      <p style={{ fontSize: 'var(--fs-sm)', color: 'var(--text-tertiary)', marginBottom: 40 }}>시행일: 2026년 3월 24일 (v2.0)</p>

      <section style={{ marginBottom: 32 }}>
        <h2 style={{ fontSize: 'var(--fs-base)', fontWeight: 700, marginBottom: 8, color: 'var(--text-primary)' }}>1. 수집 항목</h2>
        <ul style={{ fontSize: 'var(--fs-sm)', color: 'var(--text-secondary)', lineHeight: 1.8, paddingLeft: 20 }}>
          <li>필수 항목: 이메일, 닉네임</li>
          <li>카카오·구글 로그인 시: 이메일, 프로필명</li>
          <li>관심고객 등록 시 (비회원): 이름, 전화번호, 생년월일, 거주 지역(시군구)</li>
      ...
      <section style={{ marginBottom: 32 }}>
        <h2 style={{ fontSize: 'var(--fs-base)', fontWeight: 700, marginBottom: 8, color: 'var(--text-primary)' }}>2. 수집 목적</h2>
        <ul style={{ fontSize: 'var(--fs-sm)', color: 'var(--text-secondary)', lineHeight: 1.8, paddingLeft: 20 }}>
          <li>회원 관리 및 본인 확인</li>
          <li>서비스 제공 및 운영</li>
      ...
      <section style={{ marginBottom: 32 }}>
        <h2 style={{ fontSize: 'var(--fs-base)', fontWeight: 700, marginBottom: 8, color: 'var(--text-primary)' }}>3. 보유 기간</h2>
        ...
        <ul style={{ fontSize: 'var(--fs-sm)', color: 'var(--text-secondary)', lineHeight: 1.8, paddingLeft: 20, marginTop: 8 }}>
          ...
          <li>관심고객 등록 정보: 동의 철회 시 또는 수집 목적 달성 후 5일 이내 파기</li>
          <li>개인정보 동의 이력: 동의 증빙을 위해 동의 철회 후 3년 보관</li>
        </ul>
      </section>

      <section style={{ marginBottom: 32 }}>
        <h2 style={{ fontSize: 'var(--fs-base)', fontWeight: 700, marginBottom: 8, color: 'var(--text-primary)' }}>4. 제3자 제공</h2>
        <p style={{ fontSize: 'var(--fs-sm)', color: 'var(--text-secondary)', lineHeight: 1.8 }}>
          카더라는 이용자의 별도 동의 없이 개인정보를 제3자에게 제공하지 않습니다. 다만 아래의 경우에는 예외로 합니다.
        </p>
        <ul style={{ fontSize: 'var(--fs-sm)', color: 'var(--text-secondary)', lineHeight: 1.8, paddingLeft: 20, marginTop: 8 }}>
          <li>이용자가 관심고객 등록 시 &quot;제3자 제공 동의&quot;에 동의한 경우: 해당 현장 분양 상담사에게 이름·전화번호를 제공합니다.</li>
          <li>법령에 의한 요청이 있는 경우</li>
        </ul>
      </section>

      <section style={{ marginBottom: 32 }}>
        <h2 style={{ fontSize: 'var(--fs-base)', fontWeight: 700, marginBottom: 8, color: 'var(--text-primary)' }}>5. 만 14세 미만 아동</h2>
        <p style={{ fontSize: 'var(--fs-sm)', color: 'var(--text-secondary)', lineHeight: 1.8 }}>
          카더라는 만 14세 미만 아동의 개인정보를 수집하지 않습니다. 관심고객 등록 시 생년월일을 확인하여 만 14세 미만인 경우 등록이 거부됩니다. (개인정보 보호법 제22조의2)
        </p>
      </section>

      <section style={{ marginBottom: 32 }}>
        <h2 style={{ fontSize: 'var(--fs-base)', fontWeight: 700, marginBottom: 8, color: 'var(--text-primary)' }}>6. 개인정보의 안전성 확보 조치</h2>
        <ul style={{ fontSize: 'var(--fs-sm)', color: 'var(--text-secondary)', lineHeight: 1.8, paddingLeft: 20 }}>
