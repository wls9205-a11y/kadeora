...
export default function TermsPage() {
  ...
  return (
    <div style={{ maxWidth: 720, margin: '0 auto', padding: '40px 16px' }}>
      <h1 style={{ fontSize: 'var(--fs-2xl)', fontWeight: 'var(--fw-num)', color: 'var(--text-primary)', marginBottom: 'var(--sp-sm)' }}>이용약관</h1>
      ...
      <div style={{ marginTop: 24, padding: '16px 20px', borderRadius: 'var(--radius-card)', backgroundColor: 'var(--bg-sunken)', border: '1px solid var(--border)' }}>
        ...
        <p style={{ fontSize: 'var(--fs-sm)', color: 'var(--text-tertiary)', lineHeight: 1.6, margin: '8px 0 0' }}>
