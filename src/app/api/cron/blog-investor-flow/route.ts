/**
 * ⛔ 폐기됨 — blog-investor-flow (2026-09-13 · FINAL_HC_20260913 C-4)
 *
 * ── 무엇이었나 ──
 * stock_investor_flow 를 «2026-03-01 ~ 03-31 고정 창» 으로 읽어 주간 요약 글(`investor-flow-2026-03-w{n}`)을 만들던 자다.
 *
 * ── 왜 «파라미터화» 가 아니라 «묘비» 인가 ──
...
export async function GET() {
  return NextResponse.json(
    {
      error: 'gone',
      message: 'blog-investor-flow 은 2026-09-13 에 폐기됐다. 2026-03 고정 창 박제 · 스케줄 0 · 소생 계획 없음.',
    },
    { status: 410 },
  );
}
