    ...
    <html lang="ko" suppressHydrationWarning>
      <head>
        ...
        <JsonLd data={{
          ...
          description: '부동산·주식 정보 플랫폼 — 아파트 청약, 재개발, 주식 시세, AI 종목 분석, 투자 커뮤니티',
          foundingDate: '2026',
          contactPoint: { '@type': 'ContactPoint', contactType: 'customer service', email: 'kadeora.app@gmail.com', availableLanguage: 'Korean' },
          sameAs: [
      ...
      <body>
        <a href="#main-content" className="skip-to-content" style={{ position: 'absolute', left: '-9999px', top: 'auto', width: '1px', height: '1px', overflow: 'hidden', zIndex: 99999, padding: '12px 24px', background: 'var(--brand)', color: '#fff', borderRadius: '8px', fontSize: 'var(--fs-sm)', fontWeight: 'var(--fw-num)', textDecoration: 'none' }}>본문으로 건너뛰기</a>
