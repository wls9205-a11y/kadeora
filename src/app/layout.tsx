  ...
  return (
    <html lang="ko" className="dark" suppressHydrationWarning>
      <head>
        ...
        <link rel="apple-touch-icon" sizes="152x152" href="/icons/icon-152.png?v=6" />
        <link rel="apple-touch-icon" sizes="144x144" href="/icons/icon-144.png?v=6" />
        <link rel="apple-touch-icon" sizes="120x120" href="/icons/icon-128.png?v=6" />
