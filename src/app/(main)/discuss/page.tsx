...
export const metadata: Metadata = {
  ...
  other: { 'naver:written_time': '2026-01-15T00:00:00Z', 'naver:updated_time': new Date().toISOString(), 'article:section': '토론', 'dg:plink': SITE_URL + '/discuss', 'naver:author': '카더라', 'og:updated_time': new Date().toISOString() },
};
