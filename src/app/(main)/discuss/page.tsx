...
export default function DiscussPage() {
  return (
    <Suspense>
      <JsonLd data={{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"홈","item":SITE_URL},{"@type":"ListItem","position":2,"name":"토론","item":SITE_URL + "/discuss"}]}} />
      <JsonLd data={{"@context":"https://schema.org","@type":"WebPage","name":"카더라 토론","description":"주식, 부동산, 경제 이슈에 대해 실시간으로 토론하고 투표하는 공간","url":SITE_URL+"/discuss","isPartOf":{"@type":"WebSite","name":"카더라","url":SITE_URL},"about":[{"@type":"Thing","name":"주식 토론"},{"@type":"Thing","name":"부동산 토론"},{"@type":"Thing","name":"경제 토론"}]}} />
