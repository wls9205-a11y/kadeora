...
export default function PressPage() {
  return (
    <>
      <JsonLd data={{ '@context': 'https://schema.org', '@type': 'BreadcrumbList', itemListElement: [{ '@type': 'ListItem', position: 1, name: '카더라', item: SITE_URL }, { '@type': 'ListItem', position: 2, name: '프레스' }] }} />

    <article style={{ maxWidth: 720, margin: '0 auto', padding: '0 var(--sp-lg)' }}>
      <nav aria-label="breadcrumb" style={{ fontSize: 'var(--fs-xs)', color: 'var(--text-tertiary)', marginBottom: 'var(--sp-md)' }}>
        <Link href="/" style={{ textDecoration: 'none', color: 'var(--text-tertiary)' }}>홈</Link>
        <span> › </span><span>프레스 킷</span>
      </nav>

      <h1 style={{ fontSize: 'var(--fs-xl)', fontWeight: 'var(--fw-title)', marginBottom: 4 }}>프레스 킷</h1>
      ...
      <section style={{ marginBottom: 'var(--sp-xl)' }}>
        <h2 style={{ fontSize: 'var(--fs-lg)', fontWeight: 'var(--fw-title)', marginBottom: 12 }}>서비스 한줄 소개</h2>
        <div style={{ background: 'var(--bg-surface)', border: '1px solid var(--border)', borderRadius: 'var(--radius-card)', padding: 20 }}>
          <p style={{ fontSize: 'var(--fs-base)', color: 'var(--text-primary)', lineHeight: 1.6, margin: 0, fontWeight: 'var(--fw-title)' }}>
      ...
      <section style={{ marginBottom: 'var(--sp-xl)' }}>
        <h2 style={{ fontSize: 'var(--fs-lg)', fontWeight: 'var(--fw-title)', marginBottom: 12 }}>핵심 수치</h2>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(140px, 1fr))', gap: 8 }}>
          {STATS.map(s => (
            <div key={s.label} style={{ background: 'var(--bg-surface)', border: '1px solid var(--border)', borderRadius: 'var(--radius-card)', padding: 14, textAlign: 'center' }}>
              ...
              <div style={{ fontSize: 'var(--fs-xs)', fontWeight: 'var(--fw-title)', color: 'var(--text-primary)', marginTop: 2 }}>{s.label}</div>
              <div style={{ fontSize: 'var(--fs-xs)', color: 'var(--text-tertiary)', marginTop: 2 }}>{s.desc}</div>
            </div>
          ))}
        </div>
      </section>
      ...
      <section style={{ marginBottom: 'var(--sp-xl)' }}>
        <h2 style={{ fontSize: 'var(--fs-lg)', fontWeight: 'var(--fw-title)', marginBottom: 12 }}>데이터 인용 가이드</h2>
        <div style={{ background: 'var(--bg-surface)', border: '1px solid var(--border)', borderRadius: 'var(--radius-card)', padding: 20 }}>
          <p style={{ fontSize: 'var(--fs-sm)', color: 'var(--text-secondary)', lineHeight: 1.6, margin: '0 0 12px' }}>
            카더라의 데이터를 기사, 블로그, 유튜브 등에서 인용하실 때 아래 형식을 사용해 주세요.
          </p>
          <div style={{ background: 'var(--bg-base)', borderRadius: 'var(--radius-md)', padding: 14, fontSize: 'var(--fs-xs)', color: 'var(--text-primary)', fontFamily: 'var(--font-mono)', lineHeight: 1.6 }}>
      ...
      <section style={{ marginBottom: 'var(--sp-xl)' }}>
        <h2 style={{ fontSize: 'var(--fs-lg)', fontWeight: 'var(--fw-title)', marginBottom: 12 }}>데이터 출처</h2>
      ...
      <section>
        <h2 style={{ fontSize: 'var(--fs-lg)', fontWeight: 'var(--fw-title)', marginBottom: 12 }}>문의</h2>
        <div style={{ background: 'var(--bg-surface)', border: '1px solid var(--border)', borderRadius: 'var(--radius-card)', padding: 20 }}>
          <p style={{ fontSize: 'var(--fs-sm)', color: 'var(--text-secondary)', margin: '0 0 8px' }}>데이터 제휴, 기사 인용, 인터뷰 요청</p>
          <a href="mailto:kadeora.app@gmail.com" style={{ color: 'var(--brand)', fontWeight: 'var(--fw-body)', fontSize: 'var(--fs-base)', textDecoration: 'none' }}>📧 kadeora.app@gmail.com</a>
        </div>
      </section>
    </article>
