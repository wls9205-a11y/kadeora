...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    locale: 'ko_KR',
    type: 'website',
    images: [{ url: `${SITE_URL}/api/og?title=${encodeURIComponent('청약 가점 계산기')}&subtitle=${encodeURIComponent('무주택·부양가족·통장 가점 자동 계산')}`, width: 1200, height: 630, alt: '카더라 청약 가점 계산기' }],
  },
