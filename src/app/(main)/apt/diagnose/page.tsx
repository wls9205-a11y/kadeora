  ...
  return (
    <div style={{ maxWidth: 720, margin: '0 auto' }}>
      <div style={{ marginBottom: 20 }}>
        <Link href="/apt" style={{ fontSize: 13, color: 'var(--text-tertiary)', textDecoration: 'none' }}>← 청약 목록</Link>
        <h1 style={{ margin: '8px 0 0', fontSize: 22, fontWeight: 800, color: 'var(--text-primary)' }}>🎯 청약 가점 진단</h1>
        <p style={{ margin: '4px 0 0', fontSize: 13, color: 'var(--text-secondary)' }}>내 가점을 계산해보세요 (만점 84점)</p>
      </div>

      <div style={{ background: 'var(--bg-surface)', border: '1px solid var(--border)', borderRadius: 12, padding: 20, marginBottom: 16 }}>
        <div style={{ marginBottom: 20 }}>
          <label style={{ fontSize: 13, fontWeight: 600, color: 'var(--text-secondary)', display: 'block', marginBottom: 8 }}>무주택기간 (만점 32점)</label>
          <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
            ...
            <span style={{ fontSize: 14, fontWeight: 700, color: 'var(--text-primary)', minWidth: 50 }}>{years}년</span>
            <span style={{ fontSize: 12, color: 'var(--brand)', fontWeight: 600 }}>{housingScore}점</span>
          </div>
        </div>

        <div style={{ marginBottom: 20 }}>
          <label style={{ fontSize: 13, fontWeight: 600, color: 'var(--text-secondary)', display: 'block', marginBottom: 8 }}>부양가족 수 (만점 35점)</label>
          ...
          <div style={{ fontSize: 12, color: 'var(--brand)', fontWeight: 600, textAlign: 'right', marginTop: 4 }}>{familyScore}점</div>
        </div>

        <div style={{ marginBottom: 20 }}>
          <label style={{ fontSize: 13, fontWeight: 600, color: 'var(--text-secondary)', display: 'block', marginBottom: 8 }}>청약통장 가입기간 (만점 17점)</label>
          <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
            ...
            <span style={{ fontSize: 14, fontWeight: 700, color: 'var(--text-primary)', minWidth: 50 }}>{bankYears}년</span>
            <span style={{ fontSize: 12, color: 'var(--brand)', fontWeight: 600 }}>{bankScore}점</span>
          </div>
        </div>
      </div>
      ...
      <div style={{ background: 'var(--bg-surface)', border: '1px solid var(--border)', borderRadius: 12, padding: 24, textAlign: 'center' }}>
        <div style={{ fontSize: 13, color: 'var(--text-tertiary)', marginBottom: 8 }}>내 청약 가점</div>
        <div style={{ fontSize: 48, fontWeight: 900, color: grade.color }}>{total}<span style={{ fontSize: 20 }}>점</span></div>
        <div style={{ fontSize: 14, fontWeight: 600, color: grade.color, marginBottom: 16 }}>{grade.label}</div>
        <div style={{ display: 'flex', gap: 8, justifyContent: 'center' }}>
          <div style={{ background: 'var(--bg-hover)', borderRadius: 8, padding: '8px 16px', fontSize: 12, color: 'var(--text-secondary)' }}>무주택 {housingScore}점</div>
