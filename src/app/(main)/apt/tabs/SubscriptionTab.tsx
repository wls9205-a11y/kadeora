            ...
            return (
              <Link key={apt.id} href={`/apt/${encodeURIComponent(generateAptSlug(apt.house_nm) || apt.house_manage_no || String(apt.id))}`} className="hero-card" style={{
                ...
                <div className="hero-img">
                  <img src={safeImg(aptImageMap?.[apt.house_nm], { title: apt.house_nm || '', category: 'apt', design: (i % 6) + 1 })} alt={apt.house_nm || "부동산 이미지"} width={400} height={120} loading="lazy" decoding="async" />
