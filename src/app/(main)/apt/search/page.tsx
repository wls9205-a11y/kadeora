...
export const metadata: Metadata = {
  ...
  other: { 'naver:written_time': '2026-04-12T00:00:00Z', 'naver:updated_time': '2026-04-12T00:00:00Z', 'naver:author': '카더라', 'naver:description': '전국 아파트 실거래가 검색', 'og:updated_time': '2026-04-12T00:00:00Z', 'article:section': '부동산', 'article:tag': '실거래가,아파트,시세,매매,검색,부동산', 'dg:plink': SITE_URL + '/apt/search' },
};
