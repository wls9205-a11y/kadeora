  ...
  return (
    <div style={{ maxWidth: 720, margin: '0 auto', padding: '80px 16px', textAlign: 'center' }}>
      ...
      <div style={{ display: 'flex', gap: 'var(--sp-sm)', justifyContent: 'center' }}>
        <button onClick={() => reset()} style={{ padding: 'var(--sp-md) var(--sp-xl)', borderRadius: 'var(--radius-sm)', background: 'var(--brand)', color: '#fff', border: 'none', cursor: 'pointer', fontWeight: 700, fontSize: 'var(--fs-sm)' }}>다시 시도</button>
