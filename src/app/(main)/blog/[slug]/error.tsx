  ...
  return (
    <div style={{ maxWidth: 720, margin: '0 auto', padding: '60px 16px', textAlign: 'center' }}>
      ...
      <div style={{ display: 'flex', gap: 8, justifyContent: 'center' }}>
        ...
        <Link href="/blog" style={{ padding: '10px 20px', borderRadius: 10, background: 'var(--brand)', color: 'var(--text-inverse)', fontSize: 'var(--fs-base)', fontWeight: 600, textDecoration: 'none' }}>
          블로그 목록
        </Link>
      </div>
    </div>
