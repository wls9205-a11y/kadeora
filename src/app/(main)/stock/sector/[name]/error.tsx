  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', minHeight: '50vh', gap: 16, padding: 24, textAlign: 'center' }}>
      ...
      <div style={{ display: 'flex', gap: 8 }}>
        ...
        <Link href="/feed" style={{ padding: '10px 24px', borderRadius: 9999, border: '1px solid var(--border)', background: 'var(--bg-surface)', color: 'var(--text-primary)', fontSize: 'var(--fs-base)', fontWeight: 600, textDecoration: 'none' }}>홈으로</Link>
      </div>
    </div>
  );
}
