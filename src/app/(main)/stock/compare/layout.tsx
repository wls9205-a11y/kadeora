...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    locale: 'ko_KR',
    type: 'website',
    images: [{ url: `${SITE_URL}/api/og?title=${encodeURIComponent('종목 비교')}&design=2&subtitle=${encodeURIComponent('시가총액·등락률·거래량 핵심 지표 비교')}&category=stock`, width: 1200, height: 630, alt: '카더라 종목 비교' }],
  },
