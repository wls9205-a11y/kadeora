...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: `${SITE}/api/og?title=${encodeURIComponent('주식 통계 자료실')}&category=stock&design=2`, width: 1200, height: 630 }, { url: `${SITE_URL}/api/og-square?title=${encodeURIComponent(TITLE)}&category=stock`, width: 630, height: 630 }],
  },
