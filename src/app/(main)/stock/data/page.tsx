...
export default async function StockDataPage() {
  ...
  return (
    <div style={{ maxWidth: 900, margin: '0 auto', padding: '0 16px 80px' }}>
      <JsonLd data={jsonLd} />
      <JsonLd data={{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"카더라","item":SITE},{"@type":"ListItem","position":2,"name":"주식","item":`${SITE}/stock`},{"@type":"ListItem","position":3,"name":"통계 자료실"}]}} />
