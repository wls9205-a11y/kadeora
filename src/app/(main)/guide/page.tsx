...
const FEATURES = [
  ...
  { icon: '🌗', title: '화면 테마', desc: '라이트 모드 하나로 통일했습니다. 별도 전환 설정은 없습니다.' },
...
export default function GuidePage() {
  return (
    <div style={{ maxWidth: 720, margin: '0 auto', padding: '0 var(--sp-lg)' }}>
      <JsonLd data={{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"홈","item":SITE_URL},{"@type":"ListItem","position":2,"name":"가이드","item":SITE_URL + "/guide"}]}} />
      <JsonLd data={{
      ...
      <div style={{ marginBottom: 'var(--sp-xl)' }}>
        <h1 style={{ margin: 0, fontSize: 'var(--fs-xl)', fontWeight: 'var(--fw-title)', color: 'var(--text-primary)' }}>📖 카더라 가이드</h1>
      ...
      <div style={{ marginBottom: 'var(--sp-xl)', padding: 16, background: 'linear-gradient(135deg, rgba(96,165,250,0.06), rgba(52,211,153,0.06))', border: '1px solid var(--border)', borderRadius: 'var(--radius-card)' }}>
        <div style={{ fontSize: 'var(--fs-sm)', fontWeight: 'var(--fw-title)', color: 'var(--text-primary)', marginBottom: 'var(--sp-md)' }}>🚀 빠른 시작 3단계</div>
        <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 'var(--sp-md)' }}>
            <span style={{ width: 28, height: 28, borderRadius: '50%', background: 'var(--brand)', color: '#fff', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 'var(--fs-sm)', fontWeight: 'var(--fw-body)', flexShrink: 0 }}>1</span>
            <div style={{ flex: 1 }}>
              <div style={{ fontSize: 'var(--fs-xs)', fontWeight: 'var(--fw-title)', color: 'var(--text-primary)' }}>카카오 로그인</div>
              <div style={{ fontSize: 'var(--fs-xs)', color: 'var(--text-tertiary)' }}>3초면 가입 완료, 별도 회원가입 불필요</div>
            </div>
            <Link href="/login" style={{ fontSize: 'var(--fs-xs)', padding: '4px 10px', borderRadius: 'var(--radius-xs)', background: 'var(--brand)', color: '#fff', textDecoration: 'none', fontWeight: 'var(--fw-body)', flexShrink: 0 }}>시작 →</Link>
          </div>
          <div style={{ display: 'flex', alignItems: 'center', gap: 'var(--sp-md)' }}>
            <span style={{ width: 28, height: 28, borderRadius: '50%', background: 'var(--brand)', color: '#fff', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 'var(--fs-sm)', fontWeight: 'var(--fw-body)', flexShrink: 0 }}>2</span>
            <div style={{ flex: 1 }}>
              <div style={{ fontSize: 'var(--fs-xs)', fontWeight: 'var(--fw-title)', color: 'var(--text-primary)' }}>관심 종목·지역 등록</div>
              <div style={{ fontSize: 'var(--fs-xs)', color: 'var(--text-tertiary)' }}>주식 ⭐ 관심종목, 부동산 ❤️ 관심단지</div>
            </div>
            <Link href="/stock" style={{ fontSize: 'var(--fs-xs)', padding: '4px 10px', borderRadius: 'var(--radius-xs)', background: 'var(--bg-hover)', color: 'var(--text-secondary)', textDecoration: 'none', fontWeight: 'var(--fw-body)', border: '1px solid var(--border)', flexShrink: 0 }}>등록 →</Link>
          </div>
          <div style={{ display: 'flex', alignItems: 'center', gap: 'var(--sp-md)' }}>
            <span style={{ width: 28, height: 28, borderRadius: '50%', background: 'var(--brand)', color: '#fff', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 'var(--fs-sm)', fontWeight: 'var(--fw-body)', flexShrink: 0 }}>3</span>
            <div style={{ flex: 1 }}>
              <div style={{ fontSize: 'var(--fs-xs)', fontWeight: 'var(--fw-title)', color: 'var(--text-primary)' }}>첫 글 작성</div>
              <div style={{ fontSize: 'var(--fs-xs)', color: 'var(--text-tertiary)' }}>의견을 나누고 포인트도 적립하세요</div>
            </div>
            <Link href="/write" style={{ fontSize: 'var(--fs-xs)', padding: '4px 10px', borderRadius: 'var(--radius-xs)', background: 'var(--bg-hover)', color: 'var(--text-secondary)', textDecoration: 'none', fontWeight: 'var(--fw-body)', border: '1px solid var(--border)', flexShrink: 0 }}>작성 →</Link>
          </div>
        </div>
      </div>
      ...
      <div style={{ background: 'var(--bg-surface)', border: '1px solid var(--border)', borderRadius: 'var(--radius-card)', padding: 20, marginBottom: 'var(--sp-lg)' }}>
        <h2 style={{ margin: '0 0 12px', fontSize: 'var(--fs-base)', fontWeight: 'var(--fw-title)', color: 'var(--text-primary)' }}>주요 기능</h2>
        {FEATURES.map((f, i) => (
          <div key={f.title} style={{ display: 'flex', gap: 10, padding: '10px 0', borderBottom: i < FEATURES.length - 1 ? '1px solid var(--border)' : 'none', alignItems: 'flex-start' }}>
            ...
            <div>
              <div style={{ fontSize: 'var(--fs-base)', fontWeight: 'var(--fw-title)', color: 'var(--text-primary)' }}>{f.title}</div>
      ...
      {/* 등급 안내 */}
      <div style={{ background: 'var(--bg-surface)', border: '1px solid var(--border)', borderRadius: 'var(--radius-card)', padding: 20, marginBottom: 'var(--sp-lg)' }}>
        <h2 style={{ margin: '0 0 4px', fontSize: 'var(--fs-base)', fontWeight: 'var(--fw-title)', color: 'var(--text-primary)' }}>🏅 회원 등급 안내</h2>
        ...
        {[
          ...
          <div key={g.lv} style={{ display: 'flex', alignItems: 'center', gap: 10, padding: '8px 0', borderBottom: i < arr.length - 1 ? '1px solid var(--border)' : 'none' }}>
            ...
            <span style={{ fontSize: 'var(--fs-sm)', fontWeight: 'var(--fw-title)', color: 'var(--text-primary)', flex: 1 }}>Lv.{g.lv} {g.name}</span>
      ...
      {/* 포인트 획득 방법 */}
      <div style={{ background: 'var(--bg-surface)', border: '1px solid var(--border)', borderRadius: 'var(--radius-card)', padding: 20, marginBottom: 'var(--sp-lg)' }}>
        <h2 style={{ margin: '0 0 12px', fontSize: 'var(--fs-base)', fontWeight: 'var(--fw-title)', color: 'var(--text-primary)' }}>💰 포인트 획득 방법</h2>
        {[
          ...
          <div key={p.action} style={{ display: 'flex', alignItems: 'center', gap: 10, padding: '8px 0', borderBottom: i < arr.length - 1 ? '1px solid var(--border)' : 'none' }}>
            <span style={{ fontSize: 'var(--fs-sm)', fontWeight: 'var(--fw-title)', color: 'var(--text-primary)', flex: 1 }}>{p.action}</span>
            <span style={{ fontSize: 'var(--fs-sm)', fontWeight: 'var(--fw-title)', color: 'var(--brand)' }}>{p.pts}</span>
      ...
      {/* 자주 묻는 질문 */}
      <div style={{ background: 'var(--bg-surface)', border: '1px solid var(--border)', borderRadius: 'var(--radius-card)', padding: 20, marginBottom: 'var(--sp-lg)' }}>
        <h2 style={{ margin: '0 0 12px', fontSize: 'var(--fs-base)', fontWeight: 'var(--fw-title)', color: 'var(--text-primary)' }}>❓ 자주 묻는 질문</h2>
        {[
          ...
          <div key={i} style={{ padding: '10px 0', borderBottom: i < arr.length - 1 ? '1px solid var(--border)' : 'none' }}>
            <div style={{ fontSize: 'var(--fs-sm)', fontWeight: 'var(--fw-title)', color: 'var(--text-primary)', marginBottom: 'var(--sp-xs)' }}>Q. {faq.q}</div>
      ...
      <div style={{ background: 'var(--bg-hover)', borderRadius: 'var(--radius-card)', padding: 20, textAlign: 'center' }}>
        <div style={{ fontSize: 'var(--fs-base)', fontWeight: 'var(--fw-title)', color: 'var(--text-primary)', marginBottom: 6 }}>💌 문의·건의</div>
        ...
        <a href={`mailto:${CONTACT_EMAIL}`} style={{ display: 'inline-block', padding: 'var(--sp-md) var(--sp-2xl)', borderRadius: 'var(--radius-md)', background: 'var(--brand)', color: 'var(--text-inverse)', fontSize: 'var(--fs-sm)', fontWeight: 'var(--fw-body)', textDecoration: 'none' }}>
          📧 {CONTACT_EMAIL}
        </a>
      </div>
    </div>
