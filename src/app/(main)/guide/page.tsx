...
export const metadata: Metadata = {
  ...
  other: { 'naver:written_time': '2026-01-15T00:00:00Z', 'naver:updated_time': '2026-03-01T00:00:00Z', 'article:section': '가이드', 'dg:plink': SITE_URL + '/guide' },
};

const FEATURES = [
  { icon: '📋', title: '피드', desc: '전체/우리동네/주식/부동산/자유 탭으로 원하는 주제 글 보기. ▲ 추천 버튼으로 좋은 글 추천. 임시저장 지원.' },
  { icon: '📊', title: '주식', desc: '국내외 주요 종목 실시간 시세 (5분 갱신). 코스피/코스닥/뉴욕/나스닥 탭. 캔들차트, 수급, 뉴스, AI 한줄평, 종목 토론까지.' },
  { icon: '🏢', title: '부동산', desc: '5개 탭 — 📅 청약 일정 · 🏢 분양중 · 🏚️ 미분양 · 🏗️ 재개발 · 💰 실거래. 지역 필터, 마감 임박 알림, 관심단지 등록.' },
  { icon: '📝', title: '블로그', desc: '주식·청약·미분양·재테크 정보 15,400편 이상. 카테고리 필터, 인기글 TOP5, 검색 기능.' },
