...
const FEATURES = [
  ...
  { icon: '📊', title: '주식', desc: '국내외 1,700개 종목 실시간 시세 (5분 갱신). 코스피/코스닥/뉴욕/나스닥 탭. 캔들차트, 수급, 뉴스, AI 한줄평, 종목 토론, 트리맵, 레이더차트까지.' },
  { icon: '🏢', title: '부동산', desc: '5개 탭 — 📅 청약 일정 · 🏢 분양중 · 🏚️ 미분양 · 🏗️ 재개발 · 💰 실거래. 지역 필터, 마감 임박 알림, 관심단지 등록.' },
  { icon: '🏘️', title: '단지백과', desc: '전국 34,000+ 아파트 단지 프로필. 시세, 전세가율, 연차별 통계, 관련 실거래 내역을 한눈에.' },
  { icon: '📝', title: '블로그', desc: '주식·청약·미분양·재테크 정보 22,600편 이상. 카테고리 필터, 인기글 TOP5, 검색 기능. 전문가 분석 매일 업데이트.' },
  { icon: '💬', title: '라운지 토론', desc: '자유방/주식방/부동산방에서 실시간 채팅. 투표형 토론도 가능.' },
  { icon: '🔥', title: '이번 주 HOT', desc: '이번 주 가장 핫한 글 TOP 5와 지역별 인기 글을 한눈에 확인.' },
  { icon: '⚖️', title: '종목 비교', desc: '관심 종목 2~4개를 선택해서 시가총액, 등락률, PER 등 핵심 지표를 나란히 비교.' },
  ...
  { icon: '🏗️', title: '재개발 현황', desc: '전국 202건 재개발·재건축 진행 현황. 단계별(정비구역지정~준공) 필터, 세대수 표시.' },
  { icon: '💰', title: '실거래가', desc: '매매 49만건 + 전월세 209만건 실거래가 검색. 월별 추이, 최고가 대비 % 표시, 지역별 현황.' },
  ...
  { icon: '🔤', title: '글씨 크기', desc: '오른쪽 상단 드롭다운에서 작게/보통/크게 조절. 기본값은 가독성 좋은 크게 크기.' },
  { icon: '🌗', title: '화면 테마', desc: '다크 모드와 라이트 모드 전환 가능. 더보기 메뉴 또는 프로필 드롭다운에서 변경.' },
  { icon: '📊', title: '통계 자료실', desc: '주식/부동산 데이터를 CSV로 무료 다운로드. 종목 시세, 청약, 미분양, 단지백과 데이터 제공.' },
    ...
    <div style={{ maxWidth: 720, margin: '0 auto', padding: '0 var(--sp-lg)' }}>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        mainEntity: [
          ...
          { "@type": "Question", name: "카더라에서 어떤 주식 정보를 볼 수 있나요?", acceptedAnswer: { "@type": "Answer", text: "코스피, 코스닥, NYSE, NASDAQ 1,700개 종목의 실시간 시세, 캔들 차트, 수급 분석, 종목 뉴스, AI 한줄평, 투자자 매매동향, 트리맵, 레이더차트, 종목 비교를 제공합니다." } },
      ...
      <div style={{ background: 'var(--bg-surface)', border: '1px solid var(--border)', borderRadius: 'var(--radius-card)', padding: 20, marginBottom: 'var(--sp-lg)' }}>
        ...
        {[
          ...
          { q: '주식 시세는 실시간인가요?', a: '장중에는 5분 간격으로 갱신됩니다. 국내외 1,700개 종목을 지원합니다.' },
          { q: '청약 정보는 어디서 가져오나요?', a: '국토교통부 공공데이터 API (청약홈)에서 매일 자동 수집합니다.' },
          { q: '단지백과는 뭔가요?', a: '전국 34,000+ 아파트 단지의 시세, 전세가율, 거래 이력을 한눈에 볼 수 있는 프로필 페이지입니다.' },
