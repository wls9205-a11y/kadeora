...
const FEATURES = [
  ...
  { icon: '📊', title: '주식', desc: '국내외 728개 종목 실시간 시세 (5분 갱신). 코스피/코스닥/뉴욕/나스닥 탭. 캔들차트, 수급, 뉴스, AI 한줄평, 종목 토론, 트리맵, 레이더차트까지.' },
  ...
  { icon: '📝', title: '블로그', desc: '주식·청약·미분양·재테크 정보 20,800편 이상. 카테고리 필터, 인기글 TOP5, 검색 기능.' },
  ...
  { icon: '👑', title: '프로 멤버십', desc: '프로 멤버십(월 ₩24,900)으로 AI 분석, 급등락 알림, 무제한 관심 종목을 이용하세요.' },
    ...
    <div style={{ maxWidth: 720, margin: '0 auto', padding: '0 var(--sp-lg)' }}>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        mainEntity: [
          ...
          { "@type": "Question", name: "카더라에서 어떤 주식 정보를 볼 수 있나요?", acceptedAnswer: { "@type": "Answer", text: "코스피, 코스닥, NYSE, NASDAQ 728개 종목의 실시간 시세, 캔들 차트, 수급 분석, 종목 뉴스, AI 한줄평, 투자자 매매동향, 트리맵, 레이더차트, 종목 비교를 제공합니다." } },
      ...
      <div style={{ background: 'var(--bg-surface)', border: '1px solid var(--border)', borderRadius: 'var(--radius-card)', padding: 20, marginBottom: 'var(--sp-lg)' }}>
        ...
        {[
          { q: '카더라는 무료인가요?', a: '네, 모든 기능을 무료로 이용할 수 있습니다. 프로 멤버십(월 ₩24,900)과 확성기 등 일부 유료 상품이 있지만, 핵심 기능은 전부 무료입니다.' },
          { q: '회원 탈퇴는 어떻게 하나요?', a: '프로필 → 계정 설정에서 탈퇴할 수 있습니다. 탈퇴 시 작성한 글과 댓글은 익명 처리됩니다.' },
          { q: '주식 시세는 실시간인가요?', a: '장중에는 5분 간격으로 갱신됩니다. 국내외 728개 종목을 지원합니다.' },
