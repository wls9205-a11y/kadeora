...
const ResidenceNudgeModal = dynamic(() => import('@/components/onboarding/ResidenceNudgeModal'), { ssr: false });
        ...
        <footer className="hidden md:block" style={{
          ...
          <div style={{borderTop:'1px solid var(--border)', paddingTop:16, fontSize: 'var(--fs-xs)', color:'var(--text-tertiary)', textAlign:'center', lineHeight:1.9}}>
            <nav style={{display:'flex', justifyContent:'center', gap:16, flexWrap:'wrap', marginBottom:12, fontSize: 11}}>
              ...
              {/* ⛔ AD-4(2026-09-07) — '/hot' 링크를 뺐다. 푸터는 «전 페이지에» 실리는
                  내부 링크라, noindex 를 걸어 놓고 여기 남겨 두면 크롤러를 계속 그리로
                  보내게 된다 — /feed·/discuss 를 뺐던 A4 와 같은 이유다.
                  라우트는 살아 있다. 직접 주소로는 들어갈 수 있다.
                  (H6-5 가 「인기글」→「많이 본」으로 고쳤던 라벨 자체가 여기서 사라진다) */}
