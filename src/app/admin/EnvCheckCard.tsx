...
export default function EnvCheckCard() {
  ...
  return (
    <div>
      ...
      {data && missingCount > 0 && (
        <div style={{ padding: '10px 14px', borderRadius: 8, background: 'var(--error-bg, #fef2f2)', border: '1px solid var(--error, #ef4444)', marginBottom: 12, fontSize: 'var(--fs-sm)', color: 'var(--error, #ef4444)', fontWeight: 600 }}>
