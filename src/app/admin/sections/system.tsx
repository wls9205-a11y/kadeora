  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
      ...
      <div style={{ background: C.card, border: `1px solid ${C.border}`, borderRadius: 12, padding: 16 }}>
        <div style={{ fontSize: 14, fontWeight: 700, color: C.text, marginBottom: 12 }}>⚡ Supabase (Pro)</div>
        {db ? (
          <>
            ...
            <div className="mc-g4" style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 8, marginTop: 12 }}>
              {[
...
function EnvTab() {
  ...
  return (
    <div>
      <div style={{ background: C.card, border: `1px solid ${totalOk === total ? C.green : C.yellow}40`, borderRadius: 12, padding: 16, marginBottom: 16, textAlign: 'center' }}>
        <div style={{ fontSize: 28, fontWeight: 800, color: totalOk === total ? C.green : C.yellow }}>{totalOk}/{total}</div>
    ...
    <div>
      ...
      {flags.map(f => (
        <div key={f.key} style={{
          ...
          background: C.card, border: `1px solid ${C.border}`, borderRadius: 10, marginBottom: 8,
        }}>
          <div>
