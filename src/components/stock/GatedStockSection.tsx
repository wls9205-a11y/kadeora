  ...
  return (
    ...
    >
      {(gate?.display_name || fallbackTitle) && (
        <h3 style={{ fontSize: 'var(--fs-base)', fontWeight: 'var(--fw-title)', margin: '0 0 12px', color: 'var(--text-primary)' }}>
          {gate?.display_name || fallbackTitle}
        </h3>
      )}
      ...
      >
        ...
        <div style={{ fontSize: 'var(--fs-sm)', fontWeight: 'var(--fw-title)', marginBottom: 14, color: 'var(--text-primary)', wordBreak: 'keep-all' }}>
        ...
        <button
          ...
          style={{
            ...
            fontWeight: 'var(--fw-body)', fontSize: 'var(--fs-sm)',
