...
export default function BlogCommentCTA({ commentCount }: { commentCount: number }) {
  ...
  return (
    <div style={{
      ...
      <div style={{ fontSize: 'var(--fs-md)', fontWeight: 'var(--fw-title)', color: 'var(--text-primary)', marginBottom: 6 }}>
        첫 번째 댓글의 주인공이 되어주세요!
      </div>
      ...
      <div style={{
        ...
        <span style={{ fontSize: 'var(--fs-sm)', fontWeight: 'var(--fw-body)', color: 'var(--accent-yellow)' }}>댓글 작성 시 5P 적립</span>
      </div>
    </div>
  );
}
