...
const TEXTS: Record<string, { disclaimer: string; source?: string }> = {
  ...
  apt: {
    ...
    source: '청약: 공공데이터포털(data.go.kr) · 실거래: 국토교통부 실거래가 공개시스템 · 위성영상: 국토교통부 공간정보 오픈플랫폼(VWorld)',
  },
  unsold: {
    disclaimer: '본 정보는 참고용이며 투자 권유가 아닙니다. 투자에 따른 손익은 투자자 본인에게 귀속됩니다.',
    source: '국토교통부 미분양주택현황 통계 · 매월 말 발표 기준 · 위성영상: 국토교통부 공간정보 오픈플랫폼(VWorld)',
  },
  redev: {
    disclaimer: '본 정보는 참고용이며 투자 권유가 아닙니다. 실제 진행 상황은 해당 조합 또는 지자체에 직접 확인하세요.',
    source: '서울시·경기도·부산시 공공데이터 · 매주 월요일 갱신 · 위성영상: 국토교통부 공간정보 오픈플랫폼(VWorld)',
  },
  trade: {
    disclaimer: '본 정보는 참고용이며 투자 권유가 아닙니다.',
    source: '국토교통부 실거래가 공개시스템 기준 · 위성영상: 국토교통부 공간정보 오픈플랫폼(VWorld)',
  },
  feed: {
  ...
  general: {
    ...
    source: '청약: 공공데이터포털 · 미분양: 국토교통부 · 실거래: 국토교통부 · 주식: 금융위원회 · 해외시세: Yahoo Finance · 재개발: 서울시·경기도·부산시 · 위성영상: 국토교통부 공간정보 오픈플랫폼(VWorld)',
  },
};
