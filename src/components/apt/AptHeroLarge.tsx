      ...
      >
        ...
        <div style={{ position: 'relative', height: 240, background: 'var(--bg-hover)', overflow: 'hidden' }}>
          ...
          <div style={{
            ...
            <h2 style={{
              margin: 0, fontSize: 'var(--fs-md)', fontWeight: 'var(--fw-num)', letterSpacing: '-0.2px', lineHeight: 1.3,
              textShadow: '0 1px 2px rgba(0,0,0,0.4)',
              overflow: 'hidden', textOverflow: 'ellipsis', display: '-webkit-box', WebkitLineClamp: 2, WebkitBoxOrient: 'vertical',
            }}>
              {site.name}
            </h2>
            <span style={{ fontSize: 'var(--fs-xs)', fontWeight: 'var(--fw-title)', opacity: 0.92, textShadow: '0 1px 2px rgba(0,0,0,0.4)' }}>
...
function kpiLabelStyle(): React.CSSProperties {
  return { fontSize: 'var(--fs-2xs)', fontWeight: 'var(--fw-body)', color: 'var(--text-tertiary)', letterSpacing: 0 };
}
