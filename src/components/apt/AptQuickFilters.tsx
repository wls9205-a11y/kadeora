    ...
    >
      <button
        ...
        style={{
          ...
          fontSize: 'var(--fs-xs)', fontWeight: 'var(--fw-body)', color: 'var(--text-secondary)', cursor: 'pointer',
        }}
      >
      ...
      {!collapsed && (
        <div style={{ display: 'flex', flexDirection: 'column', gap: 10, paddingBottom: 8 }}>
          {/* 가격대 */}
          <div>
            <div style={{ fontSize: 'var(--fs-xs)', fontWeight: 'var(--fw-body)', color: 'var(--text-tertiary)', marginBottom: 5, letterSpacing: 0 }}>가격대</div>
          ...
          {/* 평형 */}
          <div>
            <div style={{ fontSize: 'var(--fs-xs)', fontWeight: 'var(--fw-body)', color: 'var(--text-tertiary)', marginBottom: 5, letterSpacing: 0 }}>평형</div>
            <div style={{ display: 'flex', gap: 5, flexWrap: 'wrap' }}>
              {SIZE_BANDS.map((b) => (
                <button
                  key={b.value}
          ...
          {topBuilders && topBuilders.length > 0 && (
            <div>
              <div style={{ fontSize: 'var(--fs-xs)', fontWeight: 'var(--fw-body)', color: 'var(--text-tertiary)', marginBottom: 5, letterSpacing: 0 }}>{filters.region} 주요 시공사</div>
              <div style={{ display: 'flex', gap: 5, flexWrap: 'wrap' }}>
