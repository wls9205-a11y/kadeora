    ...
    >
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 'var(--sp-xs)' }}>
        ...
        <span style={{ flex: 1, minWidth: 0, display: 'flex', flexDirection: 'column' }}>
          <span style={{ fontSize: 'var(--fs-2xs)', fontWeight: 'var(--fw-body)', lineHeight: 1.3, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
            {data.name}
          </span>
          <span style={{ fontSize: 'var(--fs-2xs)', color: 'var(--text-tertiary)', lineHeight: 1.3, whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>
        ...
        <span style={{ ...chip, padding: '1px 6px', borderRadius: 'var(--radius-xs)', fontSize: 'var(--fs-2xs)', lineHeight: 1.3, fontVariantNumeric: 'tabular-nums', whiteSpace: 'nowrap' }}>
