...
const CSP_DIRECTIVES = [
  ...
  "img-src 'self' data: blob: https://*.supabase.co https://lh3.googleusercontent.com https://*.kakaocdn.net https://*.daumcdn.net https://www.googletagmanager.com https://kadeora.app https://*.pstatic.net https://*.naver.net https://*.naver.com",
