...
const KEYWORD_WEIGHT: Record<string, number> = {
  ...
  // v2: 재테크/세금/경제/생활 키워드
  '예금 금리': 2, '적금 금리': 2, '특판': 2, '전세대출': 2, '주담대': 2,
  'ISA': 2, 'ETF': 2, '배당주': 2, '국민연금': 2, 'IRP': 2,
  '양도소득세': 2, '종합부동산세': 2, '취득세': 2, '연말정산': 2, '증여세': 2, '상속세': 2,
  '원달러': 2, '환율': 2, 'CPI': 2, 'GDP': 2, '금통위': 2,
  '최저시급': 2, '최저임금': 2, '실업급여': 2, '건강보험료': 2, '전기차 보조금': 2,
  '금리 인상': 2, '금리 인하': 2, '실손보험': 2, '퇴직연금': 2,
};
