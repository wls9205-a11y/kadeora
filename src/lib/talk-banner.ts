...
/**
 * 오픈채팅 참여자 수 — «하한 표기» 문자열.
 *
 * 하한 표기 — 실측 1,240(2026-07-18) 기준, 수동 갱신 불필요 설계 (HC_CLOSE_20260913 K-2 · C-5 ㄴ).
 * 카카오가 참여자 수 API 를 주지 않아 정확 숫자는 반드시 낡는다. 그래서 «넘었다고 확인된 선»만 쓴다.
 *
 * ⛔ 숫자 상수로 되돌리지 말 것. 숫자가 있으면 누군가 toLocaleString 으로 정확 숫자를 다시 렌더한다.
 *    이 모듈은 표시 문자열만 내보낸다.
 */
export const TALK_MEMBER_LABEL = '1,200+';
