...
export const DEMO_POSTS: PostWithProfile[] = [
  {
    id: 1, user_id: 'demo-1', category: 'apt', title: '강동구 둔촌주공 재건축 근황 알아봤습니다',
  ...
  {
    id: 2, user_id: 'demo-2', category: 'stock', title: '삼성전자 5만원대 진입 여부 분석 (기술적 분석)',
  ...
  {
    id: 3, user_id: 'demo-3', category: 'free', title: '토스뱅크 파킹통장 금리 인상 됐네요',
  ...
  {
    id: 4, user_id: 'demo-4', category: 'stock', title: '코스피 3000 돌파 가능성 있나요? 개인적 분석',
  ...
  {
    id: 5, user_id: 'demo-5', category: 'apt', title: '서울 청약 가점 40점대면 어떤 아파트 狙아야 하나요',
  ...
  {
    id: 6, user_id: 'demo-6', category: 'free', title: 'ETF 초보인데 KODEX200 vs TIGER200 차이점 뭔가요',
  ...
  {
    id: 7, user_id: 'demo-7', category: 'stock', title: 'HBM 관련주 정리해봤습니다 (SK하이닉스, 마이크론 등)',
  ...
  {
    id: 8, user_id: 'demo-8', category: 'apt', title: '경기도 청약 당첨 후기 (수원 팔달구 공공분양)',
...
export const DEMO_APT: AptSubscription[] = [
  { id: 1, name: '래미안 원베일리', location: '서울 서초구', total_units: 2990, subscription_type: '민간분양', application_start: '2026-03-20', application_end: '2026-03-22', move_in_date: '2027-12-01', min_price: 150000, max_price: 280000, status: 'upcoming', competition_rate: null, homepage_url: 'https://applyhome.co.kr', created_at: new Date().toISOString() },
  { id: 2, name: '힐스테이트 광교중앙역', location: '경기 수원시', total_units: 845, subscription_type: '민간분양', application_start: '2026-03-15', application_end: '2026-03-17', move_in_date: '2027-06-01', min_price: 58000, max_price: 95000, status: 'open', competition_rate: 47.3, homepage_url: 'https://applyhome.co.kr', created_at: new Date().toISOString() },
  { id: 3, name: '검단 푸르지오 더 파크', location: '인천 서구', total_units: 1284, subscription_type: '공공분양', application_start: '2026-03-10', application_end: '2026-03-12', move_in_date: '2027-03-01', min_price: 35000, max_price: 52000, status: 'closed', competition_rate: 23.1, homepage_url: 'https://applyhome.co.kr', created_at: new Date().toISOString() },
  { id: 4, name: '올림픽파크 포레온 2차', location: '서울 강동구', total_units: 4786, subscription_type: '민간분양', application_start: '2026-04-08', application_end: '2026-04-10', move_in_date: '2028-06-01', min_price: 120000, max_price: 198000, status: 'upcoming', competition_rate: null, homepage_url: 'https://applyhome.co.kr', created_at: new Date().toISOString() },
  { id: 5, name: '평택 브레인시티 e편한세상', location: '경기 평택시', total_units: 2156, subscription_type: '공공분양', application_start: '2026-03-25', application_end: '2026-03-27', move_in_date: '2027-09-01', min_price: 28000, max_price: 45000, status: 'upcoming', competition_rate: null, homepage_url: 'https://applyhome.co.kr', created_at: new Date().toISOString() },
  { id: 6, name: '위례 자이 더 시티', location: '경기 성남시', total_units: 698, subscription_type: '민간분양', application_start: '2026-02-28', application_end: '2026-03-02', move_in_date: '2026-12-01', min_price: 75000, max_price: 125000, status: 'closed', competition_rate: 128.7, homepage_url: 'https://applyhome.co.kr', created_at: new Date().toISOString() },
];
...
export const GRADE_INFO: Record<string, { icon: string; color: string }> = {
  ...
  '새싹': { icon: '🌿', color: '#10B981' },
  '브론즈': { icon: '🥉', color: '#CD7F32' },
  '실버': { icon: '🥈', color: '#C0C0C0' },
  '골드': { icon: '🥇', color: '#FFD700' },
  '플래티넘': { icon: '💎', color: '#8B5CF6' },
