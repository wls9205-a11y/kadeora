...
export const CALC_REGISTRY: CalcMeta[] = [
  ...
  // ════════════════════════════════════════
  {
    ...
    seoContent: '<h2>2026 청약 가점 계산기 완벽 가이드</h2><p>무주택기간·부양가족·청약통장 가입기간(배우자 합산)으로 청약 가점 84점 만점 자동 계산. 주택공급규칙 별표1 기준. 카더라 청약 가점 계산기는 2026년 최신 기준을 반영합니다.</p><p>본 계산기는 <strong>주택공급에 관한 규칙 제28조 별표1</strong>를 기준으로 계산합니다. 규정은 매년 개정될 수 있으므로 전문가 확인을 권장합니다.</p><h2>부동산 거래 핵심 정보</h2><p>부동산 거래 시 중개수수료(0.4~0.9%), 등기비용, 취득세, 대출이자 등 다양한 비용이 발생합니다. 사전에 총 비용을 정확히 계산하면 예상치 못한 지출을 방지할 수 있습니다. 등기부등본·건축물대장·토지이용계획확인서는 반드시 확인하세요.</p><h2>이런 분들에게 추천</h2><p>주택 매매·전세·월세를 계획 중인 분, 부동산 투자 수익률을 분석하고 싶은 분, 대출 가능 금액을 확인하고 싶은 분에게 유용합니다.</p>', relatedCalcs: ['brokerage-fee', 'jeonse-wolse', 'acquisition-tax'],
  ...
  },
  {
    ...
    faqs: [
      { q: '평수 환산기 결과는 실제와 같나요?', a: '참고용이며, 지역·물건 특성에 따라 차이가 있을 수 있습니다. 계량법를 기준으로 계산합니다.' },
    ...
    seoContent: '<h2>평수 ↔ 제곱미터(㎡) 환산기 완벽 가이드</h2><p>평(坪)을 제곱미터(㎡)로, 제곱미터를 평으로 즉시 변환. 1평 = 3.3058㎡. 카더라 평수 환산기는 2026년 최신 기준을 반영합니다.</p><p>본 계산기는 <strong>계량법</strong>를 기준으로 계산합니다. 규정은 매년 개정될 수 있으므로 전문가 확인을 권장합니다.</p><h2>부동산 거래 핵심 정보</h2><p>부동산 거래 시 중개수수료(0.4~0.9%), 등기비용, 취득세, 대출이자 등 다양한 비용이 발생합니다. 사전에 총 비용을 정확히 계산하면 예상치 못한 지출을 방지할 수 있습니다. 등기부등본·건축물대장·토지이용계획확인서는 반드시 확인하세요.</p><h2>이런 분들에게 추천</h2><p>주택 매매·전세·월세를 계획 중인 분, 부동산 투자 수익률을 분석하고 싶은 분, 대출 가능 금액을 확인하고 싶은 분에게 유용합니다.</p>', relatedCalcs: ['brokerage-fee', 'rental-yield'],
  },
  {
    ...
    seoContent: '<h2>전월세 전환 계산기 완벽 가이드</h2><p>전세보증금을 월세로, 월세를 전세로 전환 시 적정 금액을 계산. 전월세전환율 자동 적용. 카더라 전월세 전환 계산기는 2026년 최신 기준을 반영합니다.</p><p>본 계산기는 <strong>주택임대차보호법 제7조의2</strong>를 기준으로 계산합니다. 규정은 매년 개정될 수 있으므로 전문가 확인을 권장합니다.</p><h2>부동산 거래 핵심 정보</h2><p>부동산 거래 시 중개수수료(0.4~0.9%), 등기비용, 취득세, 대출이자 등 다양한 비용이 발생합니다. 사전에 총 비용을 정확히 계산하면 예상치 못한 지출을 방지할 수 있습니다. 등기부등본·건축물대장·토지이용계획확인서는 반드시 확인하세요.</p><h2>이런 분들에게 추천</h2><p>주택 매매·전세·월세를 계획 중인 분, 부동산 투자 수익률을 분석하고 싶은 분, 대출 가능 금액을 확인하고 싶은 분에게 유용합니다.</p>', relatedCalcs: ['brokerage-fee', 'rental-yield', 'jeonse-vs-wolse'],
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: '관련 계산기가 더 있나요?', a: '카더라는 부동산 포함 142종의 무료 계산기를 제공합니다.' },
    ], seoContent: '<h2>임대수익률 계산기 완벽 가이드</h2><p>부동산 매입가 대비 월세 수익률(연 수익률)을 계산. 공실률·관리비·세금 반영. 카더라 임대수익률 계산기는 2026년 최신 기준을 반영합니다.</p><h2>부동산 거래 핵심 정보</h2><p>부동산 거래 시 중개수수료(0.4~0.9%), 등기비용, 취득세, 대출이자 등 다양한 비용이 발생합니다. 사전에 총 비용을 정확히 계산하면 예상치 못한 지출을 방지할 수 있습니다. 등기부등본·건축물대장·토지이용계획확인서는 반드시 확인하세요.</p><h2>이런 분들에게 추천</h2><p>주택 매매·전세·월세를 계획 중인 분, 부동산 투자 수익률을 분석하고 싶은 분, 대출 가능 금액을 확인하고 싶은 분에게 유용합니다.</p>', relatedCalcs: ['jeonse-wolse', 'brokerage-fee'],
  ...
  // ════════════════════════════════════════
  {
    ...
    seoContent: '<h2>복리의 마법 — 시간이 만드는 수익</h2><p>복리는 이자에 이자가 붙는 원리로, 장기 투자 시 놀라운 자산 증식 효과를 발휘합니다. 1,000만원을 연 7% 복리로 30년 투자하면 약 7,612만원으로 불어납니다.</p><h2>복리 계산 공식</h2><p>최종금액 = 원금 × (1 + 이율)^기간. 72법칙: 72 ÷ 연수익률(%) = 원금 2배 걸리는 년수. 연 6%→12년, 연 8%→9년, 연 12%→6년.</p><h2>복리 효과 비교</h2><p>1,000만원 투자 시: 연 5% 30년→4,322만원. 연 7% 30년→7,612만원. 연 10% 30년→1억7,449만원. 이자소득세(15.4%) 적용 후 실질 수익률은 약 84.6%입니다.</p><h2>계산 시 유의사항</h2><p>본 계산기의 결과는 참고용이며, 세금·수수료·인플레이션은 별도 고려해야 합니다.</p>', relatedCalcs: ['dca-simulator', 'dividend-calc', 'fire-calc'],
  },
  {
    ...
    faqs: [
      { q: '주식 수익률 계산기에서 세금은 반영되나요?', a: '국내 주식 증권거래세(매도 시 부과 — 세율은 시장별로 다르다)와 수수료를 반영합니다. 해외주식은 양도세(22%, 250만원 공제) 별도입니다.' },
    ...
    ], seoContent: '<h2>주식 수익률 계산기 완벽 가이드</h2><p>매수가·매도가·수량을 입력하면 수익률, 수익금, 세금(수수료 포함)을 자동 계산. 카더라 주식 수익률 계산기는 수수료, 세금을 반영한 실질 수익을 계산합니다.</p><h2>투자 핵심 정보</h2><p>투자 수익에는 증권거래세(매도 시 부과 — 세율은 시장별로 다르다), 수수료, 배당소득세(15.4%), 해외주식 양도세(22%, 250만원 공제) 등이 적용됩니다. 72법칙(72÷수익률=원금2배 년수)으로 복리 효과를 빠르게 파악할 수 있습니다. 장기 적립식 투자와 배당 재투자가 자산 증식의 핵심입니다.</p><h2>이런 분들에게 추천</h2><p>주식·펀드·ETF 투자자, 배당 투자 계획 중인 분, 투자 성과를 정확히 측정하고 싶은 분에게 유용합니다. 투자에는 원금 손실 위험이 있으며, 본 계산기는 참고용입니다.</p>', relatedCalcs: ['avg-down', 'breakeven', 'overseas-cgt'],
  },
  {
    ...
    faqs: [
      { q: '물타기 계산기에서 세금은 반영되나요?', a: '국내 주식 증권거래세(매도 시 부과 — 세율은 시장별로 다르다)와 수수료를 반영합니다. 해외주식은 양도세(22%, 250만원 공제) 별도입니다.' },
      { q: '투자 수익 과세 기준은?', a: '국내 상장주식은 대주주만 양도세, 해외주식은 250만원 초과 시 22%, 배당은 15.4% 원천징수입니다.' },
      { q: '물타기 계산기는 무료인가요?', a: '네, 카더라 물타기 계산기는 무료이며 회원가입 없이 무제한 이용 가능합니다.' },
      { q: '물타기 계산기는 모바일에서도 되나요?', a: '네, 모든 기기에서 최적화되어 있습니다.' },
      { q: '관련 계산기가 더 있나요?', a: '카더라는 주식/투자 포함 142종의 무료 계산기를 제공합니다.' },
    ], seoContent: '<h2>물타기(평단가) 계산기 완벽 가이드</h2><p>추가 매수 시 평균 매수단가를 계산. 목표가까지 필요한 추가 매수량도 확인. 카더라 물타기 계산기는 수수료, 세금을 반영한 실질 수익을 계산합니다.</p><h2>투자 핵심 정보</h2><p>투자 수익에는 증권거래세(매도 시 부과 — 세율은 시장별로 다르다), 수수료, 배당소득세(15.4%), 해외주식 양도세(22%, 250만원 공제) 등이 적용됩니다. 72법칙(72÷수익률=원금2배 년수)으로 복리 효과를 빠르게 파악할 수 있습니다. 장기 적립식 투자와 배당 재투자가 자산 증식의 핵심입니다.</p><h2>이런 분들에게 추천</h2><p>주식·펀드·ETF 투자자, 배당 투자 계획 중인 분, 투자 성과를 정확히 측정하고 싶은 분에게 유용합니다. 투자에는 원금 손실 위험이 있으며, 본 계산기는 참고용입니다.</p>', relatedCalcs: ['stock-roi', 'breakeven'],
  ...
  },
  {
    ...
    faqs: [
      { q: '손익분기점 계산기에서 세금은 반영되나요?', a: '국내 주식 증권거래세(매도 시 부과 — 세율은 시장별로 다르다)와 수수료를 반영합니다. 해외주식은 양도세(22%, 250만원 공제) 별도입니다.' },
      { q: '투자 수익 과세 기준은?', a: '국내 상장주식은 대주주만 양도세, 해외주식은 250만원 초과 시 22%, 배당은 15.4% 원천징수입니다.' },
      { q: '손익분기점 계산기는 무료인가요?', a: '네, 카더라 손익분기점 계산기는 무료이며 회원가입 없이 무제한 이용 가능합니다.' },
      { q: '손익분기점 계산기는 모바일에서도 되나요?', a: '네, 모든 기기에서 최적화되어 있습니다.' },
      { q: '관련 계산기가 더 있나요?', a: '카더라는 주식/투자 포함 142종의 무료 계산기를 제공합니다.' },
    ],
    seoContent: '<h2>손익분기점 계산기 완벽 가이드</h2><p>현재 손실에서 본전까지 필요한 수익률을 계산. 카더라 손익분기점 계산기는 수수료, 세금을 반영한 실질 수익을 계산합니다.</p><h2>투자 핵심 정보</h2><p>투자 수익에는 증권거래세(매도 시 부과 — 세율은 시장별로 다르다), 수수료, 배당소득세(15.4%), 해외주식 양도세(22%, 250만원 공제) 등이 적용됩니다. 72법칙(72÷수익률=원금2배 년수)으로 복리 효과를 빠르게 파악할 수 있습니다. 장기 적립식 투자와 배당 재투자가 자산 증식의 핵심입니다.</p><h2>이런 분들에게 추천</h2><p>주식·펀드·ETF 투자자, 배당 투자 계획 중인 분, 투자 성과를 정확히 측정하고 싶은 분에게 유용합니다. 투자에는 원금 손실 위험이 있으며, 본 계산기는 참고용입니다.</p>', relatedCalcs: ['stock-roi', 'avg-down'],
  },
  {
  ...
  },
  {
    ...
    faqs: [
      { q: '적립식 투자 계산기에서 세금은 반영되나요?', a: '국내 주식 증권거래세(매도 시 부과 — 세율은 시장별로 다르다)와 수수료를 반영합니다. 해외주식은 양도세(22%, 250만원 공제) 별도입니다.' },
      { q: '투자 수익 과세 기준은?', a: '국내 상장주식은 대주주만 양도세, 해외주식은 250만원 초과 시 22%, 배당은 15.4% 원천징수입니다.' },
      { q: '적립식 투자 계산기는 무료인가요?', a: '네, 카더라 적립식 투자 계산기는 무료이며 회원가입 없이 무제한 이용 가능합니다.' },
      { q: '적립식 투자 계산기는 모바일에서도 되나요?', a: '네, 모든 기기에서 최적화되어 있습니다.' },
      { q: '관련 계산기가 더 있나요?', a: '카더라는 주식/투자 포함 142종의 무료 계산기를 제공합니다.' },
    ], seoContent: '<h2>적립식 투자 시뮬레이터 완벽 가이드</h2><p>매월 일정 금액을 투자할 때 목표 금액 달성 기간과 최종 자산을 시뮬레이션. 카더라 적립식 투자 계산기는 수수료, 세금을 반영한 실질 수익을 계산합니다.</p><h2>투자 핵심 정보</h2><p>투자 수익에는 증권거래세(매도 시 부과 — 세율은 시장별로 다르다), 수수료, 배당소득세(15.4%), 해외주식 양도세(22%, 250만원 공제) 등이 적용됩니다. 72법칙(72÷수익률=원금2배 년수)으로 복리 효과를 빠르게 파악할 수 있습니다. 장기 적립식 투자와 배당 재투자가 자산 증식의 핵심입니다.</p><h2>이런 분들에게 추천</h2><p>주식·펀드·ETF 투자자, 배당 투자 계획 중인 분, 투자 성과를 정확히 측정하고 싶은 분에게 유용합니다. 투자에는 원금 손실 위험이 있으며, 본 계산기는 참고용입니다.</p>', relatedCalcs: ['compound-interest', 'fire-calc'],
  },
  {
    ...
    faqs: [
      { q: 'PER/PBR 계산기에서 세금은 반영되나요?', a: '국내 주식 증권거래세(매도 시 부과 — 세율은 시장별로 다르다)와 수수료를 반영합니다. 해외주식은 양도세(22%, 250만원 공제) 별도입니다.' },
      { q: '투자 수익 과세 기준은?', a: '국내 상장주식은 대주주만 양도세, 해외주식은 250만원 초과 시 22%, 배당은 15.4% 원천징수입니다.' },
      { q: 'PER/PBR 계산기는 무료인가요?', a: '네, 카더라 PER/PBR 계산기는 무료이며 회원가입 없이 무제한 이용 가능합니다.' },
      { q: 'PER/PBR 계산기는 모바일에서도 되나요?', a: '네, 모든 기기에서 최적화되어 있습니다.' },
      { q: '관련 계산기가 더 있나요?', a: '카더라는 주식/투자 포함 142종의 무료 계산기를 제공합니다.' },
    ], seoContent: '<h2>PER/PBR 적정주가 계산기 완벽 가이드</h2><p>EPS×PER, BPS×PBR로 적정 주가를 추정. 카더라 PER/PBR 계산기는 수수료, 세금을 반영한 실질 수익을 계산합니다.</p><h2>투자 핵심 정보</h2><p>투자 수익에는 증권거래세(매도 시 부과 — 세율은 시장별로 다르다), 수수료, 배당소득세(15.4%), 해외주식 양도세(22%, 250만원 공제) 등이 적용됩니다. 72법칙(72÷수익률=원금2배 년수)으로 복리 효과를 빠르게 파악할 수 있습니다. 장기 적립식 투자와 배당 재투자가 자산 증식의 핵심입니다.</p><h2>이런 분들에게 추천</h2><p>주식·펀드·ETF 투자자, 배당 투자 계획 중인 분, 투자 성과를 정확히 측정하고 싶은 분에게 유용합니다. 투자에는 원금 손실 위험이 있으며, 본 계산기는 참고용입니다.</p>', relatedCalcs: ['stock-roi', 'dividend-calc'],
  ...
  },
  {
    ...
    faqs: [
      // ⛔ 여기 있던 「국내 주식 증권거래세(매도 시 부과 — 세율은 시장별로 다르다)…」는 주식 계산기 FAQ 를 복사해 온 것이었다.
      ...
      { q: '관련 계산기가 더 있나요?', a: '카더라는 주식/투자 포함 142종의 무료 계산기를 제공합니다.' },
    ], seoContent: '<h2>환율 환산 계산기 완벽 가이드</h2><p>원/달러/엔/유로 환율 실시간 변환. 카더라 환율 계산기는 수수료, 세금을 반영한 실질 수익을 계산합니다.</p><h2>투자 핵심 정보</h2><p>투자 수익에는 증권거래세(매도 시 부과 — 세율은 시장별로 다르다), 수수료, 배당소득세(15.4%), 해외주식 양도세(22%, 250만원 공제) 등이 적용됩니다. 72법칙(72÷수익률=원금2배 년수)으로 복리 효과를 빠르게 파악할 수 있습니다. 장기 적립식 투자와 배당 재투자가 자산 증식의 핵심입니다.</p><h2>이런 분들에게 추천</h2><p>주식·펀드·ETF 투자자, 배당 투자 계획 중인 분, 투자 성과를 정확히 측정하고 싶은 분에게 유용합니다. 투자에는 원금 손실 위험이 있으며, 본 계산기는 참고용입니다.</p>', relatedCalcs: ['overseas-cgt', 'stock-roi'],
  ...
  // ════════════════════════════════════════
  {
    ...
    seoContent: '<h2>연봉 실수령액이란?</h2><p>세전 연봉에서 근로소득세, 지방소득세, 4대보험료를 공제한 실제 수령 금액입니다. 같은 연봉이라도 부양가족 수, 비과세 급여에 따라 실수령액이 달라집니다.</p><h2>2026년 4대보험료율</h2><p>국민연금 4.5%, 건강보험 3.545%, 장기요양 건강보험의 12.81%, 고용보험 0.9%. 합계 약 9.4%가 공제됩니다.</p><h3>연봉별 실수령액 예시</h3><p>3,000만→약 226만/월. 4,000만→약 291만/월. 5,000만→약 352만/월. 6,000만→약 411만/월. 1억→약 631만/월 (부양가족 1인 기준).</p><h2>실수령액 높이는 방법</h2><p>비과세 급여(식대 20만원) 활용, 연금저축/IRP 세액공제 최대 활용, 체크카드 사용 비율 높이기 등으로 연말정산 환급을 극대화할 수 있습니다.</p>', relatedCalcs: ['4-insurance', 'retirement-pay', 'year-end-refund'],
  },
  {
    ...
    faqs: [
      { q: '4대보험 계산기에서 4대보험은 어떻게 적용되나요?', a: '국민연금 4.5%, 건강보험 3.545%, 장기요양 0.45%, 고용보험 0.9% — 합계 약 9.4%가 공제됩니다.' },
      { q: '비과세 급여란?', a: '식대(월 20만원), 자가운전보조금(월 20만원), 출산보육수당(월 20만원) 등 소득세 면제 항목입니다.' },
      { q: '4대보험 계산기 결과가 실제와 다를 수 있나요?', a: '부양가족 수, 비과세 항목, 보험 상한 등에 따라 차이가 발생합니다. 국민연금법, 국민건강보험법, 고용보험법를 기준으로 계산합니다.' },
      { q: '4대보험 계산기는 모바일에서도 되나요?', a: '네, 모든 기기에서 최적화되어 있습니다.' },
      { q: '관련 계산기가 더 있나요?', a: '카더라는 급여/노동 포함 142종의 무료 계산기를 제공합니다.' },
    ],
    seoContent: '<h2>4대보험 계산기 완벽 가이드</h2><p>월급에서 공제되는 국민연금·건강보험·고용보험·장기요양보험 금액을 계산. 카더라 4대보험 계산기는 2026년 4대보험 요율과 근로소득 간이세액표를 반영합니다.</p><p>본 계산기는 <strong>국민연금법, 국민건강보험법, 고용보험법</strong>를 기준으로 계산합니다. 규정은 매년 개정될 수 있으므로 전문가 확인을 권장합니다.</p><h2>급여 핵심 정보</h2><p>직장인 세전 급여에서 국민연금(4.5%), 건강보험(3.545%), 장기요양(0.45%), 고용보험(0.9%) 합계 약 9.4%가 공제됩니다. 여기에 근로소득세와 지방소득세가 추가됩니다. 비과세 급여(식대 20만원, 자가운전보조금 20만원)를 활용하면 실수령액을 높일 수 있습니다.</p><h2>이런 분들에게 추천</h2><p>연봉 협상 중인 직장인, 첫 취업을 앞둔 구직자, 급여 명세서를 이해하고 싶은 분에게 유용합니다. 연말정산 환급을 극대화하려면 체크카드 사용 비율을 높이고, IRP/연금저축에 최대 납입하세요.</p>', relatedCalcs: ['net-salary', 'retirement-pay'],
  },
  {
    ...
    faqs: [
      { q: '퇴직금 계산기에서 4대보험은 어떻게 적용되나요?', a: '국민연금 4.5%, 건강보험 3.545%, 장기요양 0.45%, 고용보험 0.9% — 합계 약 9.4%가 공제됩니다.' },
      { q: '비과세 급여란?', a: '식대(월 20만원), 자가운전보조금(월 20만원), 출산보육수당(월 20만원) 등 소득세 면제 항목입니다.' },
      { q: '퇴직금 계산기 결과가 실제와 다를 수 있나요?', a: '부양가족 수, 비과세 항목, 보험 상한 등에 따라 차이가 발생합니다. 근로자퇴직급여보장법 제8조를 기준으로 계산합니다.' },
      { q: '퇴직금 계산기는 모바일에서도 되나요?', a: '네, 모든 기기에서 최적화되어 있습니다.' },
      { q: '관련 계산기가 더 있나요?', a: '카더라는 급여/노동 포함 142종의 무료 계산기를 제공합니다.' },
    ], seoContent: '<h2>퇴직금 계산기 완벽 가이드</h2><p>근속연수·평균임금으로 퇴직금과 퇴직소득세를 자동 계산. 카더라 퇴직금 계산기는 2026년 4대보험 요율과 근로소득 간이세액표를 반영합니다.</p><p>본 계산기는 <strong>근로자퇴직급여보장법 제8조</strong>를 기준으로 계산합니다. 규정은 매년 개정될 수 있으므로 전문가 확인을 권장합니다.</p><h2>급여 핵심 정보</h2><p>직장인 세전 급여에서 국민연금(4.5%), 건강보험(3.545%), 장기요양(0.45%), 고용보험(0.9%) 합계 약 9.4%가 공제됩니다. 여기에 근로소득세와 지방소득세가 추가됩니다. 비과세 급여(식대 20만원, 자가운전보조금 20만원)를 활용하면 실수령액을 높일 수 있습니다.</p><h2>이런 분들에게 추천</h2><p>연봉 협상 중인 직장인, 첫 취업을 앞둔 구직자, 급여 명세서를 이해하고 싶은 분에게 유용합니다. 연말정산 환급을 극대화하려면 체크카드 사용 비율을 높이고, IRP/연금저축에 최대 납입하세요.</p>', relatedCalcs: ['net-salary', 'retirement-pension', 'irp-deduction'],
  ...
  },
  {
    ...
    faqs: [
      { q: '시급 환산기에서 4대보험은 어떻게 적용되나요?', a: '국민연금 4.5%, 건강보험 3.545%, 장기요양 0.45%, 고용보험 0.9% — 합계 약 9.4%가 공제됩니다.' },
      { q: '비과세 급여란?', a: '식대(월 20만원), 자가운전보조금(월 20만원), 출산보육수당(월 20만원) 등 소득세 면제 항목입니다.' },
      { q: '시급 환산기 결과가 실제와 다를 수 있나요?', a: '부양가족 수, 비과세 항목, 보험 상한 등에 따라 차이가 발생합니다. 최저임금법를 기준으로 계산합니다.' },
      { q: '시급 환산기는 모바일에서도 되나요?', a: '네, 모든 기기에서 최적화되어 있습니다.' },
      { q: '관련 계산기가 더 있나요?', a: '카더라는 급여/노동 포함 142종의 무료 계산기를 제공합니다.' },
    ], seoContent: '<h2>시급 ↔ 연봉 환산기 완벽 가이드</h2><p>시급을 연봉으로, 연봉을 시급으로 환산. 주휴수당 포함/미포함 선택. 카더라 시급 환산기는 2026년 4대보험 요율과 근로소득 간이세액표를 반영합니다.</p><p>본 계산기는 <strong>최저임금법</strong>를 기준으로 계산합니다. 규정은 매년 개정될 수 있으므로 전문가 확인을 권장합니다.</p><h2>급여 핵심 정보</h2><p>직장인 세전 급여에서 국민연금(4.5%), 건강보험(3.545%), 장기요양(0.45%), 고용보험(0.9%) 합계 약 9.4%가 공제됩니다. 여기에 근로소득세와 지방소득세가 추가됩니다. 비과세 급여(식대 20만원, 자가운전보조금 20만원)를 활용하면 실수령액을 높일 수 있습니다.</p><h2>이런 분들에게 추천</h2><p>연봉 협상 중인 직장인, 첫 취업을 앞둔 구직자, 급여 명세서를 이해하고 싶은 분에게 유용합니다. 연말정산 환급을 극대화하려면 체크카드 사용 비율을 높이고, IRP/연금저축에 최대 납입하세요.</p>', relatedCalcs: ['net-salary', '4-insurance'],
  },
  {
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: '변동금리와 고정금리 차이는?', a: '변동금리는 기준금리 따라 변하고, 고정금리는 계약 시 확정됩니다. 금리 상승기에는 고정이 유리합니다.' },
      { q: '예적금 이자 계산기는 실제 대출과 차이가 있나요?', a: '참고용이며, 은행별 우대금리·수수료 등에 따라 차이가 있습니다.' },
      { q: '예적금 이자 계산기는 모바일에서도 되나요?', a: '네, 모든 기기에서 최적화되어 있습니다.' },
      { q: '관련 계산기가 더 있나요?', a: '카더라는 대출/예적금 포함 142종의 무료 계산기를 제공합니다.' },
    ], seoContent: '<h2>예적금 이자 계산기 완벽 가이드</h2><p>예금·적금 만기 시 세전/세후 이자와 수령액을 계산. 단리/복리, 일반/비과세. 카더라 예적금 이자 계산기는 원리금균등, 원금균등, 만기일시 상환 방식을 비교합니다.</p><h2>대출 핵심 정보</h2><p>금리 1%p 차이로 30년간 수천만원의 이자 차이가 발생합니다. 원금균등은 총 이자가 적지만 초기 부담이 크고, 원리금균등은 매월 동일 금액으로 예산 관리가 쉽습니다. DSR 40% 규제를 확인하고, 중도상환수수료 면제 시점(보통 3년)을 파악하세요.</p><h2>이런 분들에게 추천</h2><p>주택담보대출, 전세대출, 자동차 대출을 비교하는 분, 대환을 고려하는 분에게 유용합니다. 여유자금으로 원금을 줄이면 총 이자를 크게 절약할 수 있습니다.</p>', relatedCalcs: ['compound-interest', 'loan-repayment'],
  ...
  },
  {
    ...
    faqs: [
      { q: 'FIRE 계산기 결과는 정확한가요?', a: '2026년 최신 기준 반영이지만, 개인 상황에 따라 차이가 있습니다. 전문가 상담을 권장합니다.' },
    ...
    seoContent: '<h2>FIRE 은퇴자금 계산기 완벽 가이드</h2><p>경제적 자유를 위한 목표 자산, 현재 저축률 기반 FIRE 달성 시기를 계산. 카더라 FIRE 계산기는 2026년 최신 기준을 반영하여 정확한 결과를 제공합니다.</p><h2>연금/은퇴 핵심 정보</h2><p>국민연금 수령액은 가입기간과 소득에 따라 달라집니다. 퇴직연금(DB/DC), 개인연금(IRP, 연금저축)을 합산하면 안정적인 노후 소득을 설계할 수 있습니다. FIRE 운동의 핵심은 저축률(50%+)과 투자 수익률입니다.</p><h2>이런 분들에게 추천</h2><p>정확한 연금/은퇴 계산이 필요한 분에게 유용합니다. 카더라는 연금/은퇴 포함 142종의 무료 계산기를 제공하며, 계산 결과를 카카오톡으로 공유할 수 있습니다. 본 계산기는 참고용이며 전문가 상담을 권장합니다.</p>', relatedCalcs: ['compound-interest', 'national-pension', 'dca-simulator'],
  },
  {
  ...
  // ════════════════════════════════════════
  {
    ...
    faqs: [
      ...
      { q: '칼로리 계산기는 남녀 기준이 다른가요?', a: '대부분의 건강 지표는 성별에 따라 다른 기준을 적용합니다. 성별 선택 시 자동 반영됩니다.' },
      { q: '칼로리 계산기는 무료인가요?', a: '네, 카더라 칼로리 계산기는 완전 무료이며 회원가입 없이 이용 가능합니다.' },
      { q: '칼로리 계산기는 모바일에서도 되나요?', a: '네, 모든 기기에서 최적화되어 있으며 앱 설치 없이 사용 가능합니다.' },
      { q: '관련 계산기가 더 있나요?', a: '카더라는 생활/건강 포함 142종의 무료 계산기를 제공합니다.' },
    ], seoContent: '<h2>칼로리 계산기 완벽 가이드</h2><p>키·몸무게·활동량으로 일일 권장 칼로리(TDEE)를 계산. 카더라 칼로리 계산기는 과학적 공식과 최신 기준을 반영합니다.</p><p>본 계산기는 <strong>Mifflin-St Jeor 공식</strong>를 기준으로 계산합니다. 규정은 매년 개정될 수 있으므로 전문가 확인을 권장합니다.</p><h2>건강·생활 핵심 정보</h2><p>BMI(18.5~22.9 정상), 체지방률, 기초대사량 등 건강 지표는 종합적으로 판단해야 합니다. 대한비만학회 기준은 WHO보다 엄격하여 BMI 23부터 과체중으로 분류합니다. 정확한 건강 평가는 의료 전문가와 상담하시기 바랍니다.</p><h2>이런 분들에게 추천</h2><p>체중 관리, 건강 관리를 계획 중인 분, 출산·육아를 준비하는 분, 일상의 궁금한 계산이 필요한 분에게 유용합니다. 정기적으로 계산하여 변화 추이를 기록하면 효과적입니다.</p>', relatedCalcs: ['bmi', 'body-fat', 'bmr'],
  },
  {
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: '기초대사량 계산기는 남녀 기준이 다른가요?', a: '대부분의 건강 지표는 성별에 따라 다른 기준을 적용합니다. 성별 선택 시 자동 반영됩니다.' },
      ...
      { q: '관련 계산기가 더 있나요?', a: '카더라는 생활/건강 포함 142종의 무료 계산기를 제공합니다.' },
    ], seoContent: '<h2>기초대사량 계산기 완벽 가이드</h2><p>성별·나이·키·몸무게로 기초대사량(BMR)을 계산. 카더라 기초대사량 계산기는 과학적 공식과 최신 기준을 반영합니다.</p><p>본 계산기는 <strong>Mifflin-St Jeor 공식</strong>를 기준으로 계산합니다. 규정은 매년 개정될 수 있으므로 전문가 확인을 권장합니다.</p><h2>건강·생활 핵심 정보</h2><p>BMI(18.5~22.9 정상), 체지방률, 기초대사량 등 건강 지표는 종합적으로 판단해야 합니다. 대한비만학회 기준은 WHO보다 엄격하여 BMI 23부터 과체중으로 분류합니다. 정확한 건강 평가는 의료 전문가와 상담하시기 바랍니다.</p><h2>이런 분들에게 추천</h2><p>체중 관리, 건강 관리를 계획 중인 분, 출산·육아를 준비하는 분, 일상의 궁금한 계산이 필요한 분에게 유용합니다. 정기적으로 계산하여 변화 추이를 기록하면 효과적입니다.</p>', relatedCalcs: ['calorie', 'bmi', 'body-fat'],
  },
  {
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: '배란일 계산기는 남녀 기준이 다른가요?', a: '대부분의 건강 지표는 성별에 따라 다른 기준을 적용합니다. 성별 선택 시 자동 반영됩니다.' },
      { q: '배란일 계산기는 무료인가요?', a: '네, 카더라 배란일 계산기는 완전 무료이며 회원가입 없이 이용 가능합니다.' },
      { q: '배란일 계산기는 모바일에서도 되나요?', a: '네, 모든 기기에서 최적화되어 있으며 앱 설치 없이 사용 가능합니다.' },
      { q: '관련 계산기가 더 있나요?', a: '카더라는 생활/건강 포함 142종의 무료 계산기를 제공합니다.' },
    ], seoContent: '<h2>배란일 계산기 완벽 가이드</h2><p>마지막 생리일과 생리주기로 배란일·가임기를 계산. 카더라 배란일 계산기는 과학적 공식과 최신 기준을 반영합니다.</p><h2>건강·생활 핵심 정보</h2><p>BMI(18.5~22.9 정상), 체지방률, 기초대사량 등 건강 지표는 종합적으로 판단해야 합니다. 대한비만학회 기준은 WHO보다 엄격하여 BMI 23부터 과체중으로 분류합니다. 정확한 건강 평가는 의료 전문가와 상담하시기 바랍니다.</p><h2>이런 분들에게 추천</h2><p>체중 관리, 건강 관리를 계획 중인 분, 출산·육아를 준비하는 분, 일상의 궁금한 계산이 필요한 분에게 유용합니다. 정기적으로 계산하여 변화 추이를 기록하면 효과적입니다.</p>', relatedCalcs: ['due-date'],
  ...
  // ════════════════════════════════════════
  {
    ...
    faqs: [
      { q: '자동차세 계산기 결과는 정확한가요?', a: '2026년 최신 기준 반영이지만, 개인 상황에 따라 차이가 있습니다. 지방세법 제127조를 기준으로 계산합니다. 전문가 상담을 권장합니다.' },
      { q: '자동차세 계산기에서 가장 중요한 입력값은?', a: '배기량·차량연식으로 자동차세를 자동 계산. 전기차·하이브리드 별도. 정확한 수치를 입력할수록 결과 신뢰도가 높아집니다.' },
      { q: '자동차세 계산기는 무료인가요?', a: '네, 카더라 자동차세 계산기는 완전 무료이며 회원가입 없이 무제한 이용 가능합니다.' },
      { q: '자동차세 계산기는 모바일에서도 되나요?', a: '네, 모든 기기에서 최적화되어 있으며 앱 설치 없이 사용 가능합니다.' },
      { q: '관련 계산기가 더 있나요?', a: '카더라는 자동차 포함 142종의 무료 계산기를 제공합니다.' },
    ],
    seoContent: '<h2>자동차세 계산기 완벽 가이드</h2><p>배기량·차량연식으로 자동차세를 자동 계산. 전기차·하이브리드 별도. 카더라 자동차세 계산기는 2026년 최신 기준을 반영하여 정확한 결과를 제공합니다.</p><p>본 계산기는 <strong>지방세법 제127조</strong>를 기준으로 계산합니다. 규정은 매년 개정될 수 있으므로 전문가 확인을 권장합니다.</p><h2>자동차 핵심 정보</h2><p>자동차 취득 시 취등록세, 보유 시 자동차세, 운행 시 유류비·보험료가 발생합니다. 전기차는 유류비가 1/3 수준이지만 충전 인프라와 배터리 교체 비용을 고려하세요.</p><h2>이런 분들에게 추천</h2><p>정확한 자동차 계산이 필요한 분에게 유용합니다. 카더라는 자동차 포함 142종의 무료 계산기를 제공하며, 계산 결과를 카카오톡으로 공유할 수 있습니다. 본 계산기는 참고용이며 전문가 상담을 권장합니다.</p>', relatedCalcs: ['fuel-cost', 'car-installment'],
  },
  {
    ...
    faqs: [
      { q: '연비 계산기 결과는 정확한가요?', a: '2026년 최신 기준 반영이지만, 개인 상황에 따라 차이가 있습니다. 전문가 상담을 권장합니다.' },
      ...
      { q: '관련 계산기가 더 있나요?', a: '카더라는 자동차 포함 142종의 무료 계산기를 제공합니다.' },
    ], seoContent: '<h2>연비/유류비 계산기 완벽 가이드</h2><p>주행거리·연비·유가로 월간/연간 유류비를 계산. 카더라 연비 계산기는 2026년 최신 기준을 반영하여 정확한 결과를 제공합니다.</p><h2>자동차 핵심 정보</h2><p>자동차 취득 시 취등록세, 보유 시 자동차세, 운행 시 유류비·보험료가 발생합니다. 전기차는 유류비가 1/3 수준이지만 충전 인프라와 배터리 교체 비용을 고려하세요.</p><h2>이런 분들에게 추천</h2><p>정확한 자동차 계산이 필요한 분에게 유용합니다. 카더라는 자동차 포함 142종의 무료 계산기를 제공하며, 계산 결과를 카카오톡으로 공유할 수 있습니다. 본 계산기는 참고용이며 전문가 상담을 권장합니다.</p>', relatedCalcs: ['vehicle-tax', 'ev-charge-cost'],
  ...
  },
  {
    ...
    faqs: [
      { q: '자동차 할부 계산기 결과는 정확한가요?', a: '2026년 최신 기준 반영이지만, 개인 상황에 따라 차이가 있습니다. 전문가 상담을 권장합니다.' },
      ...
      { q: '관련 계산기가 더 있나요?', a: '카더라는 자동차 포함 142종의 무료 계산기를 제공합니다.' },
    ], seoContent: '<h2>자동차 할부 계산기 완벽 가이드</h2><p>자동차 할부 구매 시 월 납입금과 총 이자를 계산. 카더라 자동차 할부 계산기는 2026년 최신 기준을 반영하여 정확한 결과를 제공합니다.</p><h2>자동차 핵심 정보</h2><p>자동차 취득 시 취등록세, 보유 시 자동차세, 운행 시 유류비·보험료가 발생합니다. 전기차는 유류비가 1/3 수준이지만 충전 인프라와 배터리 교체 비용을 고려하세요.</p><h2>이런 분들에게 추천</h2><p>정확한 자동차 계산이 필요한 분에게 유용합니다. 카더라는 자동차 포함 142종의 무료 계산기를 제공하며, 계산 결과를 카카오톡으로 공유할 수 있습니다. 본 계산기는 참고용이며 전문가 상담을 권장합니다.</p>', relatedCalcs: ['loan-repayment', 'vehicle-tax'],
  },
  {
    ...
    faqs: [
      { q: '전기차 충전비 계산기 결과는 정확한가요?', a: '2026년 최신 기준 반영이지만, 개인 상황에 따라 차이가 있습니다. 전문가 상담을 권장합니다.' },
      { q: '전기차 충전비 계산기에서 가장 중요한 입력값은?', a: '전기차 배터리 용량·전비로 충전비를 계산. 가정용/공용 비교. 정확한 수치를 입력할수록 결과 신뢰도가 높아집니다.' },
      ...
      { q: '관련 계산기가 더 있나요?', a: '카더라는 자동차 포함 142종의 무료 계산기를 제공합니다.' },
    ], seoContent: '<h2>전기차 충전비 계산기 완벽 가이드</h2><p>전기차 배터리 용량·전비로 충전비를 계산. 가정용/공용 비교. 카더라 전기차 충전비 계산기는 2026년 최신 기준을 반영하여 정확한 결과를 제공합니다.</p><h2>자동차 핵심 정보</h2><p>자동차 취득 시 취등록세, 보유 시 자동차세, 운행 시 유류비·보험료가 발생합니다. 전기차는 유류비가 1/3 수준이지만 충전 인프라와 배터리 교체 비용을 고려하세요.</p><h2>이런 분들에게 추천</h2><p>정확한 자동차 계산이 필요한 분에게 유용합니다. 카더라는 자동차 포함 142종의 무료 계산기를 제공하며, 계산 결과를 카카오톡으로 공유할 수 있습니다. 본 계산기는 참고용이며 전문가 상담을 권장합니다.</p>', relatedCalcs: ['fuel-cost', 'vehicle-tax'],
  ...
  // ════════════════════════════════════════
  {
    ...
    faqs: [
      { q: '할인율 계산기 결과는 정확한가요?', a: '2026년 최신 기준 반영이지만, 개인 상황에 따라 차이가 있습니다. 전문가 상담을 권장합니다.' },
      { q: '할인율 계산기에서 가장 중요한 입력값은?', a: '정가·할인가로 할인율을 계산. 역산도 가능. 정확한 수치를 입력할수록 결과 신뢰도가 높아집니다.' },
    ...
    ], seoContent: '<h2>할인율 계산기 완벽 가이드</h2><p>정가·할인가로 할인율을 계산. 역산도 가능. 카더라 할인율 계산기는 2026년 최신 기준을 반영하여 정확한 결과를 제공합니다.</p><h2>쇼핑/소비 핵심 정보</h2><p>해외직구 면세한도: 미국 $200, 일반 $150. 초과분에 관세+부가세 부과. 카드 할부 이자는 무이자 외에 수수료가 포함되며, 일시불 대비 총 비용을 비교하세요.</p><h2>이런 분들에게 추천</h2><p>정확한 쇼핑/소비 계산이 필요한 분에게 유용합니다. 카더라는 쇼핑/소비 포함 142종의 무료 계산기를 제공하며, 계산 결과를 카카오톡으로 공유할 수 있습니다. 본 계산기는 참고용이며 전문가 상담을 권장합니다.</p>', relatedCalcs: ['installment-interest'],
  },
  {
    ...
    faqs: [
      { q: '할부 이자 계산기 결과는 정확한가요?', a: '2026년 최신 기준 반영이지만, 개인 상황에 따라 차이가 있습니다. 전문가 상담을 권장합니다.' },
      ...
      { q: '관련 계산기가 더 있나요?', a: '카더라는 쇼핑/소비 포함 142종의 무료 계산기를 제공합니다.' },
    ], seoContent: '<h2>할부 이자 계산기 완벽 가이드</h2><p>카드 할부 결제 시 실제 부담 이자를 계산. 카더라 할부 이자 계산기는 2026년 최신 기준을 반영하여 정확한 결과를 제공합니다.</p><h2>쇼핑/소비 핵심 정보</h2><p>해외직구 면세한도: 미국 $200, 일반 $150. 초과분에 관세+부가세 부과. 카드 할부 이자는 무이자 외에 수수료가 포함되며, 일시불 대비 총 비용을 비교하세요.</p><h2>이런 분들에게 추천</h2><p>정확한 쇼핑/소비 계산이 필요한 분에게 유용합니다. 카더라는 쇼핑/소비 포함 142종의 무료 계산기를 제공하며, 계산 결과를 카카오톡으로 공유할 수 있습니다. 본 계산기는 참고용이며 전문가 상담을 권장합니다.</p>', relatedCalcs: ['discount-calc', 'loan-repayment'],
  ...
  },
  {
    ...
    faqs: [
      { q: '구독료 합산 계산기 결과는 정확한가요?', a: '2026년 최신 기준 반영이지만, 개인 상황에 따라 차이가 있습니다. 전문가 상담을 권장합니다.' },
      ...
      { q: '관련 계산기가 더 있나요?', a: '카더라는 쇼핑/소비 포함 142종의 무료 계산기를 제공합니다.' },
    ], seoContent: '<h2>구독료 합산 계산기 완벽 가이드</h2><p>넷플릭스·유튜브·스포티파이 등 월 구독 서비스 총 비용을 계산. 카더라 구독료 합산 계산기는 2026년 최신 기준을 반영하여 정확한 결과를 제공합니다.</p><h2>쇼핑/소비 핵심 정보</h2><p>해외직구 면세한도: 미국 $200, 일반 $150. 초과분에 관세+부가세 부과. 카드 할부 이자는 무이자 외에 수수료가 포함되며, 일시불 대비 총 비용을 비교하세요.</p><h2>이런 분들에게 추천</h2><p>정확한 쇼핑/소비 계산이 필요한 분에게 유용합니다. 카더라는 쇼핑/소비 포함 142종의 무료 계산기를 제공하며, 계산 결과를 카카오톡으로 공유할 수 있습니다. 본 계산기는 참고용이며 전문가 상담을 권장합니다.</p>', relatedCalcs: ['net-salary'],
  ...
  // ════════════════════════════════════════
  {
    ...
    faqs: [
      { q: '군인 월급 계산기 결과는 정확한가요?', a: '2026년 최신 기준 반영이지만, 개인 상황에 따라 차이가 있습니다. 국방부 병 봉급표를 기준으로 계산합니다. 전문가 상담을 권장합니다.' },
    ...
    seoContent: '<h2>군인 월급 계산기 완벽 가이드</h2><p>2026년 병사 계급별 월급을 확인. 이병~병장. 카더라 군인 월급 계산기는 2026년 최신 기준을 반영하여 정확한 결과를 제공합니다.</p><p>본 계산기는 <strong>국방부 병 봉급표</strong>를 기준으로 계산합니다. 규정은 매년 개정될 수 있으므로 전문가 확인을 권장합니다.</p><h2>군대/교육 핵심 정보</h2><p>2026년 병사 월급: 이병 67만원, 일병 78만원, 상병 97만원, 병장 125만원. 군 복무 중 학자금 대출 이자 지원, 전역 후 복학 시 등록금 감면 등 혜택을 확인하세요.</p><h2>이런 분들에게 추천</h2><p>정확한 군대/교육 계산이 필요한 분에게 유용합니다. 카더라는 군대/교육 포함 142종의 무료 계산기를 제공하며, 계산 결과를 카카오톡으로 공유할 수 있습니다. 본 계산기는 참고용이며 전문가 상담을 권장합니다.</p>', relatedCalcs: ['discharge-date', 'net-salary'],
  },
  {
    ...
    faqs: [
      { q: '학점 환산기 결과는 정확한가요?', a: '2026년 최신 기준 반영이지만, 개인 상황에 따라 차이가 있습니다. 전문가 상담을 권장합니다.' },
      ...
      { q: '관련 계산기가 더 있나요?', a: '카더라는 군대/교육 포함 142종의 무료 계산기를 제공합니다.' },
    ], seoContent: '<h2>학점 백분율 환산기 완벽 가이드</h2><p>4.5/4.3/4.0 만점 학점을 백분율 또는 100점 만점으로 환산. 카더라 학점 환산기는 2026년 최신 기준을 반영하여 정확한 결과를 제공합니다.</p><h2>군대/교육 핵심 정보</h2><p>2026년 병사 월급: 이병 67만원, 일병 78만원, 상병 97만원, 병장 125만원. 군 복무 중 학자금 대출 이자 지원, 전역 후 복학 시 등록금 감면 등 혜택을 확인하세요.</p><h2>이런 분들에게 추천</h2><p>정확한 군대/교육 계산이 필요한 분에게 유용합니다. 카더라는 군대/교육 포함 142종의 무료 계산기를 제공하며, 계산 결과를 카카오톡으로 공유할 수 있습니다. 본 계산기는 참고용이며 전문가 상담을 권장합니다.</p>', relatedCalcs: [],
  ...
  },
  {
    ...
    faqs: [
      { q: '재산세 계산기 결과는 실제 세금과 같나요?', a: '참고용이며, 감면·중과·특례 등에 따라 차이가 있습니다. 지방세법 제111조를 기준으로 계산합니다. 정확한 세액은 세무사 상담을 권장합니다.' },
      { q: '재산세 계산기에서 조정대상지역은 반영되나요?', a: '네, 조정대상지역 여부에 따른 세율 차이를 반영합니다. 최신 규제지역은 국토교통부에서 확인하세요.' },
      { q: '부동산 세금 절세 방법은?', a: '1세대1주택 비과세, 장기보유특별공제, 생애최초 감면 등을 활용하세요.' },
      { q: '재산세 계산기는 모바일에서도 되나요?', a: '네, 모바일·태블릿·PC 모든 기기에서 최적화되어 있으며 앱 설치 없이 사용 가능합니다.' },
      { q: '결과를 공유할 수 있나요?', a: '계산 완료 후 공유 버튼으로 카카오톡, URL 복사 등으로 공유 가능합니다.' },
    ], seoContent: '<h2>재산세 계산기 완벽 가이드</h2><p>주택 공시가격으로 재산세+지방교육세+도시지역분을 계산. 카더라 재산세 계산기는 2026년 최신 세법을 반영하여 조정대상지역, 주택 수, 면적, 취득 원인에 따른 세율을 자동 적용합니다.</p><p>본 계산기는 <strong>지방세법 제111조</strong>를 기준으로 계산합니다. 규정은 매년 개정될 수 있으므로 전문가 확인을 권장합니다.</p><h2>부동산 세금 핵심 포인트</h2><p>부동산 거래 시 취득세(1~12%), 양도소득세(6~45%+중과), 재산세, 종합부동산세 등 다양한 세금이 부과됩니다. 1세대1주택 비과세(12억까지), 장기보유특별공제(최대 80%), 생애최초 감면(200만원 한도) 등 절세 제도를 적극 활용하세요.</p><h2>이런 분들에게 추천</h2><p>주택 매매·매도를 계획 중인 분, 다주택 중과세 영향을 파악하고 싶은 분, 부동산 투자 수익률을 계산하고 싶은 분에게 유용합니다. 카더라는 부동산 세금 포함 142종의 무료 계산기를 제공합니다.</p>', relatedCalcs: ['comprehensive-property-tax', 'acquisition-tax'],
  ...
  },
  {
    ...
    faqs: [
      { q: '등기비용 계산기 결과는 실제와 같나요?', a: '참고용이며, 지역·물건 특성에 따라 차이가 있을 수 있습니다. 지방세법 제28조를 기준으로 계산합니다.' },
      { q: '부동산 거래 시 꼭 확인할 것은?', a: '등기부등본, 건축물대장, 토지이용계획확인서를 반드시 확인하세요.' },
      { q: '등기비용 계산기는 무료인가요?', a: '네, 카더라 등기비용 계산기는 완전 무료이며 회원가입 없이 무제한 이용 가능합니다.' },
      { q: '등기비용 계산기는 모바일에서도 되나요?', a: '네, 모든 기기에서 최적화되어 있습니다.' },
      { q: '관련 계산기가 더 있나요?', a: '카더라는 부동산 포함 142종의 무료 계산기를 제공합니다.' },
    ], seoContent: '<h2>등기비용 계산기 완벽 가이드</h2><p>부동산 매매 시 소유권이전등기 비용(등록면허세+취득세+법무사비)을 계산. 카더라 등기비용 계산기는 2026년 최신 기준을 반영합니다.</p><p>본 계산기는 <strong>지방세법 제28조</strong>를 기준으로 계산합니다. 규정은 매년 개정될 수 있으므로 전문가 확인을 권장합니다.</p><h2>부동산 거래 핵심 정보</h2><p>부동산 거래 시 중개수수료(0.4~0.9%), 등기비용, 취득세, 대출이자 등 다양한 비용이 발생합니다. 사전에 총 비용을 정확히 계산하면 예상치 못한 지출을 방지할 수 있습니다. 등기부등본·건축물대장·토지이용계획확인서는 반드시 확인하세요.</p><h2>이런 분들에게 추천</h2><p>주택 매매·전세·월세를 계획 중인 분, 부동산 투자 수익률을 분석하고 싶은 분, 대출 가능 금액을 확인하고 싶은 분에게 유용합니다.</p>', relatedCalcs: ['acquisition-tax', 'brokerage-fee'],
  },
  {
    ...
    seoContent: '<h2>DSR 계산기 완벽 가이드</h2><p>총부채원리금상환비율(DSR)을 계산. 대출 가능 금액 추정. 카더라 DSR 계산기는 2026년 최신 기준을 반영합니다.</p><p>본 계산기는 <strong>은행업감독규정</strong>를 기준으로 계산합니다. 규정은 매년 개정될 수 있으므로 전문가 확인을 권장합니다.</p><h2>부동산 거래 핵심 정보</h2><p>부동산 거래 시 중개수수료(0.4~0.9%), 등기비용, 취득세, 대출이자 등 다양한 비용이 발생합니다. 사전에 총 비용을 정확히 계산하면 예상치 못한 지출을 방지할 수 있습니다. 등기부등본·건축물대장·토지이용계획확인서는 반드시 확인하세요.</p><h2>이런 분들에게 추천</h2><p>주택 매매·전세·월세를 계획 중인 분, 부동산 투자 수익률을 분석하고 싶은 분, 대출 가능 금액을 확인하고 싶은 분에게 유용합니다.</p>', relatedCalcs: ['loan-repayment', 'net-salary'],
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: '관련 계산기가 더 있나요?', a: '카더라는 부동산 포함 142종의 무료 계산기를 제공합니다.' },
    ], seoContent: '<h2>전세 vs 월세 비교기 완벽 가이드</h2><p>전세와 월세 중 어느 것이 유리한지 대출이자·기회비용 포함 비교. 카더라 전세vs월세 비교기는 2026년 최신 기준을 반영합니다.</p><h2>부동산 거래 핵심 정보</h2><p>부동산 거래 시 중개수수료(0.4~0.9%), 등기비용, 취득세, 대출이자 등 다양한 비용이 발생합니다. 사전에 총 비용을 정확히 계산하면 예상치 못한 지출을 방지할 수 있습니다. 등기부등본·건축물대장·토지이용계획확인서는 반드시 확인하세요.</p><h2>이런 분들에게 추천</h2><p>주택 매매·전세·월세를 계획 중인 분, 부동산 투자 수익률을 분석하고 싶은 분, 대출 가능 금액을 확인하고 싶은 분에게 유용합니다.</p>', relatedCalcs: ['jeonse-wolse', 'loan-repayment'],
  },
  {
  ...
  },
  {
    ...
    faqs: [
      { q: '상속세 계산기에서 면제한도는?', a: '배우자 6억, 성년 자녀 5천만원, 미성년 2천만원 (10년간 합산).' },
      { q: '증여와 상속 어떤 것이 유리?', a: '10년 분할 증여로 면제한도를 활용하면 상속보다 절세 효과가 큽니다.' },
      { q: '상속세 계산기 결과는 정확한가요?', a: '참고용이며, 부동산 평가·감면·공제 등에 따라 차이가 있습니다. 상속세및증여세법 제18조~제24조를 기준으로 계산합니다.' },
      { q: '상속세 계산기는 모바일에서도 되나요?', a: '네, 모든 기기에서 최적화되어 있습니다.' },
      { q: '관련 계산기가 더 있나요?', a: '카더라는 상속/증여 포함 142종의 무료 계산기를 제공합니다.' },
    ],
    seoContent: '<h2>상속세 계산기 완벽 가이드</h2><p>상속재산에서 기초공제·배우자공제를 차감한 과세표준에 10~50% 누진세율 적용. 카더라 상속세 계산기는 2026년 상속세 및 증여세법 기준으로 계산합니다.</p><p>본 계산기는 <strong>상속세및증여세법 제18조~제24조</strong>를 기준으로 계산합니다. 규정은 매년 개정될 수 있으므로 전문가 확인을 권장합니다.</p><h2>상속·증여 핵심 정보</h2><p>10~50% 누진세율 적용. 증여재산공제: 배우자 6억, 성년자녀 5천만원, 미성년 2천만원 (10년간 합산). 부동산 증여 시 기준시가 평가로 절세 효과가 있지만, 5년 내 매도 시 이월과세에 주의하세요.</p><h2>이런 분들에게 추천</h2><p>자녀에게 재산을 이전하려는 부모, 상속 계획을 세우는 분, 부담부증여를 검토하는 분에게 유용합니다. 미성년 시기부터 2천만원씩 시작하면 수십 년간 수억원을 비과세로 이전 가능합니다.</p>', relatedCalcs: ['gift-tax', 'capital-gains-housing'],
  },
  {
    ...
    faqs: [
      { q: '부가세 계산기 결과는 정확한가요?', a: '2026년 최신 기준 반영이지만, 개인 상황에 따라 차이가 있습니다. 부가가치세법 제29조를 기준으로 계산합니다. 전문가 상담을 권장합니다.' },
    ...
    ], seoContent: '<h2>부가가치세 계산기 완벽 가이드</h2><p>공급가액↔VAT 역산. 부가세 포함/미포함 금액 변환. 카더라 부가세 계산기는 2026년 최신 기준을 반영하여 정확한 결과를 제공합니다.</p><p>본 계산기는 <strong>부가가치세법 제29조</strong>를 기준으로 계산합니다. 규정은 매년 개정될 수 있으므로 전문가 확인을 권장합니다.</p><h2>사업자 세금 핵심 정보</h2><p>일반과세자는 매출의 10% 부가세를 징수·납부하고, 간이과세자는 업종별 부가가치율(1.5~4%) 적용. 법인세는 2억 이하 9%, 200억 이하 19%, 3000억 이하 21%, 초과 24%입니다.</p><h2>이런 분들에게 추천</h2><p>정확한 사업자 세금 계산이 필요한 분에게 유용합니다. 카더라는 사업자 세금 포함 142종의 무료 계산기를 제공하며, 계산 결과를 카카오톡으로 공유할 수 있습니다. 본 계산기는 참고용이며 전문가 상담을 권장합니다.</p>', relatedCalcs: ['comprehensive-income-tax'],
  ...
  { slug: 'earned-income-tax', emoji: '💼', category: 'income-tax', categoryLabel: '소득세', title: '근로소득세 간이세액 계산기', titleShort: '근로소득세 계산기', description: '월급에서 원천징수되는 근로소득세를 간이세액표로 계산.', keywords: ['근로소득세','간이세액표','원천징수','월급 세금'], legalBasis: '소득세법 시행령 별표2', version: '2026.04', lastUpdated: '2026-04-05', pattern: 'tax-bracket', formula: 'earnedIncomeTax', resultLabel: '월 원천징수세액', resultUnit: '원', inputs: [{ id: 'monthlySalary', label: '월 급여 (비과세 제외)', type: 'currency', default: 3500000 }, { id: 'family', label: '공제대상 가족수', type: 'stepper', default: 1, min: 1, max: 11 }, { id: 'children', label: '20세 이하 자녀수', type: 'stepper', default: 0, min: 0, max: 7 }], faqs: [
      ...
      { q: '관련 계산기가 더 있나요?', a: '카더라는 소득세 포함 142종의 무료 계산기를 제공합니다.' },
    ], seoContent: '<h2>근로소득세 간이세액 계산기 완벽 가이드</h2><p>월급에서 원천징수되는 근로소득세를 간이세액표로 계산. 카더라 근로소득세 계산기는 2026년 소득세법 기준 8단계 누진세율(6~45%)을 반영합니다.</p><p>본 계산기는 <strong>소득세법 시행령 별표2</strong>를 기준으로 계산합니다. 규정은 매년 개정될 수 있으므로 전문가 확인을 권장합니다.</p><h2>소득세 핵심 정보</h2><p>과세표준에 따라 1,400만원 이하 6%, 5,000만원 이하 15%, 8,800만원 이하 24%, 1.5억 이하 35%, 3억 이하 38%, 5억 이하 40%, 10억 이하 42%, 10억 초과 45%가 적용됩니다. 소득공제로 과세표준을 줄이고, 세액공제로 산출세액을 직접 차감하여 절세하세요.</p><h2>이런 분들에게 추천</h2><p>근로소득자, 프리랜서, 사업자 등 소득세 신고를 준비하는 모든 분에게 유용합니다. 연금저축/IRP 세액공제(최대 900만원 납입)를 활용하면 효과적으로 절세할 수 있습니다.</p>', relatedCalcs: ['net-salary', 'year-end-refund'] },
  ...
  { slug: 'other-income-tax', emoji: '📝', category: 'income-tax', categoryLabel: '소득세', title: '기타소득세 계산기', titleShort: '기타소득세 계산기', description: '강연료·원고료·사례금 등 기타소득에 대한 세금을 계산.', keywords: ['기타소득세','강연료 세금','원고료 세금','사례금'], legalBasis: '소득세법 제21조', version: '2026.04', lastUpdated: '2026-04-05', pattern: 'simple', formula: 'otherIncomeTax', resultLabel: '기타소득세', resultUnit: '원', inputs: [{ id: 'grossIncome', label: '기타소득 총수입', type: 'currency', default: 5000000 }, { id: 'expenseRate', label: '필요경비율', type: 'radio', default: '60', options: [{ value: '60', label: '60% (일반)' }, { value: '80', label: '80% (강연·자문)' }, { value: 'actual', label: '실제 경비' }] }, { id: 'actualExpense', label: '실제 경비', type: 'currency', default: 0, condition: 'expenseRate=actual' }], faqs: [
      { q: '기타소득세 계산기에 적용되는 세율은?', a: '과세표준에 따라 6~45% 8단계 누진세율이 적용됩니다. 소득세법 제21조를 기준으로 계산합니다.' },
      { q: '소득공제와 세액공제의 차이는?', a: '소득공제는 과세표준을 줄이고, 세액공제는 산출세액에서 직접 차감합니다.' },
  ...
  { slug: 'local-income-tax', emoji: '🏛️', category: 'income-tax', categoryLabel: '소득세', title: '지방소득세 계산기', titleShort: '지방소득세 계산기', description: '소득세의 10%를 자동 계산하는 지방소득세 계산기.', keywords: ['지방소득세','소득세 10%','지방세'], legalBasis: '지방세법 제86조', version: '2026.04', lastUpdated: '2026-04-05', pattern: 'simple', formula: 'localIncomeTax', resultLabel: '지방소득세', resultUnit: '원', inputs: [{ id: 'incomeTax', label: '소득세', type: 'currency', default: 5000000 }], faqs: [
      { q: '지방소득세 계산기에 적용되는 세율은?', a: '과세표준에 따라 6~45% 8단계 누진세율이 적용됩니다. 지방세법 제86조를 기준으로 계산합니다.' },
      { q: '소득공제와 세액공제의 차이는?', a: '소득공제는 과세표준을 줄이고, 세액공제는 산출세액에서 직접 차감합니다.' },
      ...
      { q: '관련 계산기가 더 있나요?', a: '카더라는 소득세 포함 142종의 무료 계산기를 제공합니다.' },
    ], seoContent: '<h2>지방소득세 계산기 완벽 가이드</h2><p>소득세의 10%를 자동 계산하는 지방소득세 계산기. 카더라 지방소득세 계산기는 2026년 소득세법 기준 8단계 누진세율(6~45%)을 반영합니다.</p><p>본 계산기는 <strong>지방세법 제86조</strong>를 기준으로 계산합니다. 규정은 매년 개정될 수 있으므로 전문가 확인을 권장합니다.</p><h2>소득세 핵심 정보</h2><p>과세표준에 따라 1,400만원 이하 6%, 5,000만원 이하 15%, 8,800만원 이하 24%, 1.5억 이하 35%, 3억 이하 38%, 5억 이하 40%, 10억 이하 42%, 10억 초과 45%가 적용됩니다. 소득공제로 과세표준을 줄이고, 세액공제로 산출세액을 직접 차감하여 절세하세요.</p><h2>이런 분들에게 추천</h2><p>근로소득자, 프리랜서, 사업자 등 소득세 신고를 준비하는 모든 분에게 유용합니다. 연금저축/IRP 세액공제(최대 900만원 납입)를 활용하면 효과적으로 절세할 수 있습니다.</p>', relatedCalcs: ['comprehensive-income-tax'] },
  ...
  { slug: 'corporate-tax', emoji: '🏢', category: 'biz-tax', categoryLabel: '사업자 세금', title: '법인세 계산기', titleShort: '법인세 계산기', description: '법인 과세표준별 법인세(9~24% 4단계)를 계산.', keywords: ['법인세 계산기','법인세율','과세표준','법인 세금'], legalBasis: '법인세법 제55조', version: '2026.04', lastUpdated: '2026-04-05', pattern: 'tax-bracket', formula: 'corporateTax', resultLabel: '법인세', resultUnit: '원', inputs: [{ id: 'taxBase', label: '과세표준', type: 'currency', default: 500000000 }], faqs: [
      { q: '법인세 계산기 결과는 정확한가요?', a: '2026년 최신 기준 반영이지만, 개인 상황에 따라 차이가 있습니다. 법인세법 제55조를 기준으로 계산합니다. 전문가 상담을 권장합니다.' },
      { q: '법인세 계산기에서 가장 중요한 입력값은?', a: '법인 과세표준별 법인세(9~24% 4단계)를 계산. 정확한 수치를 입력할수록 결과 신뢰도가 높아집니다.' },
      { q: '법인세 계산기는 무료인가요?', a: '네, 카더라 법인세 계산기는 완전 무료이며 회원가입 없이 무제한 이용 가능합니다.' },
      { q: '법인세 계산기는 모바일에서도 되나요?', a: '네, 모든 기기에서 최적화되어 있으며 앱 설치 없이 사용 가능합니다.' },
      { q: '관련 계산기가 더 있나요?', a: '카더라는 사업자 세금 포함 142종의 무료 계산기를 제공합니다.' },
    ], seoContent: '<h2>법인세 계산기 완벽 가이드</h2><p>법인 과세표준별 법인세(9~24% 4단계)를 계산. 카더라 법인세 계산기는 2026년 최신 기준을 반영하여 정확한 결과를 제공합니다.</p><p>본 계산기는 <strong>법인세법 제55조</strong>를 기준으로 계산합니다. 규정은 매년 개정될 수 있으므로 전문가 확인을 권장합니다.</p><h2>사업자 세금 핵심 정보</h2><p>일반과세자는 매출의 10% 부가세를 징수·납부하고, 간이과세자는 업종별 부가가치율(1.5~4%) 적용. 법인세는 2억 이하 9%, 200억 이하 19%, 3000억 이하 21%, 초과 24%입니다.</p><h2>이런 분들에게 추천</h2><p>정확한 사업자 세금 계산이 필요한 분에게 유용합니다. 카더라는 사업자 세금 포함 142종의 무료 계산기를 제공하며, 계산 결과를 카카오톡으로 공유할 수 있습니다. 본 계산기는 참고용이며 전문가 상담을 권장합니다.</p>', relatedCalcs: ['vat-calc'] },
  ...
  { slug: 'expense-rate-lookup', emoji: '🔍', category: 'biz-tax', categoryLabel: '사업자 세금', title: '업종별 경비율 조회기', titleShort: '경비율 조회기', description: '업종코드별 단순경비율·기준경비율을 조회.', keywords: ['단순경비율','기준경비율','업종별 경비율','추계신고'], legalBasis: '소득세법 시행령 제143조', version: '2026.04', lastUpdated: '2026-04-05', pattern: 'simple', formula: 'expenseRateLookup', resultLabel: '추정 소득금액', resultUnit: '원', inputs: [{ id: 'revenue', label: '총 수입금액', type: 'currency', default: 50000000 }, { id: 'rateType', label: '적용 경비율', type: 'radio', default: 'simple', options: [{ value: 'simple', label: '단순경비율 (90.1%)' }, { value: 'standard', label: '기준경비율 (20.8%)' }] }, { id: 'rate', label: '경비율 (%)', type: 'percent', default: 90.1, min: 0, max: 99 }], faqs: [
      { q: '경비율 조회기 결과는 정확한가요?', a: '2026년 최신 기준 반영이지만, 개인 상황에 따라 차이가 있습니다. 소득세법 시행령 제143조를 기준으로 계산합니다. 전문가 상담을 권장합니다.' },
      { q: '경비율 조회기에서 가장 중요한 입력값은?', a: '업종코드별 단순경비율·기준경비율을 조회. 정확한 수치를 입력할수록 결과 신뢰도가 높아집니다.' },
      ...
      { q: '관련 계산기가 더 있나요?', a: '카더라는 사업자 세금 포함 142종의 무료 계산기를 제공합니다.' },
    ], seoContent: '<h2>업종별 경비율 조회기 완벽 가이드</h2><p>업종코드별 단순경비율·기준경비율을 조회. 카더라 경비율 조회기는 2026년 최신 기준을 반영하여 정확한 결과를 제공합니다.</p><p>본 계산기는 <strong>소득세법 시행령 제143조</strong>를 기준으로 계산합니다. 규정은 매년 개정될 수 있으므로 전문가 확인을 권장합니다.</p><h2>사업자 세금 핵심 정보</h2><p>일반과세자는 매출의 10% 부가세를 징수·납부하고, 간이과세자는 업종별 부가가치율(1.5~4%) 적용. 법인세는 2억 이하 9%, 200억 이하 19%, 3000억 이하 21%, 초과 24%입니다.</p><h2>이런 분들에게 추천</h2><p>정확한 사업자 세금 계산이 필요한 분에게 유용합니다. 카더라는 사업자 세금 포함 142종의 무료 계산기를 제공하며, 계산 결과를 카카오톡으로 공유할 수 있습니다. 본 계산기는 참고용이며 전문가 상담을 권장합니다.</p>', relatedCalcs: ['comprehensive-income-tax', 'withholding-3-3'] },
  ...
  { slug: 'child-credit', emoji: '👶', category: 'year-end', categoryLabel: '연말정산', title: '자녀 세액공제 계산기', titleShort: '자녀 공제 계산기', description: '자녀수별 세액공제 + 출산/입양 추가공제를 계산.', keywords: ['자녀 세액공제','자녀 공제','출산 공제','연말정산 자녀'], legalBasis: '소득세법 제59조의2', version: '2026.04', lastUpdated: '2026-04-05', pattern: 'simple', formula: 'childCredit', resultLabel: '자녀 세액공제', resultUnit: '원', inputs: [{ id: 'childCount', label: '8세 이상 자녀수', type: 'stepper', default: 2, min: 0, max: 7 }, { id: 'newborn', label: '출산/입양 자녀수', type: 'stepper', default: 0, min: 0, max: 3 }], faqs: [
      ...
      { q: '관련 계산기가 더 있나요?', a: '카더라는 연말정산 포함 142종의 무료 계산기를 제공합니다.' },
    ], seoContent: '<h2>자녀 세액공제 계산기 완벽 가이드</h2><p>자녀수별 세액공제 + 출산/입양 추가공제를 계산. 카더라 자녀 공제 계산기는 2026년 세법 기준으로 정확한 공제액을 계산합니다.</p><p>본 계산기는 <strong>소득세법 제59조의2</strong>를 기준으로 계산합니다. 규정은 매년 개정될 수 있으므로 전문가 확인을 권장합니다.</p><h2>연말정산 핵심 정보</h2><p>소득공제(인적공제, 신용카드, 주택청약)와 세액공제(의료비, 교육비, 기부금, 보험료, 연금저축)를 최대한 활용하면 상당한 환급을 받을 수 있습니다. 국세청 간소화 서비스(1월 15일 오픈)를 활용하세요.</p><h2>이런 분들에게 추천</h2><p>근로소득자, 연말정산 환급을 극대화하고 싶은 직장인에게 필수입니다. 체크카드 사용 비율 높이기, 연금저축/IRP 최대 납입, 월세 세액공제 신청이 핵심 전략입니다.</p>', relatedCalcs: ['year-end-refund'] },
  { slug: 'housing-fund-deduction', emoji: '🏠', category: 'year-end', categoryLabel: '연말정산', title: '주택자금 소득공제 계산기', titleShort: '주택자금 공제 계산기', description: '주택청약·주택담보대출 이자에 대한 소득공제를 계산.', keywords: ['주택자금 소득공제','주택청약 공제','주담대 이자 공제'], legalBasis: '소득세법 제52조', version: '2026.04', lastUpdated: '2026-04-05', pattern: 'simple', formula: 'housingFundDeduction', resultLabel: '소득공제 금액', resultUnit: '원', inputs: [{ id: 'subscription', label: '주택청약 납입액', type: 'currency', default: 2400000, hint: '한도 연 300만원 (무주택 세대주)' }, { id: 'mortgageInterest', label: '장기주담대 이자 상환액', type: 'currency', default: 0, hint: '한도 300~1,800만원 (상환기간별)' }], faqs: [
      ...
      { q: '관련 계산기가 더 있나요?', a: '카더라는 연말정산 포함 142종의 무료 계산기를 제공합니다.' },
    ], seoContent: '<h2>주택자금 소득공제 계산기 완벽 가이드</h2><p>주택청약·주택담보대출 이자에 대한 소득공제를 계산. 카더라 주택자금 공제 계산기는 2026년 세법 기준으로 정확한 공제액을 계산합니다.</p><p>본 계산기는 <strong>소득세법 제52조</strong>를 기준으로 계산합니다. 규정은 매년 개정될 수 있으므로 전문가 확인을 권장합니다.</p><h2>연말정산 핵심 정보</h2><p>소득공제(인적공제, 신용카드, 주택청약)와 세액공제(의료비, 교육비, 기부금, 보험료, 연금저축)를 최대한 활용하면 상당한 환급을 받을 수 있습니다. 국세청 간소화 서비스(1월 15일 오픈)를 활용하세요.</p><h2>이런 분들에게 추천</h2><p>근로소득자, 연말정산 환급을 극대화하고 싶은 직장인에게 필수입니다. 체크카드 사용 비율 높이기, 연금저축/IRP 최대 납입, 월세 세액공제 신청이 핵심 전략입니다.</p>', relatedCalcs: ['year-end-refund', 'loan-repayment'] },


  // 부동산 세금 추가
  { slug: 'comprehensive-property-tax', emoji: '🏘️', category: 'property-tax', categoryLabel: '부동산 세금', title: '종합부동산세 계산기', titleShort: '종부세 계산기', description: '공시가격 기준 종합부동산세를 계산. 1세대1주택 12억 공제.', keywords: ['종합부동산세 계산기','종부세','공시가격','1세대1주택'], legalBasis: '종합부동산세법', version: '2026.04', lastUpdated: '2026-04-05', pattern: 'tax-bracket', formula: 'comprehensivePropertyTax', resultLabel: '종부세', resultUnit: '원', inputs: [{ id: 'publicPrice', label: '공시가격 합계', type: 'currency', default: 1500000000 }, { id: 'houseCount', label: '보유 주택수', type: 'stepper', default: 1, min: 1, max: 5 }, { id: 'oneHouse', label: '1세대1주택 여부', type: 'radio', default: 'yes', options: [{ value: 'yes', label: '예 (12억 공제)' }, { value: 'no', label: '아니오 (9억 공제)' }] }], faqs: [
      { q: '종부세 계산기 결과는 실제 세금과 같나요?', a: '참고용이며, 감면·중과·특례 등에 따라 차이가 있습니다. 종합부동산세법를 기준으로 계산합니다. 정확한 세액은 세무사 상담을 권장합니다.' },
      { q: '종부세 계산기에서 조정대상지역은 반영되나요?', a: '네, 조정대상지역 여부에 따른 세율 차이를 반영합니다. 최신 규제지역은 국토교통부에서 확인하세요.' },
      { q: '부동산 세금 절세 방법은?', a: '1세대1주택 비과세, 장기보유특별공제, 생애최초 감면 등을 활용하세요.' },
      { q: '종부세 계산기는 모바일에서도 되나요?', a: '네, 모바일·태블릿·PC 모든 기기에서 최적화되어 있으며 앱 설치 없이 사용 가능합니다.' },
      { q: '결과를 공유할 수 있나요?', a: '계산 완료 후 공유 버튼으로 카카오톡, URL 복사 등으로 공유 가능합니다.' },
    ], seoContent: '<h2>종합부동산세 계산기 완벽 가이드</h2><p>공시가격 기준 종합부동산세를 계산. 1세대1주택 12억 공제. 카더라 종부세 계산기는 2026년 최신 세법을 반영하여 조정대상지역, 주택 수, 면적, 취득 원인에 따른 세율을 자동 적용합니다.</p><p>본 계산기는 <strong>종합부동산세법</strong>를 기준으로 계산합니다. 규정은 매년 개정될 수 있으므로 전문가 확인을 권장합니다.</p><h2>부동산 세금 핵심 포인트</h2><p>부동산 거래 시 취득세(1~12%), 양도소득세(6~45%+중과), 재산세, 종합부동산세 등 다양한 세금이 부과됩니다. 1세대1주택 비과세(12억까지), 장기보유특별공제(최대 80%), 생애최초 감면(200만원 한도) 등 절세 제도를 적극 활용하세요.</p><h2>이런 분들에게 추천</h2><p>주택 매매·매도를 계획 중인 분, 다주택 중과세 영향을 파악하고 싶은 분, 부동산 투자 수익률을 계산하고 싶은 분에게 유용합니다. 카더라는 부동산 세금 포함 142종의 무료 계산기를 제공합니다.</p>', relatedCalcs: ['property-tax', 'acquisition-tax'] },
  ...
  { slug: 'child-support', emoji: '👨‍👩‍👧', category: 'law', categoryLabel: '법률/가정', title: '양육비 계산기', titleShort: '양육비 계산기', description: '양육비 산정기준표로 자녀 양육비를 계산.', keywords: ['양육비 계산기','양육비 산정','이혼 양육비','자녀 양육비'], legalBasis: '양육비 산정기준표 (대법원)', version: '2026.04', lastUpdated: '2026-04-05', pattern: 'simple', formula: 'childSupport', resultLabel: '월 양육비', resultUnit: '원', inputs: [{ id: 'fatherIncome', label: '부 월소득', type: 'currency', default: 4000000 }, { id: 'motherIncome', label: '모 월소득', type: 'currency', default: 3000000 }, { id: 'childAge', label: '자녀 나이', type: 'number', default: 10, min: 0, max: 18 }, { id: 'childCount', label: '자녀수', type: 'stepper', default: 1, min: 1, max: 4 }], faqs: [
    ...
    ], seoContent: '<h2>양육비 계산기 완벽 가이드</h2><p>양육비 산정기준표로 자녀 양육비를 계산. 카더라 양육비 계산기는 2026년 최신 기준을 반영하여 정확한 결과를 제공합니다.</p><p>본 계산기는 <strong>양육비 산정기준표 (대법원)</strong>를 기준으로 계산합니다. 규정은 매년 개정될 수 있으므로 전문가 확인을 권장합니다.</p><h2>법률/가정 핵심 정보</h2><p>양육비는 산정기준표에 따라 양육자 소득·자녀 나이를 기준으로 결정됩니다. 위자료, 재산분할 비율은 혼인 기간, 유책 사유에 따라 달라집니다. 정확한 금액은 변호사 상담을 권장합니다.</p><h2>이런 분들에게 추천</h2><p>정확한 법률/가정 계산이 필요한 분에게 유용합니다. 카더라는 법률/가정 포함 142종의 무료 계산기를 제공하며, 계산 결과를 카카오톡으로 공유할 수 있습니다. 본 계산기는 참고용이며 전문가 상담을 권장합니다.</p>', relatedCalcs: [] },
  ...
  { slug: 'prepayment-fee', emoji: '💸', category: 'loan', categoryLabel: '대출/예적금', title: '중도상환수수료 계산기', titleShort: '중도상환수수료', description: '대출 중도상환 시 발생하는 수수료를 계산.', keywords: ['중도상환수수료','조기상환수수료','대출 상환'], legalBasis: '금융소비자보호법 제20조 · 금융소비자 보호에 관한 감독규정 제14조', version: '2026.09', lastUpdated: '2026-09-17', pattern: 'simple', formula: 'prepaymentFee', resultLabel: '중도상환수수료', resultUnit: '원', inputs: [{ id: 'repayAmount', label: '상환 금액', type: 'currency', default: 100000000 }, { id: 'contract', label: '대출 계약 시기', type: 'select', default: 'y2026', options: [{ value: 'y2026', label: '2026년' }, { value: 'y2025', label: '2025-01-13 ~ 2025년 말' }, { value: 'pre2025', label: '2025-01-12 이전' }], hint: '요율은 계약일 기준으로 적용된다' }, { id: 'loanType', label: '대출 종류', type: 'radio', default: 'secured', options: [{ value: 'secured', label: '부동산 담보(주담대 등)' }, { value: 'otherSecured', label: '보증서·기타 담보(전세 등)' }, { value: 'credit', label: '신용' }] }, { id: 'rateType', label: '금리 방식', type: 'radio', default: 'fixed', options: [{ value: 'fixed', label: '고정' }, { value: 'variable', label: '변동' }] }, { id: 'rateMode', label: '요율', type: 'radio', default: 'representative', options: [{ value: 'representative', label: '5대 은행 대표값' }, { value: 'custom', label: '약정 요율 직접 입력' }] }, { id: 'feeRate', label: '약정 수수료율 (%)', type: 'percent', default: 0.65, min: 0, max: 3, step: 0.01, condition: 'rateMode=custom' }, { id: 'elapsedMonths', label: '대출 후 경과 기간 (개월)', type: 'number', default: 12, min: 0, max: 360 }, { id: 'loanMonths', label: '대출 기간 (개월)', type: 'number', default: 360, min: 1, max: 480 }, { id: 'feePeriodMonths', label: '수수료 적용기간 (개월)', type: 'number', default: 36, min: 1, max: 36, hint: '약정으로 정하되 법정 상한은 3년' }], faqs: [
      { q: '어떤 상환방식이 유리한가요?', a: '원금균등이 총 이자가 적지만 초기 부담이 큽니다. 원리금균등은 매월 동일 금액으로 예산 관리가 쉽습니다.' },
      { q: '변동금리와 고정금리 차이는?', a: '변동금리는 기준금리 따라 변하고, 고정금리는 계약 시 확정됩니다. 금리 상승기에는 고정이 유리합니다.' },
      { q: '중도상환수수료는 실제 대출과 차이가 있나요?', a: '참고용이며, 은행별 우대금리·수수료 등에 따라 차이가 있습니다.' },
      { q: '중도상환수수료는 모바일에서도 되나요?', a: '네, 모든 기기에서 최적화되어 있습니다.' },
      { q: '관련 계산기가 더 있나요?', a: '카더라는 대출/예적금 포함 142종의 무료 계산기를 제공합니다.' },
    ], seoContent: '<h2>중도상환수수료 계산기 완벽 가이드</h2><p>대출 중도상환 시 발생하는 수수료를 계산. 카더라 중도상환수수료는 원리금균등, 원금균등, 만기일시 상환 방식을 비교합니다.</p><h2>대출 핵심 정보</h2><p>금리 1%p 차이로 30년간 수천만원의 이자 차이가 발생합니다. 원금균등은 총 이자가 적지만 초기 부담이 크고, 원리금균등은 매월 동일 금액으로 예산 관리가 쉽습니다. DSR 40% 규제를 확인하고, 중도상환수수료 면제 시점(보통 3년)을 파악하세요.</p><h2>이런 분들에게 추천</h2><p>주택담보대출, 전세대출, 자동차 대출을 비교하는 분, 대환을 고려하는 분에게 유용합니다. 여유자금으로 원금을 줄이면 총 이자를 크게 절약할 수 있습니다.</p>', relatedCalcs: ['loan-repayment'] },
  ...
  { slug: 'housing-pension', emoji: '🏡', category: 'pension', categoryLabel: '연금/은퇴', title: '주택연금 수령액 계산기', titleShort: '주택연금 계산기', seoTitle: '주택연금 계산기 — 나이·집값별 월 수령액', description: '주택가격·나이로 주택연금 예상 월 수령액을 한국주택금융공사 월지급금 예시표 기준으로 계산.', keywords: ['주택연금 계산기','주택연금 수령액','주택연금 월지급금','역모기지','노후 주거'], legalBasis: '한국주택금융공사 월지급금 예시(2026-03-01 적용)', version: '2026.09', lastUpdated: '2026-09-16', pattern: 'simple', formula: 'housingPension', resultLabel: '예상 월 수령액', resultUnit: '원', inputs: [{ id: 'housePrice', label: '주택 시가', type: 'currency', default: 500000000, hint: '표는 12억원까지 다룬다. 넘으면 상한에서 계산한다.' }, { id: 'age', label: '가입 나이', type: 'number', default: 65, min: 55, max: 90, hint: '부부 중 연소자 기준. 만 55세부터 가입 대상이다.' }], faqs: [
      ...
      { q: '관련 계산기가 더 있나요?', a: '카더라는 연금/은퇴 포함 142종의 무료 계산기를 제공합니다.' },
    ], seoContent: '<h2>주택연금 수령액 계산기 완벽 가이드</h2><p>주택가격·나이로 주택연금 예상 월 수령액을 계산. 카더라 주택연금 계산기는 2026년 최신 기준을 반영하여 정확한 결과를 제공합니다.</p><p>본 계산기는 <strong>한국주택금융공사법</strong>를 기준으로 계산합니다. 규정은 매년 개정될 수 있으므로 전문가 확인을 권장합니다.</p><h2>연금/은퇴 핵심 정보</h2><p>국민연금 수령액은 가입기간과 소득에 따라 달라집니다. 퇴직연금(DB/DC), 개인연금(IRP, 연금저축)을 합산하면 안정적인 노후 소득을 설계할 수 있습니다. FIRE 운동의 핵심은 저축률(50%+)과 투자 수익률입니다.</p><h2>이런 분들에게 추천</h2><p>정확한 연금/은퇴 계산이 필요한 분에게 유용합니다. 카더라는 연금/은퇴 포함 142종의 무료 계산기를 제공하며, 계산 결과를 카카오톡으로 공유할 수 있습니다. 본 계산기는 참고용이며 전문가 상담을 권장합니다.</p>', relatedCalcs: ['national-pension', 'fire-calc'] },
  ...
  { slug: 'unit-convert', emoji: '🔄', category: 'life', categoryLabel: '생활/건강', title: '단위 환산기', titleShort: '단위 환산기', description: '길이·무게·면적·부피 단위를 환산.', keywords: ['단위 환산기','cm inch','kg lb','면적 변환'], legalBasis: '계량법', version: '2026.04', lastUpdated: '2026-04-05', pattern: 'simple', formula: 'unitConvert', resultLabel: '변환 결과', resultUnit: '', inputs: [{ id: 'category', label: '단위 종류', type: 'select', default: 'length', options: [{ value: 'length', label: '길이 (cm↔inch)' }, { value: 'weight', label: '무게 (kg↔lb)' }, { value: 'temperature', label: '온도 (°C↔°F)' }] }, { id: 'value', label: '값', type: 'number', default: 170, step: 0.1 }, { id: 'direction', label: '방향', type: 'radio', default: 'aToB', options: [{ value: 'aToB', label: 'A → B' }, { value: 'bToA', label: 'B → A' }] }], faqs: [
      { q: '단위 환산기 결과는 의학적으로 정확한가요?', a: '일반적인 공식 기반 참고 수치입니다. 정확한 건강 판단은 의료 전문가와 상담하세요.' },
      { q: '단위 환산기는 남녀 기준이 다른가요?', a: '대부분의 건강 지표는 성별에 따라 다른 기준을 적용합니다. 성별 선택 시 자동 반영됩니다.' },
      { q: '단위 환산기는 무료인가요?', a: '네, 카더라 단위 환산기는 완전 무료이며 회원가입 없이 이용 가능합니다.' },
      { q: '단위 환산기는 모바일에서도 되나요?', a: '네, 모든 기기에서 최적화되어 있으며 앱 설치 없이 사용 가능합니다.' },
      { q: '관련 계산기가 더 있나요?', a: '카더라는 생활/건강 포함 142종의 무료 계산기를 제공합니다.' },
    ], seoContent: '<h2>단위 환산기 완벽 가이드</h2><p>길이·무게·면적·부피 단위를 환산. 카더라 단위 환산기는 과학적 공식과 최신 기준을 반영합니다.</p><p>본 계산기는 <strong>계량법</strong>를 기준으로 계산합니다. 규정은 매년 개정될 수 있으므로 전문가 확인을 권장합니다.</p><h2>건강·생활 핵심 정보</h2><p>BMI(18.5~22.9 정상), 체지방률, 기초대사량 등 건강 지표는 종합적으로 판단해야 합니다. 대한비만학회 기준은 WHO보다 엄격하여 BMI 23부터 과체중으로 분류합니다. 정확한 건강 평가는 의료 전문가와 상담하시기 바랍니다.</p><h2>이런 분들에게 추천</h2><p>체중 관리, 건강 관리를 계획 중인 분, 출산·육아를 준비하는 분, 일상의 궁금한 계산이 필요한 분에게 유용합니다. 정기적으로 계산하여 변화 추이를 기록하면 효과적입니다.</p>', relatedCalcs: ['pyeong-sqm'] },
  ...
  { slug: 'lease-vs-installment', emoji: '🔀', category: 'auto', categoryLabel: '자동차', title: '리스 vs 할부 비교기', titleShort: '리스vs할부 비교', description: '자동차 리스와 할부의 총 비용을 비교.', keywords: ['리스 할부 비교','자동차 리스','장기렌트','할부 이자'], legalBasis: '', version: '2026.04', lastUpdated: '2026-04-05', pattern: 'compare', formula: 'leaseVsInstallment', resultLabel: '비교 결과', resultUnit: '', inputs: [{ id: 'carPrice', label: '차량 가격', type: 'currency', default: 40000000 }, { id: 'leaseMonthly', label: '리스 월 납입금', type: 'currency', default: 600000 }, { id: 'leaseMonths', label: '리스 기간 (개월)', type: 'number', default: 48 }, { id: 'leaseResidual', label: '잔존가치', type: 'currency', default: 16000000 }, { id: 'installRate', label: '할부 금리 (%)', type: 'percent', default: 5.9 }, { id: 'downPayment', label: '선수금', type: 'currency', default: 10000000 }], faqs: [
      { q: '리스vs할부 비교 결과는 정확한가요?', a: '2026년 최신 기준 반영이지만, 개인 상황에 따라 차이가 있습니다. 전문가 상담을 권장합니다.' },
      ...
      { q: '관련 계산기가 더 있나요?', a: '카더라는 자동차 포함 142종의 무료 계산기를 제공합니다.' },
    ], seoContent: '<h2>리스 vs 할부 비교기 완벽 가이드</h2><p>자동차 리스와 할부의 총 비용을 비교. 카더라 리스vs할부 비교는 2026년 최신 기준을 반영하여 정확한 결과를 제공합니다.</p><h2>자동차 핵심 정보</h2><p>자동차 취득 시 취등록세, 보유 시 자동차세, 운행 시 유류비·보험료가 발생합니다. 전기차는 유류비가 1/3 수준이지만 충전 인프라와 배터리 교체 비용을 고려하세요.</p><h2>이런 분들에게 추천</h2><p>정확한 자동차 계산이 필요한 분에게 유용합니다. 카더라는 자동차 포함 142종의 무료 계산기를 제공하며, 계산 결과를 카카오톡으로 공유할 수 있습니다. 본 계산기는 참고용이며 전문가 상담을 권장합니다.</p>', relatedCalcs: ['car-installment', 'vehicle-tax'] },
  ...
  { slug: 'overtime-pay', emoji: '🌙', category: 'salary', categoryLabel: '급여/노동', title: '야간/연장 수당 계산기', titleShort: '야간수당 계산기', description: '연장·야간·휴일 근무 수당을 통상임금 기준으로 계산.', keywords: ['야간수당 계산기','연장근로 수당','휴일수당','통상임금'], legalBasis: '근로기준법 제56조', version: '2026.04', lastUpdated: '2026-04-05', pattern: 'simple', formula: 'overtimePay', resultLabel: '추가 수당', resultUnit: '원', inputs: [{ id: 'hourlyWage', label: '시급 (통상임금)', type: 'currency', default: 15000 }, { id: 'overtimeHours', label: '연장근로 시간', type: 'number', default: 10, min: 0, max: 100 }, { id: 'nightHours', label: '야간근로 시간', type: 'number', default: 0, min: 0, max: 100 }, { id: 'holidayHours', label: '휴일근로 시간', type: 'number', default: 0, min: 0, max: 100 }], faqs: [
      { q: '야간수당 계산기에서 4대보험은 어떻게 적용되나요?', a: '국민연금 4.5%, 건강보험 3.545%, 장기요양 0.45%, 고용보험 0.9% — 합계 약 9.4%가 공제됩니다.' },
      { q: '비과세 급여란?', a: '식대(월 20만원), 자가운전보조금(월 20만원), 출산보육수당(월 20만원) 등 소득세 면제 항목입니다.' },
      { q: '야간수당 계산기 결과가 실제와 다를 수 있나요?', a: '부양가족 수, 비과세 항목, 보험 상한 등에 따라 차이가 발생합니다. 근로기준법 제56조를 기준으로 계산합니다.' },
      { q: '야간수당 계산기는 모바일에서도 되나요?', a: '네, 모든 기기에서 최적화되어 있습니다.' },
      { q: '관련 계산기가 더 있나요?', a: '카더라는 급여/노동 포함 142종의 무료 계산기를 제공합니다.' },
    ], seoContent: '<h2>야간/연장 수당 계산기 완벽 가이드</h2><p>연장·야간·휴일 근무 수당을 통상임금 기준으로 계산. 카더라 야간수당 계산기는 2026년 4대보험 요율과 근로소득 간이세액표를 반영합니다.</p><p>본 계산기는 <strong>근로기준법 제56조</strong>를 기준으로 계산합니다. 규정은 매년 개정될 수 있으므로 전문가 확인을 권장합니다.</p><h2>급여 핵심 정보</h2><p>직장인 세전 급여에서 국민연금(4.5%), 건강보험(3.545%), 장기요양(0.45%), 고용보험(0.9%) 합계 약 9.4%가 공제됩니다. 여기에 근로소득세와 지방소득세가 추가됩니다. 비과세 급여(식대 20만원, 자가운전보조금 20만원)를 활용하면 실수령액을 높일 수 있습니다.</p><h2>이런 분들에게 추천</h2><p>연봉 협상 중인 직장인, 첫 취업을 앞둔 구직자, 급여 명세서를 이해하고 싶은 분에게 유용합니다. 연말정산 환급을 극대화하려면 체크카드 사용 비율을 높이고, IRP/연금저축에 최대 납입하세요.</p>', relatedCalcs: ['hourly-annual', 'net-salary'] },
  ...
  { slug: 'annual-leave-pay', emoji: '🏖️', category: 'salary', categoryLabel: '급여/노동', title: '연차 수당 계산기', titleShort: '연차수당 계산기', description: '미사용 연차에 대한 연차수당을 통상임금 기준으로 계산.', keywords: ['연차수당 계산기','연차 미사용 수당','통상임금','유급휴가'], legalBasis: '근로기준법 제60조', version: '2026.04', lastUpdated: '2026-04-05', pattern: 'simple', formula: 'annualLeavePay', resultLabel: '연차수당', resultUnit: '원', inputs: [{ id: 'monthlySalary', label: '월 통상임금', type: 'currency', default: 3500000 }, { id: 'unusedDays', label: '미사용 연차 (일)', type: 'number', default: 5, min: 0, max: 25 }, { id: 'weeklyHours', label: '주당 근로시간', type: 'number', default: 40 }], faqs: [
      { q: '연차수당 계산기에서 4대보험은 어떻게 적용되나요?', a: '국민연금 4.5%, 건강보험 3.545%, 장기요양 0.45%, 고용보험 0.9% — 합계 약 9.4%가 공제됩니다.' },
      { q: '비과세 급여란?', a: '식대(월 20만원), 자가운전보조금(월 20만원), 출산보육수당(월 20만원) 등 소득세 면제 항목입니다.' },
      { q: '연차수당 계산기 결과가 실제와 다를 수 있나요?', a: '부양가족 수, 비과세 항목, 보험 상한 등에 따라 차이가 발생합니다. 근로기준법 제60조를 기준으로 계산합니다.' },
      { q: '연차수당 계산기는 모바일에서도 되나요?', a: '네, 모든 기기에서 최적화되어 있습니다.' },
      { q: '관련 계산기가 더 있나요?', a: '카더라는 급여/노동 포함 142종의 무료 계산기를 제공합니다.' },
    ], seoContent: '<h2>연차 수당 계산기 완벽 가이드</h2><p>미사용 연차에 대한 연차수당을 통상임금 기준으로 계산. 카더라 연차수당 계산기는 2026년 4대보험 요율과 근로소득 간이세액표를 반영합니다.</p><p>본 계산기는 <strong>근로기준법 제60조</strong>를 기준으로 계산합니다. 규정은 매년 개정될 수 있으므로 전문가 확인을 권장합니다.</p><h2>급여 핵심 정보</h2><p>직장인 세전 급여에서 국민연금(4.5%), 건강보험(3.545%), 장기요양(0.45%), 고용보험(0.9%) 합계 약 9.4%가 공제됩니다. 여기에 근로소득세와 지방소득세가 추가됩니다. 비과세 급여(식대 20만원, 자가운전보조금 20만원)를 활용하면 실수령액을 높일 수 있습니다.</p><h2>이런 분들에게 추천</h2><p>연봉 협상 중인 직장인, 첫 취업을 앞둔 구직자, 급여 명세서를 이해하고 싶은 분에게 유용합니다. 연말정산 환급을 극대화하려면 체크카드 사용 비율을 높이고, IRP/연금저축에 최대 납입하세요.</p>', relatedCalcs: ['net-salary', 'overtime-pay'] },
  ...
  { slug: 'capital-gains-land', emoji: '🌾', category: 'property-tax', categoryLabel: '부동산 세금', title: '양도소득세 계산기 (토지)', titleShort: '토지 양도세 계산기', description: '토지 매도 시 양도소득세를 계산. 비사업용 토지 중과.', keywords: ['토지 양도소득세','비사업용 토지','토지 세금'], legalBasis: '소득세법 제104조', version: '2026.04', lastUpdated: '2026-04-05', pattern: 'tax-bracket', formula: 'capitalGainsLand', resultLabel: '양도소득세', resultUnit: '원', inputs: [{ id: 'sellPrice', label: '양도가액', type: 'currency', default: 300000000 }, { id: 'buyPrice', label: '취득가액', type: 'currency', default: 200000000 }, { id: 'expenses', label: '필요경비', type: 'currency', default: 5000000 }, { id: 'holdYears', label: '보유기간 (년)', type: 'number', default: 5 }, { id: 'nonBusiness', label: '비사업용 토지', type: 'radio', default: 'no', options: [{ value: 'yes', label: '예 (+10% 중과)' }, { value: 'no', label: '아니오' }] }], faqs: [
      ...
      { q: '토지 양도세 계산기에서 조정대상지역은 반영되나요?', a: '네, 조정대상지역 여부에 따른 세율 차이를 반영합니다. 최신 규제지역은 국토교통부에서 확인하세요.' },
      { q: '부동산 세금 절세 방법은?', a: '1세대1주택 비과세, 장기보유특별공제, 생애최초 감면 등을 활용하세요.' },
      { q: '토지 양도세 계산기는 모바일에서도 되나요?', a: '네, 모바일·태블릿·PC 모든 기기에서 최적화되어 있으며 앱 설치 없이 사용 가능합니다.' },
      { q: '결과를 공유할 수 있나요?', a: '계산 완료 후 공유 버튼으로 카카오톡, URL 복사 등으로 공유 가능합니다.' },
    ], seoContent: '<h2>양도소득세 계산기 (토지) 완벽 가이드</h2><p>토지 매도 시 양도소득세를 계산. 비사업용 토지 중과. 카더라 토지 양도세 계산기는 2026년 최신 세법을 반영하여 조정대상지역, 주택 수, 면적, 취득 원인에 따른 세율을 자동 적용합니다.</p><p>본 계산기는 <strong>소득세법 제104조</strong>를 기준으로 계산합니다. 규정은 매년 개정될 수 있으므로 전문가 확인을 권장합니다.</p><h2>부동산 세금 핵심 포인트</h2><p>부동산 거래 시 취득세(1~12%), 양도소득세(6~45%+중과), 재산세, 종합부동산세 등 다양한 세금이 부과됩니다. 1세대1주택 비과세(12억까지), 장기보유특별공제(최대 80%), 생애최초 감면(200만원 한도) 등 절세 제도를 적극 활용하세요.</p><h2>이런 분들에게 추천</h2><p>주택 매매·매도를 계획 중인 분, 다주택 중과세 영향을 파악하고 싶은 분, 부동산 투자 수익률을 계산하고 싶은 분에게 유용합니다. 카더라는 부동산 세금 포함 142종의 무료 계산기를 제공합니다.</p>', relatedCalcs: ['capital-gains-housing', 'acquisition-tax'] },
  ...
  { slug: 'investment-type-test', emoji: '🧪', category: 'investment', categoryLabel: '주식/투자', title: '투자 성향 진단기', titleShort: '투자 성향 진단', description: '5개 질문으로 안전형/안정형/위험형 투자 성향을 진단.', keywords: ['투자 성향 진단','투자 성향 테스트','위험 성향'], legalBasis: '', version: '2026.04', lastUpdated: '2026-04-05', pattern: 'diagnose', formula: 'investmentTypeTest', resultLabel: '투자 성향', resultUnit: '', inputs: [{ id: 'q1', label: '투자 경험', type: 'radio', default: '2', options: [{ value: '1', label: '없음' }, { value: '2', label: '1~3년' }, { value: '3', label: '3년 이상' }] }, { id: 'q2', label: '원금 손실 감내', type: 'radio', default: '2', options: [{ value: '1', label: '10% 이하' }, { value: '2', label: '20~30%' }, { value: '3', label: '50% 이상' }] }, { id: 'q3', label: '투자 기간', type: 'radio', default: '2', options: [{ value: '1', label: '1년 미만' }, { value: '2', label: '1~5년' }, { value: '3', label: '5년 이상' }] }], faqs: [
      { q: '투자 성향 진단에서 세금은 반영되나요?', a: '국내 주식 증권거래세(매도 시 부과 — 세율은 시장별로 다르다)와 수수료를 반영합니다. 해외주식은 양도세(22%, 250만원 공제) 별도입니다.' },
      { q: '투자 수익 과세 기준은?', a: '국내 상장주식은 대주주만 양도세, 해외주식은 250만원 초과 시 22%, 배당은 15.4% 원천징수입니다.' },
      { q: '투자 성향 진단는 무료인가요?', a: '네, 카더라 투자 성향 진단는 무료이며 회원가입 없이 무제한 이용 가능합니다.' },
      { q: '투자 성향 진단는 모바일에서도 되나요?', a: '네, 모든 기기에서 최적화되어 있습니다.' },
      { q: '관련 계산기가 더 있나요?', a: '카더라는 주식/투자 포함 142종의 무료 계산기를 제공합니다.' },
    ], seoContent: '<h2>투자 성향 진단기 완벽 가이드</h2><p>5개 질문으로 안전형/안정형/위험형 투자 성향을 진단. 카더라 투자 성향 진단는 수수료, 세금을 반영한 실질 수익을 계산합니다.</p><h2>투자 핵심 정보</h2><p>투자 수익에는 증권거래세(매도 시 부과 — 세율은 시장별로 다르다), 수수료, 배당소득세(15.4%), 해외주식 양도세(22%, 250만원 공제) 등이 적용됩니다. 72법칙(72÷수익률=원금2배 년수)으로 복리 효과를 빠르게 파악할 수 있습니다. 장기 적립식 투자와 배당 재투자가 자산 증식의 핵심입니다.</p><h2>이런 분들에게 추천</h2><p>주식·펀드·ETF 투자자, 배당 투자 계획 중인 분, 투자 성과를 정확히 측정하고 싶은 분에게 유용합니다. 투자에는 원금 손실 위험이 있으며, 본 계산기는 참고용입니다.</p>', relatedCalcs: ['compound-interest', 'fire-calc'] },
  ...
  { slug: 'freelancer-tax', emoji: '💻', category: 'salary', categoryLabel: '급여/노동', title: '프리랜서 세금 계산기', titleShort: '프리랜서 세금 계산기', description: '프리랜서 연 수입으로 예상 종합소득세와 환급액을 계산.', keywords: ['프리랜서 세금','종합소득세','경비율','5월 신고'], legalBasis: '소득세법', version: '2026.04', lastUpdated: '2026-04-05', pattern: 'tax-bracket', formula: 'freelancerTax', resultLabel: '예상 종합소득세', resultUnit: '원', inputs: [{ id: 'annualRevenue', label: '연 수입', type: 'currency', default: 50000000 }, { id: 'expenseType', label: '경비 유형', type: 'radio', default: 'simple', options: [{ value: 'simple', label: '단순경비율' }, { value: 'actual', label: '실제경비' }] }, { id: 'expenseRate', label: '경비율/경비액', type: 'percent', default: 64.1 }, { id: 'withheld', label: '기납부 3.3% 합계', type: 'currency', default: 1650000 }], faqs: [
      { q: '프리랜서 세금 계산기에서 4대보험은 어떻게 적용되나요?', a: '국민연금 4.5%, 건강보험 3.545%, 장기요양 0.45%, 고용보험 0.9% — 합계 약 9.4%가 공제됩니다.' },
      { q: '비과세 급여란?', a: '식대(월 20만원), 자가운전보조금(월 20만원), 출산보육수당(월 20만원) 등 소득세 면제 항목입니다.' },
      { q: '프리랜서 세금 계산기 결과가 실제와 다를 수 있나요?', a: '부양가족 수, 비과세 항목, 보험 상한 등에 따라 차이가 발생합니다. 소득세법를 기준으로 계산합니다.' },
      { q: '프리랜서 세금 계산기는 모바일에서도 되나요?', a: '네, 모든 기기에서 최적화되어 있습니다.' },
      { q: '관련 계산기가 더 있나요?', a: '카더라는 급여/노동 포함 142종의 무료 계산기를 제공합니다.' },
    ], seoContent: '<h2>프리랜서 세금 계산기 완벽 가이드</h2><p>프리랜서 연 수입으로 예상 종합소득세와 환급액을 계산. 카더라 프리랜서 세금 계산기는 2026년 4대보험 요율과 근로소득 간이세액표를 반영합니다.</p><p>본 계산기는 <strong>소득세법</strong>를 기준으로 계산합니다. 규정은 매년 개정될 수 있으므로 전문가 확인을 권장합니다.</p><h2>급여 핵심 정보</h2><p>직장인 세전 급여에서 국민연금(4.5%), 건강보험(3.545%), 장기요양(0.45%), 고용보험(0.9%) 합계 약 9.4%가 공제됩니다. 여기에 근로소득세와 지방소득세가 추가됩니다. 비과세 급여(식대 20만원, 자가운전보조금 20만원)를 활용하면 실수령액을 높일 수 있습니다.</p><h2>이런 분들에게 추천</h2><p>연봉 협상 중인 직장인, 첫 취업을 앞둔 구직자, 급여 명세서를 이해하고 싶은 분에게 유용합니다. 연말정산 환급을 극대화하려면 체크카드 사용 비율을 높이고, IRP/연금저축에 최대 납입하세요.</p>', relatedCalcs: ['withholding-3-3', 'comprehensive-income-tax'] },
  ...
  { slug: 'car-loan', emoji: '🚗', category: 'loan', categoryLabel: '대출/예적금', title: '자동차 대출 계산기', titleShort: '자동차 대출 계산기', description: '자동차 구매 대출의 월 상환액과 총 이자를 계산.', keywords: ['자동차 대출','차량 대출','할부금 계산'], legalBasis: '', version: '2026.04', lastUpdated: '2026-04-05', pattern: 'amortize', formula: 'carInstallment', resultLabel: '월 상환액', resultUnit: '원', inputs: [{ id: 'carPrice', label: '차량 가격', type: 'currency', default: 35000000 }, { id: 'downPayment', label: '선수금', type: 'currency', default: 7000000 }, { id: 'rate', label: '금리 (%)', type: 'percent', default: 5.5 }, { id: 'months', label: '기간 (개월)', type: 'select', default: '48', options: [{ value: '24', label: '24개월' }, { value: '36', label: '36개월' }, { value: '48', label: '48개월' }, { value: '60', label: '60개월' }] }], faqs: [
      ...
      { q: '관련 계산기가 더 있나요?', a: '카더라는 대출/예적금 포함 142종의 무료 계산기를 제공합니다.' },
    ], seoContent: '<h2>자동차 대출 계산기 완벽 가이드</h2><p>자동차 구매 대출의 월 상환액과 총 이자를 계산. 카더라 자동차 대출 계산기는 원리금균등, 원금균등, 만기일시 상환 방식을 비교합니다.</p><h2>대출 핵심 정보</h2><p>금리 1%p 차이로 30년간 수천만원의 이자 차이가 발생합니다. 원금균등은 총 이자가 적지만 초기 부담이 크고, 원리금균등은 매월 동일 금액으로 예산 관리가 쉽습니다. DSR 40% 규제를 확인하고, 중도상환수수료 면제 시점(보통 3년)을 파악하세요.</p><h2>이런 분들에게 추천</h2><p>주택담보대출, 전세대출, 자동차 대출을 비교하는 분, 대환을 고려하는 분에게 유용합니다. 여유자금으로 원금을 줄이면 총 이자를 크게 절약할 수 있습니다.</p>', relatedCalcs: ['loan-repayment', 'car-installment'] },
  { slug: 'student-loan', emoji: '🎓', category: 'loan', categoryLabel: '대출/예적금', title: '학자금 대출 상환 계산기', titleShort: '학자금 대출 계산기', description: '한국장학재단 학자금 대출의 상환 금액을 계산.', keywords: ['학자금 대출','한국장학재단','등록금 대출','ICL'], legalBasis: '', version: '2026.04', lastUpdated: '2026-04-05', pattern: 'amortize', formula: 'loanRepayment', resultLabel: '월 상환액', resultUnit: '원', inputs: [{ id: 'principal', label: '대출 원금', type: 'currency', default: 20000000 }, { id: 'rate', label: '이자율 (%)', type: 'percent', default: 1.7 }, { id: 'years', label: '상환 기간 (년)', type: 'range', default: 10, min: 1, max: 20 }, { id: 'method', label: '상환 방식', type: 'radio', default: 'equal', options: [{ value: 'equal', label: '원리금균등' }, { value: 'principal', label: '원금균등' }] }, { id: 'grace', label: '거치기간 (개월)', type: 'number', default: 0 }], faqs: [
      { q: '어떤 상환방식이 유리한가요?', a: '원금균등이 총 이자가 적지만 초기 부담이 큽니다. 원리금균등은 매월 동일 금액으로 예산 관리가 쉽습니다.' },
      { q: '변동금리와 고정금리 차이는?', a: '변동금리는 기준금리 따라 변하고, 고정금리는 계약 시 확정됩니다. 금리 상승기에는 고정이 유리합니다.' },
      { q: '학자금 대출 계산기는 실제 대출과 차이가 있나요?', a: '참고용이며, 은행별 우대금리·수수료 등에 따라 차이가 있습니다.' },
      { q: '학자금 대출 계산기는 모바일에서도 되나요?', a: '네, 모든 기기에서 최적화되어 있습니다.' },
      { q: '관련 계산기가 더 있나요?', a: '카더라는 대출/예적금 포함 142종의 무료 계산기를 제공합니다.' },
    ], seoContent: '<h2>학자금 대출 상환 계산기 완벽 가이드</h2><p>한국장학재단 학자금 대출의 상환 금액을 계산. 카더라 학자금 대출 계산기는 원리금균등, 원금균등, 만기일시 상환 방식을 비교합니다.</p><h2>대출 핵심 정보</h2><p>금리 1%p 차이로 30년간 수천만원의 이자 차이가 발생합니다. 원금균등은 총 이자가 적지만 초기 부담이 크고, 원리금균등은 매월 동일 금액으로 예산 관리가 쉽습니다. DSR 40% 규제를 확인하고, 중도상환수수료 면제 시점(보통 3년)을 파악하세요.</p><h2>이런 분들에게 추천</h2><p>주택담보대출, 전세대출, 자동차 대출을 비교하는 분, 대환을 고려하는 분에게 유용합니다. 여유자금으로 원금을 줄이면 총 이자를 크게 절약할 수 있습니다.</p>', relatedCalcs: ['loan-repayment'] },
  ...
  { slug: 'telecom-compare', emoji: '📱', category: 'shopping', categoryLabel: '쇼핑/소비', title: '통신비 비교 계산기', titleShort: '통신비 비교기', description: '알뜰폰 vs 일반 요금제 월/연 비용을 비교.', keywords: ['통신비 비교','알뜰폰','요금제 비교','핸드폰 요금'], legalBasis: '', version: '2026.04', lastUpdated: '2026-04-05', pattern: 'compare', formula: 'telecomCompare', resultLabel: '연간 절약액', resultUnit: '원', inputs: [{ id: 'currentPlan', label: '현재 월 요금', type: 'currency', default: 69000 }, { id: 'newPlan', label: '비교 요금제', type: 'currency', default: 33000 }], faqs: [
      { q: '통신비 비교기 결과는 정확한가요?', a: '2026년 최신 기준 반영이지만, 개인 상황에 따라 차이가 있습니다. 전문가 상담을 권장합니다.' },
      ...
      { q: '관련 계산기가 더 있나요?', a: '카더라는 쇼핑/소비 포함 142종의 무료 계산기를 제공합니다.' },
    ], seoContent: '<h2>통신비 비교 계산기 완벽 가이드</h2><p>알뜰폰 vs 일반 요금제 월/연 비용을 비교. 카더라 통신비 비교기는 2026년 최신 기준을 반영하여 정확한 결과를 제공합니다.</p><h2>쇼핑/소비 핵심 정보</h2><p>해외직구 면세한도: 미국 $200, 일반 $150. 초과분에 관세+부가세 부과. 카드 할부 이자는 무이자 외에 수수료가 포함되며, 일시불 대비 총 비용을 비교하세요.</p><h2>이런 분들에게 추천</h2><p>정확한 쇼핑/소비 계산이 필요한 분에게 유용합니다. 카더라는 쇼핑/소비 포함 142종의 무료 계산기를 제공하며, 계산 결과를 카카오톡으로 공유할 수 있습니다. 본 계산기는 참고용이며 전문가 상담을 권장합니다.</p>', relatedCalcs: ['subscription-total'] },
  // ════ 군대/교육 추가 ════
  { slug: 'graduation-year', emoji: '🎓', category: 'military', categoryLabel: '군대/교육', title: '졸업/전역 연도 계산기', titleShort: '졸업 연도 계산기', description: '생년월일로 초중고·대학 졸업연도와 전역 예상연도를 계산.', keywords: ['졸업 연도','전역 연도','학교 졸업','입학 연도'], legalBasis: '', version: '2026.04', lastUpdated: '2026-04-05', pattern: 'simple', formula: 'graduationYear', resultLabel: '졸업/전역 연도', resultUnit: '', inputs: [{ id: 'birthYear', label: '출생연도', type: 'number', default: 2000, min: 1970, max: 2020 }, { id: 'birthMonth', label: '출생월', type: 'number', default: 6, min: 1, max: 12 }], faqs: [
      { q: '졸업 연도 계산기 결과는 정확한가요?', a: '2026년 최신 기준 반영이지만, 개인 상황에 따라 차이가 있습니다. 전문가 상담을 권장합니다.' },
      ...
      { q: '관련 계산기가 더 있나요?', a: '카더라는 군대/교육 포함 142종의 무료 계산기를 제공합니다.' },
    ], seoContent: '<h2>졸업/전역 연도 계산기 완벽 가이드</h2><p>생년월일로 초중고·대학 졸업연도와 전역 예상연도를 계산. 카더라 졸업 연도 계산기는 2026년 최신 기준을 반영하여 정확한 결과를 제공합니다.</p><h2>군대/교육 핵심 정보</h2><p>2026년 병사 월급: 이병 67만원, 일병 78만원, 상병 97만원, 병장 125만원. 군 복무 중 학자금 대출 이자 지원, 전역 후 복학 시 등록금 감면 등 혜택을 확인하세요.</p><h2>이런 분들에게 추천</h2><p>정확한 군대/교육 계산이 필요한 분에게 유용합니다. 카더라는 군대/교육 포함 142종의 무료 계산기를 제공하며, 계산 결과를 카카오톡으로 공유할 수 있습니다. 본 계산기는 참고용이며 전문가 상담을 권장합니다.</p>', relatedCalcs: ['discharge-date', 'age-calc'] },
  ...
  { slug: 'gift-exemption-lookup', emoji: '🔍', category: 'inheritance', categoryLabel: '상속/증여', title: '증여 면제한도 조회기', titleShort: '증여 면제한도 조회', description: '수증자 관계별 10년간 증여 면제한도를 조회.', keywords: ['증여 면제한도','증여 공제','가족 증여','10년 합산'], legalBasis: '상속세및증여세법 제53조', version: '2026.04', lastUpdated: '2026-04-05', pattern: 'simple', formula: 'giftExemptionLookup', resultLabel: '면제한도', resultUnit: '원', inputs: [{ id: 'relationship', label: '관계', type: 'select', default: 'adultChild', options: [{ value: 'spouse', label: '배우자' }, { value: 'adultChild', label: '성년 자녀' }, { value: 'minorChild', label: '미성년 자녀' }, { value: 'otherRelative', label: '기타 친족' }] }], faqs: [
      { q: '증여 면제한도 조회에서 면제한도는?', a: '배우자 6억, 성년 자녀 5천만원, 미성년 2천만원 (10년간 합산).' },
      { q: '증여와 상속 어떤 것이 유리?', a: '10년 분할 증여로 면제한도를 활용하면 상속보다 절세 효과가 큽니다.' },
      { q: '증여 면제한도 조회 결과는 정확한가요?', a: '참고용이며, 부동산 평가·감면·공제 등에 따라 차이가 있습니다. 상속세및증여세법 제53조를 기준으로 계산합니다.' },
      { q: '증여 면제한도 조회는 모바일에서도 되나요?', a: '네, 모든 기기에서 최적화되어 있습니다.' },
      { q: '관련 계산기가 더 있나요?', a: '카더라는 상속/증여 포함 142종의 무료 계산기를 제공합니다.' },
    ], seoContent: '<h2>증여 면제한도 조회기 완벽 가이드</h2><p>수증자 관계별 10년간 증여 면제한도를 조회. 카더라 증여 면제한도 조회는 2026년 상속세 및 증여세법 기준으로 계산합니다.</p><p>본 계산기는 <strong>상속세및증여세법 제53조</strong>를 기준으로 계산합니다. 규정은 매년 개정될 수 있으므로 전문가 확인을 권장합니다.</p><h2>상속·증여 핵심 정보</h2><p>10~50% 누진세율 적용. 증여재산공제: 배우자 6억, 성년자녀 5천만원, 미성년 2천만원 (10년간 합산). 부동산 증여 시 기준시가 평가로 절세 효과가 있지만, 5년 내 매도 시 이월과세에 주의하세요.</p><h2>이런 분들에게 추천</h2><p>자녀에게 재산을 이전하려는 부모, 상속 계획을 세우는 분, 부담부증여를 검토하는 분에게 유용합니다. 미성년 시기부터 2천만원씩 시작하면 수십 년간 수억원을 비과세로 이전 가능합니다.</p>', relatedCalcs: ['gift-tax', 'inheritance-tax'] },
  { slug: 'burden-gift', emoji: '📋', category: 'inheritance', categoryLabel: '상속/증여', title: '부담부증여 세금 계산기', titleShort: '부담부증여 계산기', description: '부담부증여 시 증여세+양도소득세 이중과세를 계산.', keywords: ['부담부증여','부담부증여 세금','증여 양도세'], legalBasis: '상속세및증여세법 제47조', version: '2026.04', lastUpdated: '2026-04-05', pattern: 'conditional', formula: 'burdenGift', resultLabel: '세금 합계', resultUnit: '원', inputs: [{ id: 'propertyValue', label: '증여 재산가액', type: 'currency', default: 500000000 }, { id: 'debt', label: '인수 채무 (대출 등)', type: 'currency', default: 200000000 }, { id: 'buyPrice', label: '취득가액', type: 'currency', default: 300000000 }, { id: 'relationship', label: '수증자 관계', type: 'select', default: 'adultChild', options: [{ value: 'spouse', label: '배우자' }, { value: 'adultChild', label: '성년 자녀' }, { value: 'minorChild', label: '미성년 자녀' }] }], faqs: [
      { q: '부담부증여 계산기에서 면제한도는?', a: '배우자 6억, 성년 자녀 5천만원, 미성년 2천만원 (10년간 합산).' },
      { q: '증여와 상속 어떤 것이 유리?', a: '10년 분할 증여로 면제한도를 활용하면 상속보다 절세 효과가 큽니다.' },
      { q: '부담부증여 계산기 결과는 정확한가요?', a: '참고용이며, 부동산 평가·감면·공제 등에 따라 차이가 있습니다. 상속세및증여세법 제47조를 기준으로 계산합니다.' },
      { q: '부담부증여 계산기는 모바일에서도 되나요?', a: '네, 모든 기기에서 최적화되어 있습니다.' },
      { q: '관련 계산기가 더 있나요?', a: '카더라는 상속/증여 포함 142종의 무료 계산기를 제공합니다.' },
    ], seoContent: '<h2>부담부증여 세금 계산기 완벽 가이드</h2><p>부담부증여 시 증여세+양도소득세 이중과세를 계산. 카더라 부담부증여 계산기는 2026년 상속세 및 증여세법 기준으로 계산합니다.</p><p>본 계산기는 <strong>상속세및증여세법 제47조</strong>를 기준으로 계산합니다. 규정은 매년 개정될 수 있으므로 전문가 확인을 권장합니다.</p><h2>상속·증여 핵심 정보</h2><p>10~50% 누진세율 적용. 증여재산공제: 배우자 6억, 성년자녀 5천만원, 미성년 2천만원 (10년간 합산). 부동산 증여 시 기준시가 평가로 절세 효과가 있지만, 5년 내 매도 시 이월과세에 주의하세요.</p><h2>이런 분들에게 추천</h2><p>자녀에게 재산을 이전하려는 부모, 상속 계획을 세우는 분, 부담부증여를 검토하는 분에게 유용합니다. 미성년 시기부터 2천만원씩 시작하면 수십 년간 수억원을 비과세로 이전 가능합니다.</p>', relatedCalcs: ['gift-tax', 'capital-gains-housing'] },
  ...
  { slug: 'registration-license-tax', emoji: '📜', category: 'property-tax', categoryLabel: '부동산 세금', title: '등록면허세 계산기', titleShort: '등록면허세 계산기', description: '소유권이전·설정 시 등록면허세를 계산.', keywords: ['등록면허세','소유권이전','등록세'], legalBasis: '지방세법 제28조', version: '2026.04', lastUpdated: '2026-04-05', pattern: 'simple', formula: 'registrationLicenseTax', resultLabel: '등록면허세', resultUnit: '원', inputs: [{ id: 'price', label: '과세표준', type: 'currency', default: 500000000 }, { id: 'type', label: '등기 유형', type: 'radio', default: 'transfer', options: [{ value: 'transfer', label: '소유권이전 (2%)' }, { value: 'mortgage', label: '저당권설정 (0.2%)' }] }], faqs: [
      ...
      { q: '부동산 세금 절세 방법은?', a: '1세대1주택 비과세, 장기보유특별공제, 생애최초 감면 등을 활용하세요.' },
      { q: '등록면허세 계산기는 모바일에서도 되나요?', a: '네, 모바일·태블릿·PC 모든 기기에서 최적화되어 있으며 앱 설치 없이 사용 가능합니다.' },
      { q: '결과를 공유할 수 있나요?', a: '계산 완료 후 공유 버튼으로 카카오톡, URL 복사 등으로 공유 가능합니다.' },
    ], seoContent: '<h2>등록면허세 계산기 완벽 가이드</h2><p>소유권이전·설정 시 등록면허세를 계산. 카더라 등록면허세 계산기는 2026년 최신 세법을 반영하여 조정대상지역, 주택 수, 면적, 취득 원인에 따른 세율을 자동 적용합니다.</p><p>본 계산기는 <strong>지방세법 제28조</strong>를 기준으로 계산합니다. 규정은 매년 개정될 수 있으므로 전문가 확인을 권장합니다.</p><h2>부동산 세금 핵심 포인트</h2><p>부동산 거래 시 취득세(1~12%), 양도소득세(6~45%+중과), 재산세, 종합부동산세 등 다양한 세금이 부과됩니다. 1세대1주택 비과세(12억까지), 장기보유특별공제(최대 80%), 생애최초 감면(200만원 한도) 등 절세 제도를 적극 활용하세요.</p><h2>이런 분들에게 추천</h2><p>주택 매매·매도를 계획 중인 분, 다주택 중과세 영향을 파악하고 싶은 분, 부동산 투자 수익률을 계산하고 싶은 분에게 유용합니다. 카더라는 부동산 세금 포함 142종의 무료 계산기를 제공합니다.</p>', relatedCalcs: ['registration-cost', 'acquisition-tax'] },
  ...
  // 소득세 +3
  { slug: 'business-income-tax', emoji: '🏪', category: 'income-tax', categoryLabel: '소득세', title: '사업소득세 계산기', titleShort: '사업소득세 계산기', description: '사업소득에 대한 종합소득세를 경비율 적용하여 계산.', keywords: ['사업소득세','사업자 소득세','경비율'], legalBasis: '소득세법 제19조', version: '2026.04', lastUpdated: '2026-04-05', pattern: 'tax-bracket', formula: 'businessIncomeTax', resultLabel: '사업소득세', resultUnit: '원', inputs: [{ id: 'revenue', label: '총 수입금액', type: 'currency', default: 100000000 }, { id: 'expenses', label: '필요경비', type: 'currency', default: 60000000 }], faqs: [
      { q: '사업소득세 계산기에 적용되는 세율은?', a: '과세표준에 따라 6~45% 8단계 누진세율이 적용됩니다. 소득세법 제19조를 기준으로 계산합니다.' },
      { q: '소득공제와 세액공제의 차이는?', a: '소득공제는 과세표준을 줄이고, 세액공제는 산출세액에서 직접 차감합니다.' },
      ...
      { q: '관련 계산기가 더 있나요?', a: '카더라는 소득세 포함 142종의 무료 계산기를 제공합니다.' },
    ], seoContent: '<h2>사업소득세 계산기 완벽 가이드</h2><p>사업소득에 대한 종합소득세를 경비율 적용하여 계산. 카더라 사업소득세 계산기는 2026년 소득세법 기준 8단계 누진세율(6~45%)을 반영합니다.</p><p>본 계산기는 <strong>소득세법 제19조</strong>를 기준으로 계산합니다. 규정은 매년 개정될 수 있으므로 전문가 확인을 권장합니다.</p><h2>소득세 핵심 정보</h2><p>과세표준에 따라 1,400만원 이하 6%, 5,000만원 이하 15%, 8,800만원 이하 24%, 1.5억 이하 35%, 3억 이하 38%, 5억 이하 40%, 10억 이하 42%, 10억 초과 45%가 적용됩니다. 소득공제로 과세표준을 줄이고, 세액공제로 산출세액을 직접 차감하여 절세하세요.</p><h2>이런 분들에게 추천</h2><p>근로소득자, 프리랜서, 사업자 등 소득세 신고를 준비하는 모든 분에게 유용합니다. 연금저축/IRP 세액공제(최대 900만원 납입)를 활용하면 효과적으로 절세할 수 있습니다.</p>', relatedCalcs: ['comprehensive-income-tax'] },
  ...
  { slug: 'foreign-dividend-credit', emoji: '🌍', category: 'finance-tax', categoryLabel: '금융/투자 세금', title: '해외 배당 이중과세 환급 계산기', titleShort: '외국납부세액공제', description: '해외주식 배당에서 원천징수된 외국세액의 공제(환급)를 계산.', keywords: ['외국납부세액공제','해외배당 이중과세','배당세 환급'], legalBasis: '소득세법 제57조', version: '2026.04', lastUpdated: '2026-04-05', pattern: 'simple', formula: 'foreignDividendCredit', resultLabel: '환급 가능액', resultUnit: '원', inputs: [{ id: 'foreignTax', label: '외국 원천징수세액', type: 'currency', default: 750000 }, { id: 'domesticTax', label: '국내 산출세액', type: 'currency', default: 770000 }], faqs: [
      { q: '외국납부세액공제 결과는 정확한가요?', a: '2026년 최신 기준 반영이지만, 개인 상황에 따라 차이가 있습니다. 소득세법 제57조를 기준으로 계산합니다. 전문가 상담을 권장합니다.' },
      ...
      { q: '관련 계산기가 더 있나요?', a: '카더라는 금융/투자 세금 포함 142종의 무료 계산기를 제공합니다.' },
    ], seoContent: '<h2>해외 배당 이중과세 환급 계산기 완벽 가이드</h2><p>해외주식 배당에서 원천징수된 외국세액의 공제(환급)를 계산. 카더라 외국납부세액공제는 2026년 최신 기준을 반영하여 정확한 결과를 제공합니다.</p><p>본 계산기는 <strong>소득세법 제57조</strong>를 기준으로 계산합니다. 규정은 매년 개정될 수 있으므로 전문가 확인을 권장합니다.</p><h2>금융/투자 세금 핵심 정보</h2><p>금융투자 수익 과세: 국내 상장주식은 대주주만 양도세, 해외주식은 250만원 초과 시 22%, ETF 배당은 15.4%, ISA 비과세 한도는 일반 200만원·서민 400만원입니다.</p><h2>이런 분들에게 추천</h2><p>정확한 금융/투자 세금 계산이 필요한 분에게 유용합니다. 카더라는 금융/투자 세금 포함 142종의 무료 계산기를 제공하며, 계산 결과를 카카오톡으로 공유할 수 있습니다. 본 계산기는 참고용이며 전문가 상담을 권장합니다.</p>', relatedCalcs: ['dividend-calc', 'overseas-cgt'] },
  ...
  // 상속/증여 +2
  { slug: 'family-business', emoji: '🏭', category: 'inheritance', categoryLabel: '상속/증여', title: '가업승계 세금 계산기', titleShort: '가업승계 계산기', description: '가업상속공제 적용 시 상속세 절감액을 계산.', keywords: ['가업승계','가업상속공제','중소기업 상속'], legalBasis: '상속세및증여세법 제18조', version: '2026.04', lastUpdated: '2026-04-05', pattern: 'simple', formula: 'familyBusiness', resultLabel: '상속세 절감', resultUnit: '원', inputs: [{ id: 'businessValue', label: '가업 자산가치', type: 'currency', default: 3000000000 }, { id: 'years', label: '대표 경영기간 (년)', type: 'number', default: 15, min: 10, max: 50 }], faqs: [
      { q: '가업승계 계산기에서 면제한도는?', a: '배우자 6억, 성년 자녀 5천만원, 미성년 2천만원 (10년간 합산).' },
      { q: '증여와 상속 어떤 것이 유리?', a: '10년 분할 증여로 면제한도를 활용하면 상속보다 절세 효과가 큽니다.' },
      { q: '가업승계 계산기 결과는 정확한가요?', a: '참고용이며, 부동산 평가·감면·공제 등에 따라 차이가 있습니다. 상속세및증여세법 제18조를 기준으로 계산합니다.' },
      { q: '가업승계 계산기는 모바일에서도 되나요?', a: '네, 모든 기기에서 최적화되어 있습니다.' },
      { q: '관련 계산기가 더 있나요?', a: '카더라는 상속/증여 포함 142종의 무료 계산기를 제공합니다.' },
    ], seoContent: '<h2>가업승계 세금 계산기 완벽 가이드</h2><p>가업상속공제 적용 시 상속세 절감액을 계산. 카더라 가업승계 계산기는 2026년 상속세 및 증여세법 기준으로 계산합니다.</p><p>본 계산기는 <strong>상속세및증여세법 제18조</strong>를 기준으로 계산합니다. 규정은 매년 개정될 수 있으므로 전문가 확인을 권장합니다.</p><h2>상속·증여 핵심 정보</h2><p>10~50% 누진세율 적용. 증여재산공제: 배우자 6억, 성년자녀 5천만원, 미성년 2천만원 (10년간 합산). 부동산 증여 시 기준시가 평가로 절세 효과가 있지만, 5년 내 매도 시 이월과세에 주의하세요.</p><h2>이런 분들에게 추천</h2><p>자녀에게 재산을 이전하려는 부모, 상속 계획을 세우는 분, 부담부증여를 검토하는 분에게 유용합니다. 미성년 시기부터 2천만원씩 시작하면 수십 년간 수억원을 비과세로 이전 가능합니다.</p>', relatedCalcs: ['inheritance-tax'] },
  { slug: 'generation-skip', emoji: '👨‍👦‍👦', category: 'inheritance', categoryLabel: '상속/증여', title: '세대생략증여 할증 계산기', titleShort: '세대생략 할증 계산기', description: '손자녀 증여 시 30% 할증 과세액을 계산.', keywords: ['세대생략증여','손자 증여','30% 할증','세대 건너뛰기'], legalBasis: '상속세및증여세법 제27조', version: '2026.04', lastUpdated: '2026-04-05', pattern: 'simple', formula: 'generationSkip', resultLabel: '증여세 (할증 후)', resultUnit: '원', inputs: [{ id: 'amount', label: '증여 재산가액', type: 'currency', default: 200000000 }], faqs: [
      { q: '세대생략 할증 계산기에서 면제한도는?', a: '배우자 6억, 성년 자녀 5천만원, 미성년 2천만원 (10년간 합산).' },
      { q: '증여와 상속 어떤 것이 유리?', a: '10년 분할 증여로 면제한도를 활용하면 상속보다 절세 효과가 큽니다.' },
      { q: '세대생략 할증 계산기 결과는 정확한가요?', a: '참고용이며, 부동산 평가·감면·공제 등에 따라 차이가 있습니다. 상속세및증여세법 제27조를 기준으로 계산합니다.' },
      { q: '세대생략 할증 계산기는 모바일에서도 되나요?', a: '네, 모든 기기에서 최적화되어 있습니다.' },
      { q: '관련 계산기가 더 있나요?', a: '카더라는 상속/증여 포함 142종의 무료 계산기를 제공합니다.' },
    ], seoContent: '<h2>세대생략증여 할증 계산기 완벽 가이드</h2><p>손자녀 증여 시 30% 할증 과세액을 계산. 카더라 세대생략 할증 계산기는 2026년 상속세 및 증여세법 기준으로 계산합니다.</p><p>본 계산기는 <strong>상속세및증여세법 제27조</strong>를 기준으로 계산합니다. 규정은 매년 개정될 수 있으므로 전문가 확인을 권장합니다.</p><h2>상속·증여 핵심 정보</h2><p>10~50% 누진세율 적용. 증여재산공제: 배우자 6억, 성년자녀 5천만원, 미성년 2천만원 (10년간 합산). 부동산 증여 시 기준시가 평가로 절세 효과가 있지만, 5년 내 매도 시 이월과세에 주의하세요.</p><h2>이런 분들에게 추천</h2><p>자녀에게 재산을 이전하려는 부모, 상속 계획을 세우는 분, 부담부증여를 검토하는 분에게 유용합니다. 미성년 시기부터 2천만원씩 시작하면 수십 년간 수억원을 비과세로 이전 가능합니다.</p>', relatedCalcs: ['gift-tax'] },
  ...
  { slug: 'stamp-tax', emoji: '📃', category: 'biz-tax', categoryLabel: '사업자 세금', title: '인지세 계산기', titleShort: '인지세 계산기', description: '계약서 작성 시 납부하는 인지세를 계산.', keywords: ['인지세','계약서 인지세','인지대','수입인지'], legalBasis: '인지세법', version: '2026.04', lastUpdated: '2026-04-05', pattern: 'simple', formula: 'stampTax', resultLabel: '인지세', resultUnit: '원', inputs: [{ id: 'contractAmount', label: '계약금액', type: 'currency', default: 500000000 }], faqs: [
      { q: '인지세 계산기 결과는 정확한가요?', a: '2026년 최신 기준 반영이지만, 개인 상황에 따라 차이가 있습니다. 인지세법를 기준으로 계산합니다. 전문가 상담을 권장합니다.' },
      { q: '인지세 계산기에서 가장 중요한 입력값은?', a: '계약서 작성 시 납부하는 인지세를 계산. 정확한 수치를 입력할수록 결과 신뢰도가 높아집니다.' },
      { q: '인지세 계산기는 무료인가요?', a: '네, 카더라 인지세 계산기는 완전 무료이며 회원가입 없이 무제한 이용 가능합니다.' },
      { q: '인지세 계산기는 모바일에서도 되나요?', a: '네, 모든 기기에서 최적화되어 있으며 앱 설치 없이 사용 가능합니다.' },
      { q: '관련 계산기가 더 있나요?', a: '카더라는 사업자 세금 포함 142종의 무료 계산기를 제공합니다.' },
    ], seoContent: '<h2>인지세 계산기 완벽 가이드</h2><p>계약서 작성 시 납부하는 인지세를 계산. 카더라 인지세 계산기는 2026년 최신 기준을 반영하여 정확한 결과를 제공합니다.</p><p>본 계산기는 <strong>인지세법</strong>를 기준으로 계산합니다. 규정은 매년 개정될 수 있으므로 전문가 확인을 권장합니다.</p><h2>사업자 세금 핵심 정보</h2><p>일반과세자는 매출의 10% 부가세를 징수·납부하고, 간이과세자는 업종별 부가가치율(1.5~4%) 적용. 법인세는 2억 이하 9%, 200억 이하 19%, 3000억 이하 21%, 초과 24%입니다.</p><h2>이런 분들에게 추천</h2><p>정확한 사업자 세금 계산이 필요한 분에게 유용합니다. 카더라는 사업자 세금 포함 142종의 무료 계산기를 제공하며, 계산 결과를 카카오톡으로 공유할 수 있습니다. 본 계산기는 참고용이며 전문가 상담을 권장합니다.</p>', relatedCalcs: ['registration-cost'] },
  ...
  { slug: 'simple-bookkeeping', emoji: '📒', category: 'biz-tax', categoryLabel: '사업자 세금', title: '간편장부 소득금액 계산기', titleShort: '간편장부 계산기', description: '간편장부로 사업소득금액을 계산.', keywords: ['간편장부','사업소득','필요경비','소규모 사업자'], legalBasis: '소득세법 시행령 제131조', version: '2026.04', lastUpdated: '2026-04-05', pattern: 'simple', formula: 'simpleBookkeeping', resultLabel: '소득금액', resultUnit: '원', inputs: [{ id: 'revenue', label: '총수입금액', type: 'currency', default: 30000000 }, { id: 'expenses', label: '필요경비', type: 'currency', default: 15000000 }], faqs: [
      { q: '간편장부 계산기 결과는 정확한가요?', a: '2026년 최신 기준 반영이지만, 개인 상황에 따라 차이가 있습니다. 소득세법 시행령 제131조를 기준으로 계산합니다. 전문가 상담을 권장합니다.' },
  ...
  { slug: 'housing-bond', emoji: '📋', category: 'real-estate', categoryLabel: '부동산', title: '국민주택채권 매입금액 계산기', titleShort: '주택채권 계산기', seoTitle: '국민주택채권 계산기 — 매입금액·할인율 즉시 계산', description: '부동산 등기 시 매입해야 하는 국민주택채권 금액을 시가표준액 구간별 법정 매입률로 계산.', keywords: ['국민주택채권','국민주택채권 계산기','채권매입','등기 채권','할인율','매입률'], legalBasis: '주택도시기금법 시행령 별표', version: '2026.09', lastUpdated: '2026-09-16', pattern: 'tax-bracket', formula: 'housingBond', resultLabel: '채권 매입금액', resultUnit: '원', inputs: [{ id: 'housePrice', label: '부동산 시가표준액', type: 'currency', default: 500000000 }, { id: 'region', label: '지역', type: 'radio', default: 'metro', options: [{ value: 'metro', label: '특별시/광역시' }, { value: 'other', label: '기타 지역' }] }, { id: 'discountRate', label: '당일 고시 할인율 (%)', type: 'number', default: 0, min: 0, max: 30, step: 0.01, unit: '%', hint: '즉시매도 시에만 필요. 매일 바뀌므로 주택도시기금 홈페이지의 당일 고시값을 넣는다. 비워 두면 법정 매입금액만 계산한다.' }], faqs: [
      ...
      { q: '관련 계산기가 더 있나요?', a: '카더라는 부동산 포함 142종의 무료 계산기를 제공합니다.' },
    ], seoContent: '<h2>국민주택채권 매입금액 계산기 완벽 가이드</h2><p>부동산 등기 시 매입해야 하는 국민주택채권 금액을 계산. 카더라 주택채권 계산기는 2026년 최신 기준을 반영합니다.</p><p>본 계산기는 <strong>주택도시기금법</strong>를 기준으로 계산합니다. 규정은 매년 개정될 수 있으므로 전문가 확인을 권장합니다.</p><h2>부동산 거래 핵심 정보</h2><p>부동산 거래 시 중개수수료(0.4~0.9%), 등기비용, 취득세, 대출이자 등 다양한 비용이 발생합니다. 사전에 총 비용을 정확히 계산하면 예상치 못한 지출을 방지할 수 있습니다. 등기부등본·건축물대장·토지이용계획확인서는 반드시 확인하세요.</p><h2>이런 분들에게 추천</h2><p>주택 매매·전세·월세를 계획 중인 분, 부동산 투자 수익률을 분석하고 싶은 분, 대출 가능 금액을 확인하고 싶은 분에게 유용합니다.</p>', relatedCalcs: ['registration-cost'] },
  { slug: 'far-bcr', emoji: '🏗️', category: 'real-estate', categoryLabel: '부동산', title: '건폐율/용적률 계산기', titleShort: '건폐율/용적률', description: '대지면적·건축면적·연면적으로 건폐율과 용적률을 계산.', keywords: ['건폐율','용적률','건축면적','연면적','대지면적'], legalBasis: '건축법 제55조, 제56조', version: '2026.04', lastUpdated: '2026-04-05', pattern: 'simple', formula: 'farBcr', resultLabel: '건폐율/용적률', resultUnit: '', inputs: [{ id: 'landArea', label: '대지면적 (㎡)', type: 'number', default: 500 }, { id: 'buildingArea', label: '건축면적 (㎡)', type: 'number', default: 300 }, { id: 'totalFloorArea', label: '연면적 (㎡)', type: 'number', default: 1500 }], faqs: [
      { q: '건폐율/용적률 결과는 실제와 같나요?', a: '참고용이며, 지역·물건 특성에 따라 차이가 있을 수 있습니다. 건축법 제55조, 제56조를 기준으로 계산합니다.' },
      { q: '부동산 거래 시 꼭 확인할 것은?', a: '등기부등본, 건축물대장, 토지이용계획확인서를 반드시 확인하세요.' },
      { q: '건폐율/용적률는 무료인가요?', a: '네, 카더라 건폐율/용적률는 완전 무료이며 회원가입 없이 무제한 이용 가능합니다.' },
      { q: '건폐율/용적률는 모바일에서도 되나요?', a: '네, 모든 기기에서 최적화되어 있습니다.' },
      { q: '관련 계산기가 더 있나요?', a: '카더라는 부동산 포함 142종의 무료 계산기를 제공합니다.' },
    ], seoContent: '<h2>건폐율/용적률 계산기 완벽 가이드</h2><p>대지면적·건축면적·연면적으로 건폐율과 용적률을 계산. 카더라 건폐율/용적률는 2026년 최신 기준을 반영합니다.</p><p>본 계산기는 <strong>건축법 제55조, 제56조</strong>를 기준으로 계산합니다. 규정은 매년 개정될 수 있으므로 전문가 확인을 권장합니다.</p><h2>부동산 거래 핵심 정보</h2><p>부동산 거래 시 중개수수료(0.4~0.9%), 등기비용, 취득세, 대출이자 등 다양한 비용이 발생합니다. 사전에 총 비용을 정확히 계산하면 예상치 못한 지출을 방지할 수 있습니다. 등기부등본·건축물대장·토지이용계획확인서는 반드시 확인하세요.</p><h2>이런 분들에게 추천</h2><p>주택 매매·전세·월세를 계획 중인 분, 부동산 투자 수익률을 분석하고 싶은 분, 대출 가능 금액을 확인하고 싶은 분에게 유용합니다.</p>', relatedCalcs: ['pyeong-sqm'] },
  ...
  { slug: 'drip-sim', emoji: '💹', category: 'investment', categoryLabel: '주식/투자', title: '배당 재투자(DRIP) 시뮬레이터', titleShort: 'DRIP 시뮬레이터', description: '배당금을 재투자할 때 장기 복리 효과를 시뮬레이션.', keywords: ['DRIP','배당 재투자','배당 복리','배당 성장'], legalBasis: '', version: '2026.04', lastUpdated: '2026-04-05', pattern: 'amortize', formula: 'dripSim', resultLabel: '최종 자산', resultUnit: '원', inputs: [{ id: 'investment', label: '초기 투자금', type: 'currency', default: 50000000 }, { id: 'yieldRate', label: '배당수익률 (%)', type: 'percent', default: 4 }, { id: 'growthRate', label: '배당성장률 (%)', type: 'percent', default: 5 }, { id: 'years', label: '투자 기간 (년)', type: 'range', default: 20, min: 1, max: 40 }], faqs: [
      { q: 'DRIP 시뮬레이터에서 세금은 반영되나요?', a: '국내 주식 증권거래세(매도 시 부과 — 세율은 시장별로 다르다)와 수수료를 반영합니다. 해외주식은 양도세(22%, 250만원 공제) 별도입니다.' },
      { q: '투자 수익 과세 기준은?', a: '국내 상장주식은 대주주만 양도세, 해외주식은 250만원 초과 시 22%, 배당은 15.4% 원천징수입니다.' },
      { q: 'DRIP 시뮬레이터는 무료인가요?', a: '네, 카더라 DRIP 시뮬레이터는 무료이며 회원가입 없이 무제한 이용 가능합니다.' },
      { q: 'DRIP 시뮬레이터는 모바일에서도 되나요?', a: '네, 모든 기기에서 최적화되어 있습니다.' },
      { q: '관련 계산기가 더 있나요?', a: '카더라는 주식/투자 포함 142종의 무료 계산기를 제공합니다.' },
    ], seoContent: '<h2>배당 재투자(DRIP) 시뮬레이터 완벽 가이드</h2><p>배당금을 재투자할 때 장기 복리 효과를 시뮬레이션. 카더라 DRIP 시뮬레이터는 수수료, 세금을 반영한 실질 수익을 계산합니다.</p><h2>투자 핵심 정보</h2><p>투자 수익에는 증권거래세(매도 시 부과 — 세율은 시장별로 다르다), 수수료, 배당소득세(15.4%), 해외주식 양도세(22%, 250만원 공제) 등이 적용됩니다. 72법칙(72÷수익률=원금2배 년수)으로 복리 효과를 빠르게 파악할 수 있습니다. 장기 적립식 투자와 배당 재투자가 자산 증식의 핵심입니다.</p><h2>이런 분들에게 추천</h2><p>주식·펀드·ETF 투자자, 배당 투자 계획 중인 분, 투자 성과를 정확히 측정하고 싶은 분에게 유용합니다. 투자에는 원금 손실 위험이 있으며, 본 계산기는 참고용입니다.</p>', relatedCalcs: ['dividend-calc', 'compound-interest'] },
  ...
  { slug: 'short-selling', emoji: '📉', category: 'investment', categoryLabel: '주식/투자', title: '공매도 수익 계산기', titleShort: '공매도 계산기', description: '공매도 시 대차료·수수료 포함 순수익을 계산.', keywords: ['공매도 수익','공매도 계산','대차료','숏셀링'], legalBasis: '증권거래세법 · 농어촌특별세법', version: '2026.09', lastUpdated: '2026-09-17', pattern: 'simple', formula: 'shortSelling', resultLabel: '공매도 순수익', resultUnit: '원', inputs: [{ id: 'market', label: '시장', type: 'radio', default: 'kospi', options: [{ value: 'kospi', label: '코스피' }, { value: 'kosdaq', label: '코스닥' }] }, { id: 'sellPrice', label: '매도가', type: 'currency', default: 100000 }, { id: 'buyPrice', label: '환매가', type: 'currency', default: 80000 }, { id: 'quantity', label: '수량', type: 'number', default: 100 }, { id: 'borrowFee', label: '대차료율 (%/년)', type: 'percent', default: 3, hint: '종목·수급에 따라 달라진다 — 대여 약정 요율을 넣는다' }, { id: 'days', label: '보유일수', type: 'number', default: 30 }, { id: 'fee', label: '위탁수수료율 (%)', type: 'percent', default: 0.015, step: 0.001, hint: '증권사·매체별로 다르다. 기본값은 예시값' }], faqs: [
      { q: '공매도 계산기에서 세금은 반영되나요?', a: '국내 주식 증권거래세(매도 시 부과 — 세율은 시장별로 다르다)와 수수료를 반영합니다. 해외주식은 양도세(22%, 250만원 공제) 별도입니다.' },
      { q: '투자 수익 과세 기준은?', a: '국내 상장주식은 대주주만 양도세, 해외주식은 250만원 초과 시 22%, 배당은 15.4% 원천징수입니다.' },
      { q: '공매도 계산기는 무료인가요?', a: '네, 카더라 공매도 계산기는 무료이며 회원가입 없이 무제한 이용 가능합니다.' },
      { q: '공매도 계산기는 모바일에서도 되나요?', a: '네, 모든 기기에서 최적화되어 있습니다.' },
      { q: '관련 계산기가 더 있나요?', a: '카더라는 주식/투자 포함 142종의 무료 계산기를 제공합니다.' },
    ], seoContent: '<h2>공매도 수익 계산기 완벽 가이드</h2><p>공매도 시 대차료·수수료 포함 순수익을 계산. 카더라 공매도 계산기는 수수료, 세금을 반영한 실질 수익을 계산합니다.</p><h2>투자 핵심 정보</h2><p>투자 수익에는 증권거래세(매도 시 부과 — 세율은 시장별로 다르다), 수수료, 배당소득세(15.4%), 해외주식 양도세(22%, 250만원 공제) 등이 적용됩니다. 72법칙(72÷수익률=원금2배 년수)으로 복리 효과를 빠르게 파악할 수 있습니다. 장기 적립식 투자와 배당 재투자가 자산 증식의 핵심입니다.</p><h2>이런 분들에게 추천</h2><p>주식·펀드·ETF 투자자, 배당 투자 계획 중인 분, 투자 성과를 정확히 측정하고 싶은 분에게 유용합니다. 투자에는 원금 손실 위험이 있으며, 본 계산기는 참고용입니다.</p>', relatedCalcs: ['stock-roi'] },
  { slug: 'rebalance-calc', emoji: '⚖️', category: 'investment', categoryLabel: '주식/투자', title: '포트폴리오 리밸런싱 계산기', titleShort: '리밸런싱 계산기', description: '목표 비중으로 포트폴리오를 리밸런싱할 때 매수/매도 금액을 계산.', keywords: ['리밸런싱','포트폴리오','자산배분','목표비중'], legalBasis: '', version: '2026.04', lastUpdated: '2026-04-05', pattern: 'simple', formula: 'rebalanceCalc', resultLabel: '조정 결과', resultUnit: '', inputs: [{ id: 'totalAsset', label: '총 자산', type: 'currency', default: 100000000 }, { id: 'stock', label: '주식 현재 비중 (%)', type: 'percent', default: 70 }, { id: 'stockTarget', label: '주식 목표 비중 (%)', type: 'percent', default: 60 }, { id: 'bond', label: '채권 현재 비중 (%)', type: 'percent', default: 20 }, { id: 'bondTarget', label: '채권 목표 비중 (%)', type: 'percent', default: 30 }], faqs: [
      { q: '리밸런싱 계산기에서 세금은 반영되나요?', a: '국내 주식 증권거래세(매도 시 부과 — 세율은 시장별로 다르다)와 수수료를 반영합니다. 해외주식은 양도세(22%, 250만원 공제) 별도입니다.' },
      { q: '투자 수익 과세 기준은?', a: '국내 상장주식은 대주주만 양도세, 해외주식은 250만원 초과 시 22%, 배당은 15.4% 원천징수입니다.' },
      { q: '리밸런싱 계산기는 무료인가요?', a: '네, 카더라 리밸런싱 계산기는 무료이며 회원가입 없이 무제한 이용 가능합니다.' },
      { q: '리밸런싱 계산기는 모바일에서도 되나요?', a: '네, 모든 기기에서 최적화되어 있습니다.' },
      { q: '관련 계산기가 더 있나요?', a: '카더라는 주식/투자 포함 142종의 무료 계산기를 제공합니다.' },
    ], seoContent: '<h2>포트폴리오 리밸런싱 계산기 완벽 가이드</h2><p>목표 비중으로 포트폴리오를 리밸런싱할 때 매수/매도 금액을 계산. 카더라 리밸런싱 계산기는 수수료, 세금을 반영한 실질 수익을 계산합니다.</p><h2>투자 핵심 정보</h2><p>투자 수익에는 증권거래세(매도 시 부과 — 세율은 시장별로 다르다), 수수료, 배당소득세(15.4%), 해외주식 양도세(22%, 250만원 공제) 등이 적용됩니다. 72법칙(72÷수익률=원금2배 년수)으로 복리 효과를 빠르게 파악할 수 있습니다. 장기 적립식 투자와 배당 재투자가 자산 증식의 핵심입니다.</p><h2>이런 분들에게 추천</h2><p>주식·펀드·ETF 투자자, 배당 투자 계획 중인 분, 투자 성과를 정확히 측정하고 싶은 분에게 유용합니다. 투자에는 원금 손실 위험이 있으며, 본 계산기는 참고용입니다.</p>', relatedCalcs: ['compound-interest', 'investment-type-test'] },
  ...
  { slug: 'severance-calc', emoji: '📑', category: 'salary', categoryLabel: '급여/노동', title: '해고예고수당 계산기', titleShort: '해고예고수당', description: '해고 시 지급해야 하는 해고예고수당(30일분)을 계산.', keywords: ['해고예고수당','해고 수당','30일분','통상임금'], legalBasis: '근로기준법 제26조', version: '2026.04', lastUpdated: '2026-04-05', pattern: 'simple', formula: 'severanceCalc', resultLabel: '해고예고수당', resultUnit: '원', inputs: [{ id: 'monthlySalary', label: '월 통상임금', type: 'currency', default: 3500000 }], faqs: [
      { q: '해고예고수당에서 4대보험은 어떻게 적용되나요?', a: '국민연금 4.5%, 건강보험 3.545%, 장기요양 0.45%, 고용보험 0.9% — 합계 약 9.4%가 공제됩니다.' },
      { q: '비과세 급여란?', a: '식대(월 20만원), 자가운전보조금(월 20만원), 출산보육수당(월 20만원) 등 소득세 면제 항목입니다.' },
      { q: '해고예고수당 결과가 실제와 다를 수 있나요?', a: '부양가족 수, 비과세 항목, 보험 상한 등에 따라 차이가 발생합니다. 근로기준법 제26조를 기준으로 계산합니다.' },
      { q: '해고예고수당는 모바일에서도 되나요?', a: '네, 모든 기기에서 최적화되어 있습니다.' },
      { q: '관련 계산기가 더 있나요?', a: '카더라는 급여/노동 포함 142종의 무료 계산기를 제공합니다.' },
    ], seoContent: '<h2>해고예고수당 계산기 완벽 가이드</h2><p>해고 시 지급해야 하는 해고예고수당(30일분)을 계산. 카더라 해고예고수당는 2026년 4대보험 요율과 근로소득 간이세액표를 반영합니다.</p><p>본 계산기는 <strong>근로기준법 제26조</strong>를 기준으로 계산합니다. 규정은 매년 개정될 수 있으므로 전문가 확인을 권장합니다.</p><h2>급여 핵심 정보</h2><p>직장인 세전 급여에서 국민연금(4.5%), 건강보험(3.545%), 장기요양(0.45%), 고용보험(0.9%) 합계 약 9.4%가 공제됩니다. 여기에 근로소득세와 지방소득세가 추가됩니다. 비과세 급여(식대 20만원, 자가운전보조금 20만원)를 활용하면 실수령액을 높일 수 있습니다.</p><h2>이런 분들에게 추천</h2><p>연봉 협상 중인 직장인, 첫 취업을 앞둔 구직자, 급여 명세서를 이해하고 싶은 분에게 유용합니다. 연말정산 환급을 극대화하려면 체크카드 사용 비율을 높이고, IRP/연금저축에 최대 납입하세요.</p>', relatedCalcs: ['retirement-pay', 'net-salary'] },
  { slug: 'minimum-wage', emoji: '💰', category: 'salary', categoryLabel: '급여/노동', title: '최저임금 계산기', titleShort: '최저임금 계산기', description: '2026년 최저임금 기준 월급·연봉을 계산.', keywords: ['최저임금','2026 최저임금','최저시급','최저월급'], legalBasis: '최저임금법', version: '2026.04', lastUpdated: '2026-04-05', pattern: 'simple', formula: 'minimumWage', resultLabel: '최저월급 (209시간)', resultUnit: '원', inputs: [{ id: 'weeklyHours', label: '주당 근로시간', type: 'number', default: 40 }, { id: 'includeHoliday', label: '주휴수당 포함', type: 'radio', default: 'yes', options: [{ value: 'yes', label: '포함' }, { value: 'no', label: '미포함' }] }], faqs: [
      { q: '최저임금 계산기에서 4대보험은 어떻게 적용되나요?', a: '국민연금 4.5%, 건강보험 3.545%, 장기요양 0.45%, 고용보험 0.9% — 합계 약 9.4%가 공제됩니다.' },
      { q: '비과세 급여란?', a: '식대(월 20만원), 자가운전보조금(월 20만원), 출산보육수당(월 20만원) 등 소득세 면제 항목입니다.' },
      { q: '최저임금 계산기 결과가 실제와 다를 수 있나요?', a: '부양가족 수, 비과세 항목, 보험 상한 등에 따라 차이가 발생합니다. 최저임금법를 기준으로 계산합니다.' },
      { q: '최저임금 계산기는 모바일에서도 되나요?', a: '네, 모든 기기에서 최적화되어 있습니다.' },
      { q: '관련 계산기가 더 있나요?', a: '카더라는 급여/노동 포함 142종의 무료 계산기를 제공합니다.' },
    ], seoContent: '<h2>최저임금 계산기 완벽 가이드</h2><p>2026년 최저임금 기준 월급·연봉을 계산. 카더라 최저임금 계산기는 2026년 4대보험 요율과 근로소득 간이세액표를 반영합니다.</p><p>본 계산기는 <strong>최저임금법</strong>를 기준으로 계산합니다. 규정은 매년 개정될 수 있으므로 전문가 확인을 권장합니다.</p><h2>급여 핵심 정보</h2><p>직장인 세전 급여에서 국민연금(4.5%), 건강보험(3.545%), 장기요양(0.45%), 고용보험(0.9%) 합계 약 9.4%가 공제됩니다. 여기에 근로소득세와 지방소득세가 추가됩니다. 비과세 급여(식대 20만원, 자가운전보조금 20만원)를 활용하면 실수령액을 높일 수 있습니다.</p><h2>이런 분들에게 추천</h2><p>연봉 협상 중인 직장인, 첫 취업을 앞둔 구직자, 급여 명세서를 이해하고 싶은 분에게 유용합니다. 연말정산 환급을 극대화하려면 체크카드 사용 비율을 높이고, IRP/연금저축에 최대 납입하세요.</p>', relatedCalcs: ['hourly-annual', 'net-salary'] },
  ...
  { slug: 'jeonse-loan', emoji: '🏠', category: 'loan', categoryLabel: '대출/예적금', title: '전세대출 이자 계산기', titleShort: '전세대출 이자', description: '전세자금대출의 월 이자를 계산.', keywords: ['전세대출','전세자금대출','전세대출 이자'], legalBasis: '', version: '2026.04', lastUpdated: '2026-04-05', pattern: 'simple', formula: 'jeonseLoan', resultLabel: '월 이자', resultUnit: '원', inputs: [{ id: 'loanAmount', label: '대출 금액', type: 'currency', default: 200000000 }, { id: 'rate', label: '금리 (%)', type: 'percent', default: 3.5, step: 0.1 }], faqs: [
      { q: '어떤 상환방식이 유리한가요?', a: '원금균등이 총 이자가 적지만 초기 부담이 큽니다. 원리금균등은 매월 동일 금액으로 예산 관리가 쉽습니다.' },
      { q: '변동금리와 고정금리 차이는?', a: '변동금리는 기준금리 따라 변하고, 고정금리는 계약 시 확정됩니다. 금리 상승기에는 고정이 유리합니다.' },
      { q: '전세대출 이자는 실제 대출과 차이가 있나요?', a: '참고용이며, 은행별 우대금리·수수료 등에 따라 차이가 있습니다.' },
      { q: '전세대출 이자는 모바일에서도 되나요?', a: '네, 모든 기기에서 최적화되어 있습니다.' },
      { q: '관련 계산기가 더 있나요?', a: '카더라는 대출/예적금 포함 142종의 무료 계산기를 제공합니다.' },
    ], seoContent: '<h2>전세대출 이자 계산기 완벽 가이드</h2><p>전세자금대출의 월 이자를 계산. 카더라 전세대출 이자는 원리금균등, 원금균등, 만기일시 상환 방식을 비교합니다.</p><h2>대출 핵심 정보</h2><p>금리 1%p 차이로 30년간 수천만원의 이자 차이가 발생합니다. 원금균등은 총 이자가 적지만 초기 부담이 크고, 원리금균등은 매월 동일 금액으로 예산 관리가 쉽습니다. DSR 40% 규제를 확인하고, 중도상환수수료 면제 시점(보통 3년)을 파악하세요.</p><h2>이런 분들에게 추천</h2><p>주택담보대출, 전세대출, 자동차 대출을 비교하는 분, 대환을 고려하는 분에게 유용합니다. 여유자금으로 원금을 줄이면 총 이자를 크게 절약할 수 있습니다.</p>', relatedCalcs: ['loan-repayment', 'jeonse-vs-wolse'] },
  { slug: 'refinance-compare', emoji: '🔄', category: 'loan', categoryLabel: '대출/예적금', title: '대출 대환 비교기', titleShort: '대환 비교기', description: '기존 대출을 새 대출로 갈아탈 때 이자 절감액을 비교.', keywords: ['대환','대출 갈아타기','금리 비교','이자 절감'], legalBasis: '', version: '2026.04', lastUpdated: '2026-04-05', pattern: 'compare', formula: 'refinanceCompare', resultLabel: '연간 이자 절감', resultUnit: '원', inputs: [{ id: 'balance', label: '잔여 원금', type: 'currency', default: 200000000 }, { id: 'currentRate', label: '현재 금리 (%)', type: 'percent', default: 5.5, step: 0.1 }, { id: 'newRate', label: '새 금리 (%)', type: 'percent', default: 4.0, step: 0.1 }, { id: 'refinanceFee', label: '대환 수수료', type: 'currency', default: 500000 }], faqs: [
      ...
      { q: '관련 계산기가 더 있나요?', a: '카더라는 대출/예적금 포함 142종의 무료 계산기를 제공합니다.' },
    ], seoContent: '<h2>대출 대환 비교기 완벽 가이드</h2><p>기존 대출을 새 대출로 갈아탈 때 이자 절감액을 비교. 카더라 대환 비교기는 원리금균등, 원금균등, 만기일시 상환 방식을 비교합니다.</p><h2>대출 핵심 정보</h2><p>금리 1%p 차이로 30년간 수천만원의 이자 차이가 발생합니다. 원금균등은 총 이자가 적지만 초기 부담이 크고, 원리금균등은 매월 동일 금액으로 예산 관리가 쉽습니다. DSR 40% 규제를 확인하고, 중도상환수수료 면제 시점(보통 3년)을 파악하세요.</p><h2>이런 분들에게 추천</h2><p>주택담보대출, 전세대출, 자동차 대출을 비교하는 분, 대환을 고려하는 분에게 유용합니다. 여유자금으로 원금을 줄이면 총 이자를 크게 절약할 수 있습니다.</p>', relatedCalcs: ['loan-repayment', 'prepayment-fee'] },
  ...
  { slug: 'credit-loan-est', emoji: '💳', category: 'loan', categoryLabel: '대출/예적금', title: '신용대출 한도 추정기', titleShort: '신용대출 한도', description: '연소득·신용등급으로 신용대출 가능 한도를 추정.', keywords: ['신용대출 한도','대출 가능 금액','신용등급'], legalBasis: '', version: '2026.04', lastUpdated: '2026-04-05', pattern: 'simple', formula: 'creditLoanEst', resultLabel: '추정 한도', resultUnit: '원', inputs: [{ id: 'annualIncome', label: '연소득', type: 'currency', default: 50000000 }, { id: 'creditGrade', label: '신용등급', type: 'select', default: '3', options: [{ value: '1', label: '1등급 (최우량)' }, { value: '3', label: '3등급 (우량)' }, { value: '5', label: '5등급 (보통)' }, { value: '7', label: '7등급 (주의)' }] }], faqs: [
      { q: '어떤 상환방식이 유리한가요?', a: '원금균등이 총 이자가 적지만 초기 부담이 큽니다. 원리금균등은 매월 동일 금액으로 예산 관리가 쉽습니다.' },
      { q: '변동금리와 고정금리 차이는?', a: '변동금리는 기준금리 따라 변하고, 고정금리는 계약 시 확정됩니다. 금리 상승기에는 고정이 유리합니다.' },
      { q: '신용대출 한도는 실제 대출과 차이가 있나요?', a: '참고용이며, 은행별 우대금리·수수료 등에 따라 차이가 있습니다.' },
      { q: '신용대출 한도는 모바일에서도 되나요?', a: '네, 모든 기기에서 최적화되어 있습니다.' },
      { q: '관련 계산기가 더 있나요?', a: '카더라는 대출/예적금 포함 142종의 무료 계산기를 제공합니다.' },
    ], seoContent: '<h2>신용대출 한도 추정기 완벽 가이드</h2><p>연소득·신용등급으로 신용대출 가능 한도를 추정. 카더라 신용대출 한도는 원리금균등, 원금균등, 만기일시 상환 방식을 비교합니다.</p><h2>대출 핵심 정보</h2><p>금리 1%p 차이로 30년간 수천만원의 이자 차이가 발생합니다. 원금균등은 총 이자가 적지만 초기 부담이 크고, 원리금균등은 매월 동일 금액으로 예산 관리가 쉽습니다. DSR 40% 규제를 확인하고, 중도상환수수료 면제 시점(보통 3년)을 파악하세요.</p><h2>이런 분들에게 추천</h2><p>주택담보대출, 전세대출, 자동차 대출을 비교하는 분, 대환을 고려하는 분에게 유용합니다. 여유자금으로 원금을 줄이면 총 이자를 크게 절약할 수 있습니다.</p>', relatedCalcs: ['loan-repayment', 'dsr-calc'] },
  // 연금 +3
  { slug: 'retirement-expense', emoji: '🧓', category: 'pension', categoryLabel: '연금/은퇴', title: '노후 생활비 추정기', titleShort: '노후 생활비 계산기', description: '은퇴 후 필요한 월 생활비와 총 필요자금을 추정.', keywords: ['노후 생활비','은퇴 자금','노후 준비','생활비 계산'], legalBasis: '', version: '2026.04', lastUpdated: '2026-04-05', pattern: 'simple', formula: 'retirementExpense', resultLabel: '총 필요자금', resultUnit: '원', inputs: [{ id: 'monthlyExpense', label: '은퇴 후 월 생활비', type: 'currency', default: 3000000 }, { id: 'retireAge', label: '은퇴 나이', type: 'number', default: 60 }, { id: 'lifeExpectancy', label: '기대 수명', type: 'number', default: 85 }, { id: 'inflation', label: '물가상승률 (%)', type: 'percent', default: 3 }], faqs: [
      { q: '노후 생활비 계산기 결과는 정확한가요?', a: '2026년 최신 기준 반영이지만, 개인 상황에 따라 차이가 있습니다. 전문가 상담을 권장합니다.' },
      ...
      { q: '관련 계산기가 더 있나요?', a: '카더라는 연금/은퇴 포함 142종의 무료 계산기를 제공합니다.' },
    ], seoContent: '<h2>노후 생활비 추정기 완벽 가이드</h2><p>은퇴 후 필요한 월 생활비와 총 필요자금을 추정. 카더라 노후 생활비 계산기는 2026년 최신 기준을 반영하여 정확한 결과를 제공합니다.</p><h2>연금/은퇴 핵심 정보</h2><p>국민연금 수령액은 가입기간과 소득에 따라 달라집니다. 퇴직연금(DB/DC), 개인연금(IRP, 연금저축)을 합산하면 안정적인 노후 소득을 설계할 수 있습니다. FIRE 운동의 핵심은 저축률(50%+)과 투자 수익률입니다.</p><h2>이런 분들에게 추천</h2><p>정확한 연금/은퇴 계산이 필요한 분에게 유용합니다. 카더라는 연금/은퇴 포함 142종의 무료 계산기를 제공하며, 계산 결과를 카카오톡으로 공유할 수 있습니다. 본 계산기는 참고용이며 전문가 상담을 권장합니다.</p>', relatedCalcs: ['fire-calc', 'national-pension'] },
  ...
  { slug: 'pension-vs-lump', emoji: '🔀', category: 'pension', categoryLabel: '연금/은퇴', title: '연금 vs 일시금 비교기', titleShort: '연금vs일시금', description: '퇴직금을 연금으로 받을 때 vs 일시금으로 받을 때 총 수령액 비교.', keywords: ['연금 일시금 비교','퇴직금 수령','연금 수령','일시금'], legalBasis: '소득세법 제22조', version: '2026.04', lastUpdated: '2026-04-05', pattern: 'compare', formula: 'pensionVsLump', resultLabel: '비교 결과', resultUnit: '', inputs: [{ id: 'totalAmount', label: '퇴직금', type: 'currency', default: 200000000 }, { id: 'pensionYears', label: '연금 수령 기간 (년)', type: 'range', default: 15, min: 5, max: 30 }, { id: 'investReturn', label: '연금 운용 수익률 (%)', type: 'percent', default: 4 }], faqs: [
      { q: '연금vs일시금 결과는 정확한가요?', a: '2026년 최신 기준 반영이지만, 개인 상황에 따라 차이가 있습니다. 소득세법 제22조를 기준으로 계산합니다. 전문가 상담을 권장합니다.' },
      ...
      { q: '관련 계산기가 더 있나요?', a: '카더라는 연금/은퇴 포함 142종의 무료 계산기를 제공합니다.' },
    ], seoContent: '<h2>연금 vs 일시금 비교기 완벽 가이드</h2><p>퇴직금을 연금으로 받을 때 vs 일시금으로 받을 때 총 수령액 비교. 카더라 연금vs일시금는 2026년 최신 기준을 반영하여 정확한 결과를 제공합니다.</p><p>본 계산기는 <strong>소득세법 제22조</strong>를 기준으로 계산합니다. 규정은 매년 개정될 수 있으므로 전문가 확인을 권장합니다.</p><h2>연금/은퇴 핵심 정보</h2><p>국민연금 수령액은 가입기간과 소득에 따라 달라집니다. 퇴직연금(DB/DC), 개인연금(IRP, 연금저축)을 합산하면 안정적인 노후 소득을 설계할 수 있습니다. FIRE 운동의 핵심은 저축률(50%+)과 투자 수익률입니다.</p><h2>이런 분들에게 추천</h2><p>정확한 연금/은퇴 계산이 필요한 분에게 유용합니다. 카더라는 연금/은퇴 포함 142종의 무료 계산기를 제공하며, 계산 결과를 카카오톡으로 공유할 수 있습니다. 본 계산기는 참고용이며 전문가 상담을 권장합니다.</p>', relatedCalcs: ['retirement-pension-sim', 'irp-deduction'] },
  { slug: 'isa-conversion', emoji: '🔄', category: 'pension', categoryLabel: '연금/은퇴', title: 'ISA 만기 전환 시뮬레이터', titleShort: 'ISA 전환 시뮬', description: 'ISA 만기 후 IRP 전환 시 추가 세액공제 효과를 시뮬레이션.', keywords: ['ISA 전환','ISA IRP','ISA 만기','추가 세액공제'], legalBasis: '조세특례제한법 제91조의18', version: '2026.04', lastUpdated: '2026-04-05', pattern: 'simple', formula: 'isaConversion', resultLabel: '추가 세액공제', resultUnit: '원', inputs: [{ id: 'isaBalance', label: 'ISA 만기 잔액', type: 'currency', default: 20000000 }, { id: 'transferAmount', label: 'IRP 전환 금액', type: 'currency', default: 20000000 }], faqs: [
      { q: 'ISA 전환 시뮬 결과는 정확한가요?', a: '2026년 최신 기준 반영이지만, 개인 상황에 따라 차이가 있습니다. 조세특례제한법 제91조의18를 기준으로 계산합니다. 전문가 상담을 권장합니다.' },
      ...
      { q: '관련 계산기가 더 있나요?', a: '카더라는 연금/은퇴 포함 142종의 무료 계산기를 제공합니다.' },
    ], seoContent: '<h2>ISA 만기 전환 시뮬레이터 완벽 가이드</h2><p>ISA 만기 후 IRP 전환 시 추가 세액공제 효과를 시뮬레이션. 카더라 ISA 전환 시뮬는 2026년 최신 기준을 반영하여 정확한 결과를 제공합니다.</p><p>본 계산기는 <strong>조세특례제한법 제91조의18</strong>를 기준으로 계산합니다. 규정은 매년 개정될 수 있으므로 전문가 확인을 권장합니다.</p><h2>연금/은퇴 핵심 정보</h2><p>국민연금 수령액은 가입기간과 소득에 따라 달라집니다. 퇴직연금(DB/DC), 개인연금(IRP, 연금저축)을 합산하면 안정적인 노후 소득을 설계할 수 있습니다. FIRE 운동의 핵심은 저축률(50%+)과 투자 수익률입니다.</p><h2>이런 분들에게 추천</h2><p>정확한 연금/은퇴 계산이 필요한 분에게 유용합니다. 카더라는 연금/은퇴 포함 142종의 무료 계산기를 제공하며, 계산 결과를 카카오톡으로 공유할 수 있습니다. 본 계산기는 참고용이며 전문가 상담을 권장합니다.</p>', relatedCalcs: ['irp-deduction', 'isa-tax-free'] },
  ...
  { slug: 'car-insurance-est', emoji: '🛡️', category: 'auto', categoryLabel: '자동차', title: '자동차 보험료 추정기', titleShort: '자동차 보험료', description: '차량·운전자 정보로 자동차 보험료를 «예시로» 추정. 실제 보험료는 보험사 견적이 정본.', keywords: ['자동차 보험료','차량 보험','보험료 추정','자동차보험'], legalBasis: '', version: '2026.09', lastUpdated: '2026-09-17', pattern: 'simple', formula: 'carInsuranceEst', resultLabel: '추정 보험료 (예시)', resultUnit: '원', inputs: [{ id: 'carAge', label: '차량 연식 (년)', type: 'number', default: 3 }, { id: 'driverAge', label: '운전자 나이', type: 'number', default: 35 }, { id: 'carPrice', label: '차량 가격', type: 'currency', default: 30000000 }, { id: 'accidentFree', label: '무사고 기간 (년)', type: 'number', default: 3 }], faqs: [
      { q: '자동차 보험료 결과는 정확한가요?', a: '2026년 최신 기준 반영이지만, 개인 상황에 따라 차이가 있습니다. 전문가 상담을 권장합니다.' },
      ...
      { q: '관련 계산기가 더 있나요?', a: '카더라는 자동차 포함 142종의 무료 계산기를 제공합니다.' },
    ], seoContent: '<h2>자동차 보험료 추정기 완벽 가이드</h2><p>차량·운전자 정보로 자동차 보험료를 추정. 카더라 자동차 보험료는 2026년 최신 기준을 반영하여 정확한 결과를 제공합니다.</p><h2>자동차 핵심 정보</h2><p>자동차 취득 시 취등록세, 보유 시 자동차세, 운행 시 유류비·보험료가 발생합니다. 전기차는 유류비가 1/3 수준이지만 충전 인프라와 배터리 교체 비용을 고려하세요.</p><h2>이런 분들에게 추천</h2><p>정확한 자동차 계산이 필요한 분에게 유용합니다. 카더라는 자동차 포함 142종의 무료 계산기를 제공하며, 계산 결과를 카카오톡으로 공유할 수 있습니다. 본 계산기는 참고용이며 전문가 상담을 권장합니다.</p>', relatedCalcs: ['vehicle-tax', 'fuel-cost'] },
  { slug: 'fuel-saving', emoji: '⛽', category: 'auto', categoryLabel: '자동차', title: '유류비 절감 비교기', titleShort: '유류비 절감 비교', description: '두 차량의 연비를 비교하여 연간 유류비 절감액을 계산.', keywords: ['유류비 절감','연비 비교','하이브리드 절감','경유 휘발유'], legalBasis: '', version: '2026.04', lastUpdated: '2026-04-05', pattern: 'compare', formula: 'fuelSaving', resultLabel: '연간 절감액', resultUnit: '원', inputs: [{ id: 'distance', label: '연간 주행거리 (km)', type: 'number', default: 15000 }, { id: 'eff1', label: '차량A 연비 (km/L)', type: 'number', default: 10, step: 0.1 }, { id: 'eff2', label: '차량B 연비 (km/L)', type: 'number', default: 18, step: 0.1 }, { id: 'fuelPrice', label: '유가 (원/L)', type: 'currency', default: 1700 }], faqs: [
      { q: '유류비 절감 비교 결과는 정확한가요?', a: '2026년 최신 기준 반영이지만, 개인 상황에 따라 차이가 있습니다. 전문가 상담을 권장합니다.' },
      ...
      { q: '관련 계산기가 더 있나요?', a: '카더라는 자동차 포함 142종의 무료 계산기를 제공합니다.' },
    ], seoContent: '<h2>유류비 절감 비교기 완벽 가이드</h2><p>두 차량의 연비를 비교하여 연간 유류비 절감액을 계산. 카더라 유류비 절감 비교는 2026년 최신 기준을 반영하여 정확한 결과를 제공합니다.</p><h2>자동차 핵심 정보</h2><p>자동차 취득 시 취등록세, 보유 시 자동차세, 운행 시 유류비·보험료가 발생합니다. 전기차는 유류비가 1/3 수준이지만 충전 인프라와 배터리 교체 비용을 고려하세요.</p><h2>이런 분들에게 추천</h2><p>정확한 자동차 계산이 필요한 분에게 유용합니다. 카더라는 자동차 포함 142종의 무료 계산기를 제공하며, 계산 결과를 카카오톡으로 공유할 수 있습니다. 본 계산기는 참고용이며 전문가 상담을 권장합니다.</p>', relatedCalcs: ['fuel-cost', 'ev-charge-cost'] },
  ...
  { slug: 'inflation-calc', emoji: '📈', category: 'life', categoryLabel: '생활/건강', title: '인플레이션 구매력 계산기', titleShort: '구매력 계산기', description: '과거/현재 금액의 실질 구매력을 물가상승률로 환산.', keywords: ['인플레이션 계산기','구매력','물가상승률','실질가치'], legalBasis: '', version: '2026.04', lastUpdated: '2026-04-05', pattern: 'simple', formula: 'inflationCalc', resultLabel: '실질 가치', resultUnit: '원', inputs: [{ id: 'amount', label: '금액', type: 'currency', default: 10000000 }, { id: 'years', label: '기간 (년)', type: 'range', default: 10, min: 1, max: 50 }, { id: 'inflationRate', label: '연 물가상승률 (%)', type: 'percent', default: 3 }], faqs: [
      { q: '구매력 계산기 결과는 의학적으로 정확한가요?', a: '일반적인 공식 기반 참고 수치입니다. 정확한 건강 판단은 의료 전문가와 상담하세요.' },
      { q: '구매력 계산기는 남녀 기준이 다른가요?', a: '대부분의 건강 지표는 성별에 따라 다른 기준을 적용합니다. 성별 선택 시 자동 반영됩니다.' },
      { q: '구매력 계산기는 무료인가요?', a: '네, 카더라 구매력 계산기는 완전 무료이며 회원가입 없이 이용 가능합니다.' },
      { q: '구매력 계산기는 모바일에서도 되나요?', a: '네, 모든 기기에서 최적화되어 있으며 앱 설치 없이 사용 가능합니다.' },
      { q: '관련 계산기가 더 있나요?', a: '카더라는 생활/건강 포함 142종의 무료 계산기를 제공합니다.' },
    ], seoContent: '<h2>인플레이션 구매력 계산기 완벽 가이드</h2><p>과거/현재 금액의 실질 구매력을 물가상승률로 환산. 카더라 구매력 계산기는 과학적 공식과 최신 기준을 반영합니다.</p><h2>건강·생활 핵심 정보</h2><p>BMI(18.5~22.9 정상), 체지방률, 기초대사량 등 건강 지표는 종합적으로 판단해야 합니다. 대한비만학회 기준은 WHO보다 엄격하여 BMI 23부터 과체중으로 분류합니다. 정확한 건강 평가는 의료 전문가와 상담하시기 바랍니다.</p><h2>이런 분들에게 추천</h2><p>체중 관리, 건강 관리를 계획 중인 분, 출산·육아를 준비하는 분, 일상의 궁금한 계산이 필요한 분에게 유용합니다. 정기적으로 계산하여 변화 추이를 기록하면 효과적입니다.</p>', relatedCalcs: ['compound-interest', 'fire-calc'] },
  // 법률 +4
  ...
  { slug: 'property-division', emoji: '⚖️', category: 'law', categoryLabel: '법률/가정', title: '이혼 재산분할 계산기', titleShort: '재산분할 계산기', description: '이혼 시 재산분할 비율과 금액을 추정.', keywords: ['재산분할','이혼 재산','분할 비율'], legalBasis: '민법 제839조의2', version: '2026.04', lastUpdated: '2026-04-05', pattern: 'simple', formula: 'propertyDivision', resultLabel: '분할 금액', resultUnit: '원', inputs: [{ id: 'totalAssets', label: '부부 공동재산', type: 'currency', default: 500000000 }, { id: 'ratio', label: '분할 비율 (%)', type: 'percent', default: 50 }], faqs: [
      { q: '재산분할 계산기 결과는 정확한가요?', a: '2026년 최신 기준 반영이지만, 개인 상황에 따라 차이가 있습니다. 민법 제839조의2를 기준으로 계산합니다. 전문가 상담을 권장합니다.' },
      ...
      { q: '관련 계산기가 더 있나요?', a: '카더라는 법률/가정 포함 142종의 무료 계산기를 제공합니다.' },
    ], seoContent: '<h2>이혼 재산분할 계산기 완벽 가이드</h2><p>이혼 시 재산분할 비율과 금액을 추정. 카더라 재산분할 계산기는 2026년 최신 기준을 반영하여 정확한 결과를 제공합니다.</p><p>본 계산기는 <strong>민법 제839조의2</strong>를 기준으로 계산합니다. 규정은 매년 개정될 수 있으므로 전문가 확인을 권장합니다.</p><h2>법률/가정 핵심 정보</h2><p>양육비는 산정기준표에 따라 양육자 소득·자녀 나이를 기준으로 결정됩니다. 위자료, 재산분할 비율은 혼인 기간, 유책 사유에 따라 달라집니다. 정확한 금액은 변호사 상담을 권장합니다.</p><h2>이런 분들에게 추천</h2><p>정확한 법률/가정 계산이 필요한 분에게 유용합니다. 카더라는 법률/가정 포함 142종의 무료 계산기를 제공하며, 계산 결과를 카카오톡으로 공유할 수 있습니다. 본 계산기는 참고용이며 전문가 상담을 권장합니다.</p>', relatedCalcs: ['consolation-money', 'child-support'] },
  ...
  { slug: 'industrial-accident', emoji: '🏗️', category: 'law', categoryLabel: '법률/가정', title: '산재 보상금 계산기', titleShort: '산재 보상금', description: '산업재해 시 휴업급여·장해급여를 추정.', keywords: ['산재 보상','산업재해','휴업급여','장해급여'], legalBasis: '산업재해보상보험법', version: '2026.04', lastUpdated: '2026-04-05', pattern: 'simple', formula: 'industrialAccident', resultLabel: '보상금 추정', resultUnit: '원', inputs: [{ id: 'dailyWage', label: '평균임금 (일당)', type: 'currency', default: 150000 }, { id: 'restDays', label: '휴업일수', type: 'number', default: 60 }, { id: 'disabilityGrade', label: '장해 등급', type: 'select', default: '0', options: [{ value: '0', label: '장해 없음' }, { value: '14', label: '14급' }, { value: '12', label: '12급' }, { value: '10', label: '10급' }, { value: '7', label: '7급' }, { value: '4', label: '4급' }, { value: '1', label: '1급' }] }], faqs: [
      { q: '산재 보상금 결과는 정확한가요?', a: '2026년 최신 기준 반영이지만, 개인 상황에 따라 차이가 있습니다. 산업재해보상보험법를 기준으로 계산합니다. 전문가 상담을 권장합니다.' },
      ...
      { q: '관련 계산기가 더 있나요?', a: '카더라는 법률/가정 포함 142종의 무료 계산기를 제공합니다.' },
    ], seoContent: '<h2>산재 보상금 계산기 완벽 가이드</h2><p>산업재해 시 휴업급여·장해급여를 추정. 카더라 산재 보상금는 2026년 최신 기준을 반영하여 정확한 결과를 제공합니다.</p><p>본 계산기는 <strong>산업재해보상보험법</strong>를 기준으로 계산합니다. 규정은 매년 개정될 수 있으므로 전문가 확인을 권장합니다.</p><h2>법률/가정 핵심 정보</h2><p>양육비는 산정기준표에 따라 양육자 소득·자녀 나이를 기준으로 결정됩니다. 위자료, 재산분할 비율은 혼인 기간, 유책 사유에 따라 달라집니다. 정확한 금액은 변호사 상담을 권장합니다.</p><h2>이런 분들에게 추천</h2><p>정확한 법률/가정 계산이 필요한 분에게 유용합니다. 카더라는 법률/가정 포함 142종의 무료 계산기를 제공하며, 계산 결과를 카카오톡으로 공유할 수 있습니다. 본 계산기는 참고용이며 전문가 상담을 권장합니다.</p>', relatedCalcs: ['accident-compensation'] },
  // 군대/교육 +2
  { slug: 'tuition-loan', emoji: '🎓', category: 'military', categoryLabel: '군대/교육', title: '대학 등록금 대출 계산기', titleShort: '등록금 대출', description: '학기별 등록금 대출 시 총 상환액을 계산.', keywords: ['등록금 대출','학자금','대학 등록금','학비 대출'], legalBasis: '', version: '2026.04', lastUpdated: '2026-04-05', pattern: 'amortize', formula: 'loanRepayment', resultLabel: '월 상환액', resultUnit: '원', inputs: [{ id: 'principal', label: '총 대출금', type: 'currency', default: 16000000 }, { id: 'rate', label: '이자율 (%)', type: 'percent', default: 1.7 }, { id: 'years', label: '상환 기간 (년)', type: 'range', default: 10, min: 1, max: 20 }, { id: 'method', label: '상환 방식', type: 'radio', default: 'equal', options: [{ value: 'equal', label: '원리금균등' }, { value: 'principal', label: '원금균등' }] }, { id: 'grace', label: '거치기간 (개월)', type: 'number', default: 0 }], faqs: [
      { q: '등록금 대출 결과는 정확한가요?', a: '2026년 최신 기준 반영이지만, 개인 상황에 따라 차이가 있습니다. 전문가 상담을 권장합니다.' },
      ...
      { q: '관련 계산기가 더 있나요?', a: '카더라는 군대/교육 포함 142종의 무료 계산기를 제공합니다.' },
    ], seoContent: '<h2>대학 등록금 대출 계산기 완벽 가이드</h2><p>학기별 등록금 대출 시 총 상환액을 계산. 카더라 등록금 대출는 2026년 최신 기준을 반영하여 정확한 결과를 제공합니다.</p><h2>군대/교육 핵심 정보</h2><p>2026년 병사 월급: 이병 67만원, 일병 78만원, 상병 97만원, 병장 125만원. 군 복무 중 학자금 대출 이자 지원, 전역 후 복학 시 등록금 감면 등 혜택을 확인하세요.</p><h2>이런 분들에게 추천</h2><p>정확한 군대/교육 계산이 필요한 분에게 유용합니다. 카더라는 군대/교육 포함 142종의 무료 계산기를 제공하며, 계산 결과를 카카오톡으로 공유할 수 있습니다. 본 계산기는 참고용이며 전문가 상담을 권장합니다.</p>', relatedCalcs: ['student-loan'] },
  ...
  { slug: 'csat-grade', emoji: '📝', category: 'military', categoryLabel: '군대/교육', title: '수능 등급컷 계산기', titleShort: '수능 등급 계산기', description: '원점수로 수능 예상 등급을 확인.', keywords: ['수능 등급컷','수능 등급','원점수','등급 환산'], legalBasis: '', version: '2026.04', lastUpdated: '2026-04-05', pattern: 'simple', formula: 'csatGrade', resultLabel: '예상 등급', resultUnit: '등급', inputs: [{ id: 'score', label: '원점수', type: 'number', default: 85, min: 0, max: 100 }, { id: 'subject', label: '과목', type: 'select', default: 'korean', options: [{ value: 'korean', label: '국어' }, { value: 'math', label: '수학' }, { value: 'english', label: '영어' }] }], faqs: [
      { q: '수능 등급 계산기 결과는 정확한가요?', a: '2026년 최신 기준 반영이지만, 개인 상황에 따라 차이가 있습니다. 전문가 상담을 권장합니다.' },
      ...
      { q: '관련 계산기가 더 있나요?', a: '카더라는 군대/교육 포함 142종의 무료 계산기를 제공합니다.' },
    ], seoContent: '<h2>수능 등급컷 계산기 완벽 가이드</h2><p>원점수로 수능 예상 등급을 확인. 카더라 수능 등급 계산기는 2026년 최신 기준을 반영하여 정확한 결과를 제공합니다.</p><h2>군대/교육 핵심 정보</h2><p>2026년 병사 월급: 이병 67만원, 일병 78만원, 상병 97만원, 병장 125만원. 군 복무 중 학자금 대출 이자 지원, 전역 후 복학 시 등록금 감면 등 혜택을 확인하세요.</p><h2>이런 분들에게 추천</h2><p>정확한 군대/교육 계산이 필요한 분에게 유용합니다. 카더라는 군대/교육 포함 142종의 무료 계산기를 제공하며, 계산 결과를 카카오톡으로 공유할 수 있습니다. 본 계산기는 참고용이며 전문가 상담을 권장합니다.</p>', relatedCalcs: ['gpa-convert'] },
  // 쇼핑 +1
  { slug: 'point-convert', emoji: '🎯', category: 'shopping', categoryLabel: '쇼핑/소비', title: '카드 포인트 환산기', titleShort: '포인트 환산기', description: '카드 포인트의 현금 가치를 환산.', keywords: ['카드 포인트','포인트 환산','적립 포인트','마일리지'], legalBasis: '', version: '2026.04', lastUpdated: '2026-04-05', pattern: 'simple', formula: 'pointConvert', resultLabel: '현금 가치', resultUnit: '원', inputs: [{ id: 'points', label: '포인트', type: 'number', default: 50000 }, { id: 'ratio', label: '1포인트 가치 (원)', type: 'number', default: 1, step: 0.1, min: 0.1, max: 100 }], faqs: [
      { q: '포인트 환산기 결과는 정확한가요?', a: '2026년 최신 기준 반영이지만, 개인 상황에 따라 차이가 있습니다. 전문가 상담을 권장합니다.' },
      ...
      { q: '관련 계산기가 더 있나요?', a: '카더라는 쇼핑/소비 포함 142종의 무료 계산기를 제공합니다.' },
    ], seoContent: '<h2>카드 포인트 환산기 완벽 가이드</h2><p>카드 포인트의 현금 가치를 환산. 카더라 포인트 환산기는 2026년 최신 기준을 반영하여 정확한 결과를 제공합니다.</p><h2>쇼핑/소비 핵심 정보</h2><p>해외직구 면세한도: 미국 $200, 일반 $150. 초과분에 관세+부가세 부과. 카드 할부 이자는 무이자 외에 수수료가 포함되며, 일시불 대비 총 비용을 비교하세요.</p><h2>이런 분들에게 추천</h2><p>정확한 쇼핑/소비 계산이 필요한 분에게 유용합니다. 카더라는 쇼핑/소비 포함 142종의 무료 계산기를 제공하며, 계산 결과를 카카오톡으로 공유할 수 있습니다. 본 계산기는 참고용이며 전문가 상담을 권장합니다.</p>', relatedCalcs: ['discount-calc'] },
