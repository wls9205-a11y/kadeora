...
export const CALC_REGISTRY: CalcMeta[] = [
  ...
  { slug: 'investment-type-test', emoji: '🧪', category: 'investment', categoryLabel: '주식/투자', title: '투자 성향 진단기', titleShort: '투자 성향 진단', description: '5개 질문으로 안전형/안정형/위험형 투자 성향을 진단.', keywords: ['투자 성향 진단','투자 성향 테스트','위험 성향'], legalBasis: '', version: '2026.04', lastUpdated: '2026-04-05', pattern: 'diagnose', formula: 'investmentTypeTest', resultLabel: '투자 성향', resultUnit: '', inputs: [{ id: 'q1', label: '투자 경험', type: 'radio', default: '2', options: [{ value: '1', label: '없음' }, { value: '2', label: '1~3년' }, { value: '3', label: '3년 이상' }] }, { id: 'q2', label: '원금 손실 감내', type: 'radio', default: '2', options: [{ value: '1', label: '10% 이하' }, { value: '2', label: '20~30%' }, { value: '3', label: '50% 이상' }] }, { id: 'q3', label: '투자 기간', type: 'radio', default: '2', options: [{ value: '1', label: '1년 미만' }, { value: '2', label: '1~5년' }, { value: '3', label: '5년 이상' }] }], faqs: [
      { q: '투자 성향 진단에서 세금은 반영되나요?', a: '국내 주식 거래세(0.18%)와 수수료를 반영합니다. 해외주식은 양도세(22%, 250만원 공제) 별도입니다.' },
      { q: '투자 수익 과세 기준은?', a: '국내 상장주식은 대주주만 양도세, 해외주식은 250만원 초과 시 22%, 배당은 15.4% 원천징수입니다.' },
      { q: '투자 성향 진단는 무료인가요?', a: '네, 카더라 투자 성향 진단는 무료이며 회원가입 없이 무제한 이용 가능합니다.' },
      { q: '투자 성향 진단는 모바일에서도 되나요?', a: '네, 모든 기기에서 최적화되어 있습니다.' },
      { q: '관련 계산기가 더 있나요?', a: '카더라는 주식/투자 포함 142종의 무료 계산기를 제공합니다.' },
    ], seoContent: '<h2>투자 성향 진단기 완벽 가이드</h2><p>5개 질문으로 안전형/안정형/위험형 투자 성향을 진단. 카더라 투자 성향 진단는 수수료, 세금을 반영한 실질 수익을 계산합니다.</p><h2>투자 핵심 정보</h2><p>투자 수익에는 거래세(0.18%), 수수료, 배당소득세(15.4%), 해외주식 양도세(22%, 250만원 공제) 등이 적용됩니다. 72법칙(72÷수익률=원금2배 년수)으로 복리 효과를 빠르게 파악할 수 있습니다. 장기 적립식 투자와 배당 재투자가 자산 증식의 핵심입니다.</p><h2>이런 분들에게 추천</h2><p>주식·펀드·ETF 투자자, 배당 투자 계획 중인 분, 투자 성과를 정확히 측정하고 싶은 분에게 유용합니다. 투자에는 원금 손실 위험이 있으며, 본 계산기는 참고용입니다.</p>', relatedCalcs: ['compound-interest', 'fire-calc'] },
  ...
  { slug: 'auction-profit', emoji: '🔨', category: 'real-estate', categoryLabel: '부동산', title: '경매 수익률 계산기', titleShort: '경매 수익률', description: '경매 낙찰가 대비 시세 차익과 수익률을 계산.', keywords: ['경매 수익률','부동산 경매','낙찰가','감정가'], legalBasis: '', version: '2026.04', lastUpdated: '2026-04-05', pattern: 'simple', formula: 'auctionProfit', resultLabel: '예상 수익률', resultUnit: '%', inputs: [{ id: 'appraisal', label: '감정가', type: 'currency', default: 500000000 }, { id: 'bidPrice', label: '낙찰 예상가', type: 'currency', default: 350000000 }, { id: 'repairCost', label: '수리비', type: 'currency', default: 20000000 }], faqs: [
