...
- 종합 현황: 4열 (전체/분양중/미분양/잔여세대)
- 지역별 TOP5, 지역 필터, 상태 필터(전체/분양중/미분양)
- 검색바: 단지명/지역/시공사 실시간 검색
- 정렬 4종: 세대수순/미분양순/분양가순/경쟁률순
- 프로그레스바: 접수→마감→당첨→계약→입주 5단계 시각화
- 경쟁률 표시: competition_rate_1st
- 인근 시세 비교: 지역별 실거래 평균가 vs 분양가 차이(%)
- ⭐ 관심단지, 💬 한줄평, 공고 링크, 전화문의
- 페이지네이션 20건

### 한줄평 프롬프트 강화
- 분양중: 모델하우스/시공사/교통/분양가 질문
- 미분양: 이유/할인/실거주vs투자 질문
- 재개발: 사업 진행/주민 의견 질문
- 유형별 동적 placeholder
