...
| 커밋 | sha | 내용 |
|---|---|---|
| 1 | `425b2fbf` | 라우트 판별 헬퍼 + `.kd-lrow` 목록 행 프리미티브 |
| 2 | `e38e7123` | 현장 상세 리드폼 배치 전환 — 폼 주 / 카톡 부 |
| 3 | `8d98457b` | 현장 상세 히어로·헤더 + 섹션 점프 바 |
| 4 | `03e1335c` | 현장 상세 데스크탑 2단 (우측 300px 레일) |
| 5 | `65d142f6` | 목록 3종 — 큐레이션 캐러셀 + 행 교체 + 2단 |
| 6 | (이 커밋) | 카톡 배너 라우트 조정 + 상세 2종 정리 |
